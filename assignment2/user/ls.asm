...
ls(char *path)
{
 ...
 128:	9c450513          	addi	a0,a0,-1596 # ae8 <malloc+0x116>
 ...
 166:	95658593          	addi	a1,a1,-1706 # ab8 <malloc+0xe6>
 16a:	4509                	li	a0,2
 ...
 17c:	95858593          	addi	a1,a1,-1704 # ad0 <malloc+0xfe>
 180:	4509                	li	a0,2
 ...
 1ae:	94e50513          	addi	a0,a0,-1714 # af8 <malloc+0x126>
 ...
 1f4:	920a0a13          	addi	s4,s4,-1760 # b10 <malloc+0x13e>
        printf("ls: cannot stat %s\n", buf);
 1f8:	00001a97          	auipc	s5,0x1
 1fc:	8d8a8a93          	addi	s5,s5,-1832 # ad0 <malloc+0xfe>
...
main(int argc, char *argv[])
{
 ...
 2be:	86650513          	addi	a0,a0,-1946 # b20 <malloc+0x14e>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 684:	4b050513          	addi	a0,a0,1200 # b30 <digits>
 688:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 750:	3e4b8b93          	addi	s7,s7,996 # b30 <digits>
 ...
 890:	29c90913          	addi	s2,s2,668 # b28 <malloc+0x156>
        while(*s != 0){
...
free(void *ap)
{
 ...
 958:	1f47b783          	ld	a5,500(a5) # b48 <freep>
 ...
 986:	00e6ea63          	bltu	a3,a4,99a <free+0x50>
{
 ...
 9c8:	18f73223          	sd	a5,388(a4) # b48 <freep>
}
 9cc:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 9fa:	15253503          	ld	a0,338(a0) # b48 <freep>
 ...
 a22:	12a90913          	addi	s2,s2,298 # b48 <freep>
  if(p == (char*)-1)
 a26:	5afd                	li	s5,-1
 a28:	a895                	j	a9c <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 a2a:	00000797          	auipc	a5,0x0
 a2e:	13678793          	addi	a5,a5,310 # b60 <base>
 a32:	00000717          	auipc	a4,0x0
 a36:	10f73b23          	sd	a5,278(a4) # b48 <freep>
 a3a:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 a5e:	0ea73723          	sd	a0,238(a4) # b48 <freep>
      return (void*)(p + 1);
