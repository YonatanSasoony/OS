...
main(int argc, char *argv[])
{
  ...
  1a:	90a78793          	addi	a5,a5,-1782 # 920 <malloc+0x116>
  1e:	6398                	ld	a4,0(a5)
  ...
  30:	8c450513          	addi	a0,a0,-1852 # 8f0 <malloc+0xe6>
  ...
  6c:	8a050513          	addi	a0,a0,-1888 # 908 <malloc+0xfe>
...
//    printf(fd, "%d\n", i);
  ...
  ba:	86250513          	addi	a0,a0,-1950 # 918 <malloc+0x10e>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4bc:	48050513          	addi	a0,a0,1152 # 938 <digits>
 4c0:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 588:	3b4b8b93          	addi	s7,s7,948 # 938 <digits>
 ...
 6c8:	26c90913          	addi	s2,s2,620 # 930 <malloc+0x126>
        while(*s != 0){
...
free(void *ap)
{
 ...
 790:	1c47b783          	ld	a5,452(a5) # 950 <freep>
 ...
 7be:	00e6ea63          	bltu	a3,a4,7d2 <free+0x50>
{
 ...
 800:	14f73a23          	sd	a5,340(a4) # 950 <freep>
}
 804:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 832:	12253503          	ld	a0,290(a0) # 950 <freep>
 ...
 85a:	0fa90913          	addi	s2,s2,250 # 950 <freep>
  if(p == (char*)-1)
 85e:	5afd                	li	s5,-1
 860:	a895                	j	8d4 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 862:	00000797          	auipc	a5,0x0
 866:	0f678793          	addi	a5,a5,246 # 958 <base>
 86a:	00000717          	auipc	a4,0x0
 86e:	0ef73323          	sd	a5,230(a4) # 950 <freep>
 872:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 896:	0aa73f23          	sd	a0,190(a4) # 950 <freep>
      return (void*)(p + 1);
