...
main(void)
{
  ...
  12:	8d250513          	addi	a0,a0,-1838 # 8e0 <malloc+0xea>
  ...
  3a:	8b290913          	addi	s2,s2,-1870 # 8e8 <malloc+0xf2>
  3e:	854a                	mv	a0,s2
  ...
  6e:	8ce50513          	addi	a0,a0,-1842 # 938 <malloc+0x142>
  ...
  8c:	85850513          	addi	a0,a0,-1960 # 8e0 <malloc+0xea>
  90:	00000097          	auipc	ra,0x0
  94:	31e080e7          	jalr	798(ra) # 3ae <mknod>
    open("console", O_RDWR);
  98:	4589                	li	a1,2
  9a:	00001517          	auipc	a0,0x1
  9e:	84650513          	addi	a0,a0,-1978 # 8e0 <malloc+0xea>
  a2:	00000097          	auipc	ra,0x0
  a6:	304080e7          	jalr	772(ra) # 3a6 <open>
  aa:	bfa5                	j	22 <main+0x22>
      printf("init: fork failed\n");
  ac:	00001517          	auipc	a0,0x1
  b0:	85450513          	addi	a0,a0,-1964 # 900 <malloc+0x10a>
  ...
  d2:	84a50513          	addi	a0,a0,-1974 # 918 <malloc+0x122>
  d6:	00000097          	auipc	ra,0x0
  da:	2c8080e7          	jalr	712(ra) # 39e <exec>
      printf("init: exec sh failed\n");
  de:	00001517          	auipc	a0,0x1
  e2:	84250513          	addi	a0,a0,-1982 # 920 <malloc+0x12a>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4a8:	4bc50513          	addi	a0,a0,1212 # 960 <digits>
 4ac:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 574:	3f0b8b93          	addi	s7,s7,1008 # 960 <digits>
 ...
 6b4:	2a890913          	addi	s2,s2,680 # 958 <malloc+0x162>
        while(*s != 0){
...
free(void *ap)
{
 ...
 77c:	2107b783          	ld	a5,528(a5) # 988 <freep>
 ...
 7aa:	00e6ea63          	bltu	a3,a4,7be <free+0x50>
{
 ...
 7ec:	1af73023          	sd	a5,416(a4) # 988 <freep>
}
 7f0:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 81e:	16e53503          	ld	a0,366(a0) # 988 <freep>
 ...
 846:	14690913          	addi	s2,s2,326 # 988 <freep>
  if(p == (char*)-1)
 84a:	5afd                	li	s5,-1
 84c:	a895                	j	8c0 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 84e:	00000797          	auipc	a5,0x0
 852:	14278793          	addi	a5,a5,322 # 990 <base>
 856:	00000717          	auipc	a4,0x0
 85a:	12f73923          	sd	a5,306(a4) # 988 <freep>
 85e:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 882:	10a73523          	sd	a0,266(a4) # 988 <freep>
      return (void*)(p + 1);
