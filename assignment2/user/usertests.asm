...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    uint64 addr = addrs[ai];
      ...
      42:	f1a50513          	addi	a0,a0,-230 # 5f58 <malloc+0x41c>
      ...
      74:	8082                	ret
{
      ...
      84:	ef850513          	addi	a0,a0,-264 # 5f78 <malloc+0x43c>
...
000000000000009a <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      ac:	ee850513          	addi	a0,a0,-280 # 5f90 <malloc+0x454>
  ...
  fd = open("doesnotexist", 0);
      ...
      ca:	eea50513          	addi	a0,a0,-278 # 5fb0 <malloc+0x474>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      ea:	eb250513          	addi	a0,a0,-334 # 5f98 <malloc+0x45c>
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     106:	ebe50513          	addi	a0,a0,-322 # 5fc0 <malloc+0x484>
...
000000000000011c <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     130:	ebc50513          	addi	a0,a0,-324 # 5fe8 <malloc+0x4ac>
     134:	00005097          	auipc	ra,0x5
     138:	5c8080e7          	jalr	1480(ra) # 56fc <unlink>
  int fd1 = open("truncfile", O_CREATE|O_TRUNC|O_WRONLY);
     13c:	60100593          	li	a1,1537
     140:	00006517          	auipc	a0,0x6
     144:	ea850513          	addi	a0,a0,-344 # 5fe8 <malloc+0x4ac>
  ...
  write(fd1, "abcd", 4);
     ...
     158:	ea458593          	addi	a1,a1,-348 # 5ff8 <malloc+0x4bc>
     15c:	00005097          	auipc	ra,0x5
     160:	570080e7          	jalr	1392(ra) # 56cc <write>
  int fd2 = open("truncfile", O_TRUNC|O_WRONLY);
     164:	40100593          	li	a1,1025
     168:	00006517          	auipc	a0,0x6
     16c:	e8050513          	addi	a0,a0,-384 # 5fe8 <malloc+0x4ac>
  ...
  int n = write(fd1, "x", 1);
     ...
     180:	e8458593          	addi	a1,a1,-380 # 6000 <malloc+0x4c4>
     184:	8526                	mv	a0,s1
  ...
  unlink("truncfile");
     ...
     198:	e5450513          	addi	a0,a0,-428 # 5fe8 <malloc+0x4ac>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1ce:	e3e50513          	addi	a0,a0,-450 # 6008 <malloc+0x4cc>
...
0000000000000264 <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     280:	b7c50513          	addi	a0,a0,-1156 # 5df8 <malloc+0x2bc>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     294:	b68a8a93          	addi	s5,s5,-1176 # 5df8 <malloc+0x2bc>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     316:	d1e50513          	addi	a0,a0,-738 # 6030 <malloc+0x4f4>
     ...
     33a:	d1a50513          	addi	a0,a0,-742 # 6050 <malloc+0x514>
...
0000000000000350 <copyin>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     376:	cf6a0a13          	addi	s4,s4,-778 # 6068 <malloc+0x52c>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     422:	c5250513          	addi	a0,a0,-942 # 6070 <malloc+0x534>
     ...
     440:	c4c50513          	addi	a0,a0,-948 # 6088 <malloc+0x54c>
     ...
     45e:	c5e50513          	addi	a0,a0,-930 # 60b8 <malloc+0x57c>
     ...
     478:	c7450513          	addi	a0,a0,-908 # 60e8 <malloc+0x5ac>
     ...
     496:	c6650513          	addi	a0,a0,-922 # 60f8 <malloc+0x5bc>
...
00000000000004ac <copyout>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     4d4:	c58a0a13          	addi	s4,s4,-936 # 6128 <malloc+0x5ec>
    n = write(fds[1], "x", 1);
     4d8:	00006a97          	auipc	s5,0x6
     4dc:	b28a8a93          	addi	s5,s5,-1240 # 6000 <malloc+0x4c4>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     582:	bb250513          	addi	a0,a0,-1102 # 6130 <malloc+0x5f4>
     ...
     5a0:	bac50513          	addi	a0,a0,-1108 # 6148 <malloc+0x60c>
     ...
     5ba:	b3250513          	addi	a0,a0,-1230 # 60e8 <malloc+0x5ac>
     ...
     5d4:	ba850513          	addi	a0,a0,-1112 # 6178 <malloc+0x63c>
     ...
     5f2:	ba250513          	addi	a0,a0,-1118 # 6190 <malloc+0x654>
...
0000000000000608 <truncate1>:
{
  ...
  write(fd1, "abcd", 4);
     ...
     648:	9b458593          	addi	a1,a1,-1612 # 5ff8 <malloc+0x4bc>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     664:	98850513          	addi	a0,a0,-1656 # 5fe8 <malloc+0x4ac>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     690:	95c50513          	addi	a0,a0,-1700 # 5fe8 <malloc+0x4ac>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     6a4:	94850513          	addi	a0,a0,-1720 # 5fe8 <malloc+0x4ac>
  ...
  write(fd1, "abcdef", 6);
     ...
     6e2:	b4258593          	addi	a1,a1,-1214 # 6220 <malloc+0x6e4>
     6e6:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     724:	8c850513          	addi	a0,a0,-1848 # 5fe8 <malloc+0x4ac>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     768:	a5c50513          	addi	a0,a0,-1444 # 61c0 <malloc+0x684>
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     784:	a6050513          	addi	a0,a0,-1440 # 61e0 <malloc+0x6a4>
    ...
    printf("%s: read %d bytes, wanted 0\n", s, n);
     ...
     798:	a5c50513          	addi	a0,a0,-1444 # 61f0 <malloc+0x6b4>
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     7b4:	a6050513          	addi	a0,a0,-1440 # 6210 <malloc+0x6d4>
    ...
    printf("%s: read %d bytes, wanted 0\n", s, n);
     ...
     7c8:	a2c50513          	addi	a0,a0,-1492 # 61f0 <malloc+0x6b4>
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     7e6:	a4650513          	addi	a0,a0,-1466 # 6228 <malloc+0x6ec>
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     804:	a4850513          	addi	a0,a0,-1464 # 6248 <malloc+0x70c>
...
000000000000081a <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     838:	a3450513          	addi	a0,a0,-1484 # 6268 <malloc+0x72c>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     850:	a4498993          	addi	s3,s3,-1468 # 6290 <malloc+0x754>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     854:	00006a97          	auipc	s5,0x6
     858:	a74a8a93          	addi	s5,s5,-1420 # 62c8 <malloc+0x78c>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     89e:	9ce50513          	addi	a0,a0,-1586 # 6268 <malloc+0x72c>
  ...
  if(unlink("small") < 0){
     ...
     8da:	99250513          	addi	a0,a0,-1646 # 6268 <malloc+0x72c>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     904:	97050513          	addi	a0,a0,-1680 # 6270 <malloc+0x734>
    ...
    exit(1);
     ...
     922:	98250513          	addi	a0,a0,-1662 # 62a0 <malloc+0x764>
     ...
     940:	99c50513          	addi	a0,a0,-1636 # 62d8 <malloc+0x79c>
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     95c:	9a850513          	addi	a0,a0,-1624 # 6300 <malloc+0x7c4>
    ...
    printf("%s: read failed\n", s);
     ...
     978:	9ac50513          	addi	a0,a0,-1620 # 6320 <malloc+0x7e4>
    ...
    printf("%s: unlink small failed\n", s);
     ...
     994:	9a850513          	addi	a0,a0,-1624 # 6338 <malloc+0x7fc>
...
00000000000009aa <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     9c6:	99650513          	addi	a0,a0,-1642 # 6358 <malloc+0x81c>
  ...
  fd = open("big", O_RDONLY);
     ...
     a18:	94450513          	addi	a0,a0,-1724 # 6358 <malloc+0x81c>
  ...
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     a60:	90450513          	addi	a0,a0,-1788 # 6360 <malloc+0x824>
    ...
    exit(1);
     ...
     a7e:	90650513          	addi	a0,a0,-1786 # 6380 <malloc+0x844>
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     a9a:	91250513          	addi	a0,a0,-1774 # 63a8 <malloc+0x86c>
  ...
  if(unlink("big") < 0){
     ...
     ac6:	89650513          	addi	a0,a0,-1898 # 6358 <malloc+0x81c>
     ...
     af2:	8da50513          	addi	a0,a0,-1830 # 63c8 <malloc+0x88c>
     ...
     b10:	8e450513          	addi	a0,a0,-1820 # 63f0 <malloc+0x8b4>
     ...
     b2e:	8de50513          	addi	a0,a0,-1826 # 6408 <malloc+0x8cc>
    ...
    printf("%s: unlink big failed\n", s);
     ...
     b4a:	8ea50513          	addi	a0,a0,-1814 # 6430 <malloc+0x8f4>
...
0000000000000b60 <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     b78:	21450513          	addi	a0,a0,532 # 5d88 <malloc+0x24c>
  ...
  write(fd, "hello", SZ);
     ...
     b90:	8dc58593          	addi	a1,a1,-1828 # 6468 <malloc+0x92c>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     bac:	1e050513          	addi	a0,a0,480 # 5d88 <malloc+0x24c>
  ...
  if(unlink("unlinkread") != 0){
     ...
     bc2:	1ca50513          	addi	a0,a0,458 # 5d88 <malloc+0x24c>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     bd8:	1b450513          	addi	a0,a0,436 # 5d88 <malloc+0x24c>
  ...
  write(fd1, "yyy", 3);
     ...
     bec:	8c858593          	addi	a1,a1,-1848 # 64b0 <malloc+0x974>
  ...
  unlink("unlinkread");
     ...
     c54:	13850513          	addi	a0,a0,312 # 5d88 <malloc+0x24c>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     c74:	7d850513          	addi	a0,a0,2008 # 6448 <malloc+0x90c>
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     c90:	7e450513          	addi	a0,a0,2020 # 6470 <malloc+0x934>
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     cac:	7e850513          	addi	a0,a0,2024 # 6490 <malloc+0x954>
    ...
    printf("%s: unlinkread read failed", s);
     ...
     cc8:	7f450513          	addi	a0,a0,2036 # 64b8 <malloc+0x97c>
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     ce4:	7f850513          	addi	a0,a0,2040 # 64d8 <malloc+0x99c>
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     d00:	7fc50513          	addi	a0,a0,2044 # 64f8 <malloc+0x9bc>
...
0000000000000d16 <linktest>:
{
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     d64:	70858593          	addi	a1,a1,1800 # 6468 <malloc+0x92c>
  ...
  if(link("lf1", "lf2") < 0){
     ...
     d84:	7a058593          	addi	a1,a1,1952 # 6520 <malloc+0x9e4>
     d88:	00005517          	auipc	a0,0x5
     d8c:	79050513          	addi	a0,a0,1936 # 6518 <malloc+0x9dc>
  ...
  unlink("lf1");
     ...
     da0:	77c50513          	addi	a0,a0,1916 # 6518 <malloc+0x9dc>
     da4:	00005097          	auipc	ra,0x5
     da8:	958080e7          	jalr	-1704(ra) # 56fc <unlink>
  if(open("lf1", 0) >= 0){
     dac:	4581                	li	a1,0
     dae:	00005517          	auipc	a0,0x5
     db2:	76a50513          	addi	a0,a0,1898 # 6518 <malloc+0x9dc>
  ...
  fd = open("lf2", 0);
     ...
     dc8:	75c50513          	addi	a0,a0,1884 # 6520 <malloc+0x9e4>
  ...
  if(link("lf2", "lf2") >= 0){
     ...
     e00:	72458593          	addi	a1,a1,1828 # 6520 <malloc+0x9e4>
     e04:	852e                	mv	a0,a1
  ...
  unlink("lf2");
     ...
     e16:	70e50513          	addi	a0,a0,1806 # 6520 <malloc+0x9e4>
     e1a:	00005097          	auipc	ra,0x5
     e1e:	8e2080e7          	jalr	-1822(ra) # 56fc <unlink>
  if(link("lf2", "lf1") >= 0){
     e22:	00005597          	auipc	a1,0x5
     e26:	6f658593          	addi	a1,a1,1782 # 6518 <malloc+0x9dc>
     e2a:	00005517          	auipc	a0,0x5
     e2e:	6f650513          	addi	a0,a0,1782 # 6520 <malloc+0x9e4>
  ...
  if(link(".", "lf1") >= 0){
     ...
     e42:	6da58593          	addi	a1,a1,1754 # 6518 <malloc+0x9dc>
     e46:	00005517          	auipc	a0,0x5
     e4a:	7e250513          	addi	a0,a0,2018 # 6628 <malloc+0xaec>
    ...
    printf("%s: create lf1 failed\n", s);
     ...
     e6c:	6c050513          	addi	a0,a0,1728 # 6528 <malloc+0x9ec>
    ...
    printf("%s: write lf1 failed\n", s);
     ...
     e88:	6bc50513          	addi	a0,a0,1724 # 6540 <malloc+0xa04>
    ...
    printf("%s: link lf1 lf2 failed\n", s);
     ...
     ea4:	6b850513          	addi	a0,a0,1720 # 6558 <malloc+0xa1c>
    ...
    printf("%s: unlinked lf1 but it is still there!\n", s);
     ...
     ec0:	6bc50513          	addi	a0,a0,1724 # 6578 <malloc+0xa3c>
    ...
    printf("%s: open lf2 failed\n", s);
     ...
     edc:	6d050513          	addi	a0,a0,1744 # 65a8 <malloc+0xa6c>
    ...
    printf("%s: read lf2 failed\n", s);
     ...
     ef8:	6cc50513          	addi	a0,a0,1740 # 65c0 <malloc+0xa84>
    ...
    printf("%s: link lf2 lf2 succeeded! oops\n", s);
     ...
     f14:	6c850513          	addi	a0,a0,1736 # 65d8 <malloc+0xa9c>
    ...
    printf("%s: link non-existant succeeded! oops\n", s);
     ...
     f30:	6d450513          	addi	a0,a0,1748 # 6600 <malloc+0xac4>
    ...
    printf("%s: link . lf1 succeeded! oops\n", s);
     ...
     f4c:	6e850513          	addi	a0,a0,1768 # 6630 <malloc+0xaf4>
...
0000000000000f62 <bigdir>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    if(link("bd", name) != 0){
     ...
     fb2:	6a2a0a13          	addi	s4,s4,1698 # 6650 <malloc+0xb14>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
    ...
    1004:	65050513          	addi	a0,a0,1616 # 6650 <malloc+0xb14>
  ...
  for(i = 0; i < N; i++){
    ...
    1074:	5e850513          	addi	a0,a0,1512 # 6658 <malloc+0xb1c>
    ...
    1094:	5e850513          	addi	a0,a0,1512 # 6678 <malloc+0xb3c>
    ...
    10b0:	5ec50513          	addi	a0,a0,1516 # 6698 <malloc+0xb5c>
...
00000000000010c6 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    10e2:	5da98993          	addi	s3,s3,1498 # 66b8 <malloc+0xb7c>
    10e6:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    111e:	5ae50513          	addi	a0,a0,1454 # 66c8 <malloc+0xb8c>
...
badarg(char *s)
{
  ...
  for(int i = 0; i < 50000; i++){
    ...
    118a:	e0a98993          	addi	s3,s3,-502 # 5f90 <malloc+0x454>
    argv[0] = (char*)0xffffffff;
...
00000000000011b2 <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    1214:	68878793          	addi	a5,a5,1672 # 7898 <malloc+0x1d5c>
  ...
  if(pid == 0){
    ...
    1270:	d3c78793          	addi	a5,a5,-708 # 7fa8 <malloc+0x246c>
    ...
    1294:	d0050513          	addi	a0,a0,-768 # 5f90 <malloc+0x454>
    ...
    12ac:	4c850513          	addi	a0,a0,1224 # 6770 <malloc+0xc34>
    ...
    12cc:	42050513          	addi	a0,a0,1056 # 66e8 <malloc+0xbac>
    ...
    12ec:	42050513          	addi	a0,a0,1056 # 6708 <malloc+0xbcc>
    ...
    130e:	41e50513          	addi	a0,a0,1054 # 6728 <malloc+0xbec>
    ...
    132e:	42650513          	addi	a0,a0,1062 # 6750 <malloc+0xc14>
    ...
    1348:	88c50513          	addi	a0,a0,-1908 # 6bd0 <malloc+0x1094>
  ...
  if(st != 747){
    ...
    1392:	40a50513          	addi	a0,a0,1034 # 6798 <malloc+0xc5c>
...
00000000000013a8 <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    13c4:	c2850513          	addi	a0,a0,-984 # 5fe8 <malloc+0x4ac>
  ...
  if(pid == 0){
    ...
    13ee:	bfea0a13          	addi	s4,s4,-1026 # 5fe8 <malloc+0x4ac>
      int n = write(fd, "1234567890", 10);
    13f2:	00005a97          	auipc	s5,0x5
    13f6:	406a8a93          	addi	s5,s5,1030 # 67f8 <malloc+0xcbc>
      int fd = open("truncfile", O_WRONLY);
    13fa:	4585                	li	a1,1
    13fc:	8552                	mv	a0,s4
    ...
    1466:	36650513          	addi	a0,a0,870 # 67c8 <malloc+0xc8c>
    ...
    1482:	36250513          	addi	a0,a0,866 # 67e0 <malloc+0xca4>
    ...
    14a0:	36c50513          	addi	a0,a0,876 # 6808 <malloc+0xccc>
    ...
    14be:	b2ea0a13          	addi	s4,s4,-1234 # 5fe8 <malloc+0x4ac>
    int n = write(fd, "xxx", 3);
    14c2:	00005a97          	auipc	s5,0x5
    14c6:	366a8a93          	addi	s5,s5,870 # 6828 <malloc+0xcec>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    1510:	adc50513          	addi	a0,a0,-1316 # 5fe8 <malloc+0x4ac>
  ...
  exit(xstatus);
    ...
    152e:	2b650513          	addi	a0,a0,694 # 67e0 <malloc+0xca4>
    ...
    154c:	2e850513          	addi	a0,a0,744 # 6830 <malloc+0xcf4>
...
0000000000001562 <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    1574:	a2078793          	addi	a5,a5,-1504 # 5f90 <malloc+0x454>
    1578:	fcf43023          	sd	a5,-64(s0)
    157c:	00005797          	auipc	a5,0x5
    1580:	2d478793          	addi	a5,a5,724 # 6850 <malloc+0xd14>
    1584:	fcf43423          	sd	a5,-56(s0)
    1588:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    158c:	00005517          	auipc	a0,0x5
    1590:	2cc50513          	addi	a0,a0,716 # 6858 <malloc+0xd1c>
  ...
  if(pid == 0) {
    ...
    15be:	29e50513          	addi	a0,a0,670 # 6858 <malloc+0xd1c>
    ...
    15da:	2a250513          	addi	a0,a0,674 # 6878 <malloc+0xd3c>
    ...
    15f6:	1d650513          	addi	a0,a0,470 # 67c8 <malloc+0xc8c>
    ...
    1612:	25250513          	addi	a0,a0,594 # 6860 <malloc+0xd24>
    ...
    1630:	96450513          	addi	a0,a0,-1692 # 5f90 <malloc+0x454>
  ...
  if(xstatus != 0)
    ...
    1664:	22850513          	addi	a0,a0,552 # 6888 <malloc+0xd4c>
    ...
    1680:	22450513          	addi	a0,a0,548 # 68a0 <malloc+0xd64>
  ...
  fd = open("echo-ok", O_RDONLY);
    ...
    1694:	1c850513          	addi	a0,a0,456 # 6858 <malloc+0xd1c>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    16be:	c6650513          	addi	a0,a0,-922 # 6320 <malloc+0x7e4>
    ...
    16da:	10a50513          	addi	a0,a0,266 # 67e0 <malloc+0xca4>
  ...
  unlink("echo-ok");
    ...
    16f4:	16850513          	addi	a0,a0,360 # 6858 <malloc+0xd1c>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    171e:	19e50513          	addi	a0,a0,414 # 68b8 <malloc+0xd7c>
...
000000000000173e <pipe1>:
{
  ...
  if(pid == 0){
    ...
    17e0:	0f450513          	addi	a0,a0,244 # 68d0 <malloc+0xd94>
    ...
    181a:	42da8a93          	addi	s5,s5,1069 # 142d <truncate3+0x85>
{
    ...
    1866:	08650513          	addi	a0,a0,134 # 68e8 <malloc+0xdac>
    ...
    1882:	08250513          	addi	a0,a0,130 # 6900 <malloc+0xdc4>
    ...
    18b4:	06850513          	addi	a0,a0,104 # 6918 <malloc+0xddc>
    ...
    18f4:	04850513          	addi	a0,a0,72 # 6938 <malloc+0xdfc>
...
000000000000190a <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    1966:	e6650513          	addi	a0,a0,-410 # 67c8 <malloc+0xc8c>
    ...
    1982:	fd250513          	addi	a0,a0,-46 # 6950 <malloc+0xe14>
    ...
    199e:	fce50513          	addi	a0,a0,-50 # 6968 <malloc+0xe2c>
...
00000000000019be <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1a16:	db650513          	addi	a0,a0,-586 # 67c8 <malloc+0xc8c>
    ...
    1a3a:	d9250513          	addi	a0,a0,-622 # 67c8 <malloc+0xc8c>
...
0000000000001a58 <forkfork>:
{
    ...
    1ab4:	ed850513          	addi	a0,a0,-296 # 6988 <malloc+0xe4c>
    ...
    1ac6:	bea080e7          	jalr	-1046(ra) # 56ac <exit>
{
    ...
    1b0c:	e9050513          	addi	a0,a0,-368 # 6998 <malloc+0xe5c>
...
0000000000001b22 <reparent2>:
{
  ...
  exit(0);
    ...
    1b5a:	07a50513          	addi	a0,a0,122 # 6bd0 <malloc+0x1094>
...
0000000000001b8a <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1bf8:	fdc50513          	addi	a0,a0,-36 # 6bd0 <malloc+0x1094>
    ...
    1c24:	c4050513          	addi	a0,a0,-960 # 6860 <malloc+0xd24>
    ...
    1c96:	d2650513          	addi	a0,a0,-730 # 69b8 <malloc+0xe7c>
    ...
    1cca:	d0a50513          	addi	a0,a0,-758 # 69d0 <malloc+0xe94>
    ...
    1d30:	ccc50513          	addi	a0,a0,-820 # 69f8 <malloc+0xebc>
...
0000000000001db0 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1dd0:	23450513          	addi	a0,a0,564 # 6000 <malloc+0x4c4>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1e0c:	1f8a8a93          	addi	s5,s5,504 # 6000 <malloc+0x4c4>
      link("cat", "x");
    1e10:	00005b97          	auipc	s7,0x5
    1e14:	c10b8b93          	addi	s7,s7,-1008 # 6a20 <malloc+0xee4>
    1e18:	a825                	j	1e50 <linkunlink+0xa0>
    printf("%s: fork failed\n", s);
    1e1a:	85a6                	mv	a1,s1
    1e1c:	00005517          	auipc	a0,0x5
    1e20:	9ac50513          	addi	a0,a0,-1620 # 67c8 <malloc+0xc8c>
...
0000000000001eb2 <manywrites>:
{
  ...
  exit(0);
    ...
    1f0e:	cc650513          	addi	a0,a0,-826 # 6bd0 <malloc+0x1094>
    ...
    1fbe:	a6e50513          	addi	a0,a0,-1426 # 6a28 <malloc+0xeec>
    ...
    1fde:	07650513          	addi	a0,a0,118 # 6050 <malloc+0x514>
...
0000000000001ffc <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    202c:	a3050513          	addi	a0,a0,-1488 # 6a58 <malloc+0xf1c>
  ...
  if(wait(0) != -1){
    ...
    208e:	9b650513          	addi	a0,a0,-1610 # 6a40 <malloc+0xf04>
    ...
    20aa:	9da50513          	addi	a0,a0,-1574 # 6a80 <malloc+0xf44>
    ...
    20c6:	9d650513          	addi	a0,a0,-1578 # 6a98 <malloc+0xf5c>
...
00000000000020dc <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2146:	68650513          	addi	a0,a0,1670 # 67c8 <malloc+0xc8c>
    ...
    2168:	94c50513          	addi	a0,a0,-1716 # 6ab0 <malloc+0xf74>
...
0000000000002188 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    2198:	93c50513          	addi	a0,a0,-1732 # 6ad0 <malloc+0xf94>
  ...
  fd = open("bigarg-ok", 0);
    ...
    21ca:	90a50513          	addi	a0,a0,-1782 # 6ad0 <malloc+0xf94>
  ...
  close(fd);
    ...
    2200:	8e470713          	addi	a4,a4,-1820 # 6ae0 <malloc+0xfa4>
    ...
    2254:	97050513          	addi	a0,a0,-1680 # 6bc0 <malloc+0x1084>
    ...
    2278:	96c50513          	addi	a0,a0,-1684 # 6be0 <malloc+0x10a4>
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    22d6:	92e50513          	addi	a0,a0,-1746 # 6c00 <malloc+0x10c4>
    ...
    22f2:	4da50513          	addi	a0,a0,1242 # 67c8 <malloc+0xc8c>
...
0000000000002312 <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    238c:	51078793          	addi	a5,a5,1296 # 7898 <malloc+0x1d5c>
  ...
  if(ret != -1){
    ...
    23ce:	85e50513          	addi	a0,a0,-1954 # 6c28 <malloc+0x10ec>
    ...
    23ec:	30050513          	addi	a0,a0,768 # 66e8 <malloc+0xbac>
    ...
    240a:	30250513          	addi	a0,a0,770 # 6708 <malloc+0xbcc>
    ...
    242a:	30250513          	addi	a0,a0,770 # 6728 <malloc+0xbec>
    ...
    2448:	30c50513          	addi	a0,a0,780 # 6750 <malloc+0xc14>
...
000000000000245e <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    2494:	81050513          	addi	a0,a0,-2032 # 5ca0 <malloc+0x164>
  ...
  if(n >= 0){
    ...
    24c6:	7be50513          	addi	a0,a0,1982 # 6c80 <malloc+0x1144>
    ...
    24e0:	75450513          	addi	a0,a0,1876 # 6c30 <malloc+0x10f4>
    ...
    24fa:	75250513          	addi	a0,a0,1874 # 6c48 <malloc+0x110c>
    ...
    2514:	75850513          	addi	a0,a0,1880 # 6c68 <malloc+0x112c>
  ...
  unlink("rwsbrk");
    ...
    2538:	76c50513          	addi	a0,a0,1900 # 5ca0 <malloc+0x164>
    253c:	00003097          	auipc	ra,0x3
    2540:	1c0080e7          	jalr	448(ra) # 56fc <unlink>
  fd = open("README", O_RDONLY);
    2544:	4581                	li	a1,0
    2546:	00004517          	auipc	a0,0x4
    254a:	be250513          	addi	a0,a0,-1054 # 6128 <malloc+0x5ec>
  ...
  if(n >= 0){
    ...
    2574:	74050513          	addi	a0,a0,1856 # 6cb0 <malloc+0x1174>
    ...
    258e:	6de50513          	addi	a0,a0,1758 # 6c68 <malloc+0x112c>
...
00000000000025b8 <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    260e:	6ce50513          	addi	a0,a0,1742 # 6cd8 <malloc+0x119c>
  ...
  for(i = 0; i < 5000; i++){
    ...
    2660:	69c50513          	addi	a0,a0,1692 # 6cf8 <malloc+0x11bc>
  ...
  if(c != a + 1){
    ...
    26c4:	69850513          	addi	a0,a0,1688 # 6d58 <malloc+0x121c>
    ...
    26e4:	63850513          	addi	a0,a0,1592 # 6d18 <malloc+0x11dc>
    ...
    2700:	63c50513          	addi	a0,a0,1596 # 6d38 <malloc+0x11fc>
...
000000000000273c <sbrkmuch>:
{
  ...
  *lastaddr = 99;
  ...
  if(c != a){
    ...
    284a:	53250513          	addi	a0,a0,1330 # 6d78 <malloc+0x123c>
    ...
    2866:	55e50513          	addi	a0,a0,1374 # 6dc0 <malloc+0x1284>
    ...
    2886:	55e50513          	addi	a0,a0,1374 # 6de0 <malloc+0x12a4>
    ...
    28a6:	57e50513          	addi	a0,a0,1406 # 6e20 <malloc+0x12e4>
    ...
    28c2:	59250513          	addi	a0,a0,1426 # 6e50 <malloc+0x1314>
    ...
    28e2:	5aa50513          	addi	a0,a0,1450 # 6e88 <malloc+0x134c>
...
00000000000028f8 <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    291c:	59850513          	addi	a0,a0,1432 # 6eb0 <malloc+0x1374>
    2920:	00003097          	auipc	ra,0x3
    2924:	dcc080e7          	jalr	-564(ra) # 56ec <open>
    2928:	84aa                	mv	s1,a0
  unlink("sbrk");
    292a:	00004517          	auipc	a0,0x4
    292e:	58650513          	addi	a0,a0,1414 # 6eb0 <malloc+0x1374>
  ...
  if(pipe((int *) a) != 0){
    ...
    2982:	53a50513          	addi	a0,a0,1338 # 6eb8 <malloc+0x137c>
    ...
    299e:	53650513          	addi	a0,a0,1334 # 6ed0 <malloc+0x1394>
    ...
    29ba:	f1a50513          	addi	a0,a0,-230 # 68d0 <malloc+0xd94>
...
00000000000029d0 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    29e4:	50850513          	addi	a0,a0,1288 # 6ee8 <malloc+0x13ac>
  ...
  close(fd);
    ...
    2a2c:	db850513          	addi	a0,a0,-584 # 67e0 <malloc+0xca4>
...
0000000000002a42 <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2a7a:	15a50513          	addi	a0,a0,346 # 6bd0 <malloc+0x1094>
  ...
  if(pid == 0){
    ...
    2ad0:	10450513          	addi	a0,a0,260 # 6bd0 <malloc+0x1094>
  ...
  if(pid == 0){
    ...
    2b30:	0a450513          	addi	a0,a0,164 # 6bd0 <malloc+0x1094>
...
execout(char *s)
{
  ...
  exit(0);
    ...
    2b9c:	03850513          	addi	a0,a0,56 # 6bd0 <malloc+0x1094>
    ...
    2bf0:	3a450513          	addi	a0,a0,932 # 5f90 <malloc+0x454>
    2bf4:	faa43c23          	sd	a0,-72(s0)
    2bf8:	00003797          	auipc	a5,0x3
    2bfc:	40878793          	addi	a5,a5,1032 # 6000 <malloc+0x4c4>
...
0000000000002c1e <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    2c2e:	49650513          	addi	a0,a0,1174 # 70c0 <malloc+0x1584>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    2c40:	2dc50513          	addi	a0,a0,732 # 6f18 <malloc+0x13dc>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    2c56:	31e50513          	addi	a0,a0,798 # 6f70 <malloc+0x1434>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    2c74:	37850513          	addi	a0,a0,888 # 6fe8 <malloc+0x14ac>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    2c90:	3cc50513          	addi	a0,a0,972 # 7058 <malloc+0x151c>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    2ca2:	41250513          	addi	a0,a0,1042 # 70b0 <malloc+0x1574>
  ...
  unlink("12345678901234");
    ...
    2d20:	1d450513          	addi	a0,a0,468 # 6ef0 <malloc+0x13b4>
    ...
    2d3c:	20050513          	addi	a0,a0,512 # 6f38 <malloc+0x13fc>
    ...
    2d58:	24c50513          	addi	a0,a0,588 # 6fa0 <malloc+0x1464>
    ...
    2d74:	2a850513          	addi	a0,a0,680 # 7018 <malloc+0x14dc>
    ...
    2d90:	2ec50513          	addi	a0,a0,748 # 7078 <malloc+0x153c>
    ...
    2dac:	32850513          	addi	a0,a0,808 # 70d0 <malloc+0x1594>
...
0000000000002dc2 <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    2dd2:	33a50513          	addi	a0,a0,826 # 7108 <malloc+0x15cc>
  ...
  if(chdir("iputdir") < 0){
    ...
    2de6:	32650513          	addi	a0,a0,806 # 7108 <malloc+0x15cc>
  ...
  if(unlink("../iputdir") < 0){
    ...
    2dfa:	35250513          	addi	a0,a0,850 # 7148 <malloc+0x160c>
  ...
  if(chdir("/") < 0){
    ...
    2e0e:	36e50513          	addi	a0,a0,878 # 7178 <malloc+0x163c>
    ...
    2e2e:	2e650513          	addi	a0,a0,742 # 7110 <malloc+0x15d4>
    ...
    2e4a:	2e250513          	addi	a0,a0,738 # 7128 <malloc+0x15ec>
    ...
    2e66:	2f650513          	addi	a0,a0,758 # 7158 <malloc+0x161c>
    ...
    2e82:	30250513          	addi	a0,a0,770 # 7180 <malloc+0x1644>
...
0000000000002e98 <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    2eb6:	25650513          	addi	a0,a0,598 # 7108 <malloc+0x15cc>
    ...
    2eca:	24250513          	addi	a0,a0,578 # 7108 <malloc+0x15cc>
    ...
    2ede:	26e50513          	addi	a0,a0,622 # 7148 <malloc+0x160c>
    ...
    2efe:	8ce50513          	addi	a0,a0,-1842 # 67c8 <malloc+0xc8c>
    ...
    2f1a:	1fa50513          	addi	a0,a0,506 # 7110 <malloc+0x15d4>
    ...
    2f36:	26650513          	addi	a0,a0,614 # 7198 <malloc+0x165c>
    ...
    2f52:	20a50513          	addi	a0,a0,522 # 7158 <malloc+0x161c>
...
0000000000002f80 <dirtest>:
{
  ...
  if(mkdir("dir0") < 0){
    ...
    2f90:	22450513          	addi	a0,a0,548 # 71b0 <malloc+0x1674>
  ...
  if(chdir("dir0") < 0){
    ...
    2fa4:	21050513          	addi	a0,a0,528 # 71b0 <malloc+0x1674>
  ...
  if(chdir("..") < 0){
    ...
    2fb8:	21c50513          	addi	a0,a0,540 # 71d0 <malloc+0x1694>
  ...
  if(unlink("dir0") < 0){
    ...
    2fcc:	1e850513          	addi	a0,a0,488 # 71b0 <malloc+0x1674>
    ...
    2fec:	12850513          	addi	a0,a0,296 # 7110 <malloc+0x15d4>
    ...
    3008:	1b450513          	addi	a0,a0,436 # 71b8 <malloc+0x167c>
    ...
    3024:	1b850513          	addi	a0,a0,440 # 71d8 <malloc+0x169c>
    ...
    3040:	1b450513          	addi	a0,a0,436 # 71f0 <malloc+0x16b4>
...
0000000000003056 <subdir>:
{
  ...
  unlink("ff");
    ...
    3068:	2d450513          	addi	a0,a0,724 # 7338 <malloc+0x17fc>
    306c:	00002097          	auipc	ra,0x2
    3070:	690080e7          	jalr	1680(ra) # 56fc <unlink>
  if(mkdir("dd") != 0){
    3074:	00004517          	auipc	a0,0x4
    3078:	19450513          	addi	a0,a0,404 # 7208 <malloc+0x16cc>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    3090:	19c50513          	addi	a0,a0,412 # 7228 <malloc+0x16ec>
  ...
  write(fd, "ff", 2);
    ...
    30a8:	29458593          	addi	a1,a1,660 # 7338 <malloc+0x17fc>
  ...
  if(unlink("dd") >= 0){
    ...
    30c2:	14a50513          	addi	a0,a0,330 # 7208 <malloc+0x16cc>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    30d6:	1ae50513          	addi	a0,a0,430 # 7280 <malloc+0x1744>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    30ee:	1be50513          	addi	a0,a0,446 # 72a8 <malloc+0x176c>
  ...
  write(fd, "FF", 2);
    ...
    3106:	1d658593          	addi	a1,a1,470 # 72d8 <malloc+0x179c>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    3122:	1c250513          	addi	a0,a0,450 # 72e0 <malloc+0x17a4>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    316a:	1ca58593          	addi	a1,a1,458 # 7330 <malloc+0x17f4>
    316e:	00004517          	auipc	a0,0x4
    3172:	13a50513          	addi	a0,a0,314 # 72a8 <malloc+0x176c>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    3186:	12650513          	addi	a0,a0,294 # 72a8 <malloc+0x176c>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    319c:	11050513          	addi	a0,a0,272 # 72a8 <malloc+0x176c>
  ...
  if(chdir("dd") != 0){
    ...
    31b0:	05c50513          	addi	a0,a0,92 # 7208 <malloc+0x16cc>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    31c4:	20850513          	addi	a0,a0,520 # 73c8 <malloc+0x188c>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    31d8:	22450513          	addi	a0,a0,548 # 73f8 <malloc+0x18bc>
  ...
  if(chdir("./..") != 0){
    ...
    31ec:	24050513          	addi	a0,a0,576 # 7428 <malloc+0x18ec>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    3202:	13250513          	addi	a0,a0,306 # 7330 <malloc+0x17f4>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    323c:	07050513          	addi	a0,a0,112 # 72a8 <malloc+0x176c>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    3254:	26850513          	addi	a0,a0,616 # 74b8 <malloc+0x197c>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    326c:	28050513          	addi	a0,a0,640 # 74e8 <malloc+0x19ac>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    3284:	f8850513          	addi	a0,a0,-120 # 7208 <malloc+0x16cc>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    329a:	f7250513          	addi	a0,a0,-142 # 7208 <malloc+0x16cc>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    32b0:	f5c50513          	addi	a0,a0,-164 # 7208 <malloc+0x16cc>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    32c4:	2b858593          	addi	a1,a1,696 # 7578 <malloc+0x1a3c>
    32c8:	00004517          	auipc	a0,0x4
    32cc:	1f050513          	addi	a0,a0,496 # 74b8 <malloc+0x197c>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    32e0:	29c58593          	addi	a1,a1,668 # 7578 <malloc+0x1a3c>
    32e4:	00004517          	auipc	a0,0x4
    32e8:	20450513          	addi	a0,a0,516 # 74e8 <malloc+0x19ac>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    32fc:	03858593          	addi	a1,a1,56 # 7330 <malloc+0x17f4>
    3300:	00004517          	auipc	a0,0x4
    3304:	f2850513          	addi	a0,a0,-216 # 7228 <malloc+0x16ec>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    3318:	1a450513          	addi	a0,a0,420 # 74b8 <malloc+0x197c>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    332c:	1c050513          	addi	a0,a0,448 # 74e8 <malloc+0x19ac>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    3340:	ff450513          	addi	a0,a0,-12 # 7330 <malloc+0x17f4>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    3354:	19850513          	addi	a0,a0,408 # 74e8 <malloc+0x19ac>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    3368:	15450513          	addi	a0,a0,340 # 74b8 <malloc+0x197c>
  ...
  if(chdir("dd/ff") == 0){
    ...
    337c:	eb050513          	addi	a0,a0,-336 # 7228 <malloc+0x16ec>
  ...
  if(chdir("dd/xx") == 0){
    ...
    3390:	33c50513          	addi	a0,a0,828 # 76c8 <malloc+0x1b8c>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    33a4:	f9050513          	addi	a0,a0,-112 # 7330 <malloc+0x17f4>
  ...
  if(unlink("dd/ff") != 0){
    ...
    33b8:	e7450513          	addi	a0,a0,-396 # 7228 <malloc+0x16ec>
  ...
  if(unlink("dd") == 0){
    ...
    33cc:	e4050513          	addi	a0,a0,-448 # 7208 <malloc+0x16cc>
  ...
  if(unlink("dd/dd") < 0){
    ...
    33e0:	35c50513          	addi	a0,a0,860 # 7738 <malloc+0x1bfc>
  ...
  if(unlink("dd") < 0){
    ...
    33f4:	e1850513          	addi	a0,a0,-488 # 7208 <malloc+0x16cc>
    ...
    3416:	dfe50513          	addi	a0,a0,-514 # 7210 <malloc+0x16d4>
    ...
    3432:	e0250513          	addi	a0,a0,-510 # 7230 <malloc+0x16f4>
    ...
    344e:	e0650513          	addi	a0,a0,-506 # 7250 <malloc+0x1714>
    ...
    346a:	e2250513          	addi	a0,a0,-478 # 7288 <malloc+0x174c>
    ...
    3486:	e3650513          	addi	a0,a0,-458 # 72b8 <malloc+0x177c>
    ...
    34a2:	e5250513          	addi	a0,a0,-430 # 72f0 <malloc+0x17b4>
    ...
    34be:	e5650513          	addi	a0,a0,-426 # 7310 <malloc+0x17d4>
    ...
    34da:	e6a50513          	addi	a0,a0,-406 # 7340 <malloc+0x1804>
    ...
    34f6:	e7650513          	addi	a0,a0,-394 # 7368 <malloc+0x182c>
    ...
    3512:	e7a50513          	addi	a0,a0,-390 # 7388 <malloc+0x184c>
    ...
    352e:	e8650513          	addi	a0,a0,-378 # 73b0 <malloc+0x1874>
    ...
    354a:	e9250513          	addi	a0,a0,-366 # 73d8 <malloc+0x189c>
    ...
    3566:	ea650513          	addi	a0,a0,-346 # 7408 <malloc+0x18cc>
    ...
    3582:	eb250513          	addi	a0,a0,-334 # 7430 <malloc+0x18f4>
    ...
    359e:	eae50513          	addi	a0,a0,-338 # 7448 <malloc+0x190c>
    ...
    35ba:	eb250513          	addi	a0,a0,-334 # 7468 <malloc+0x192c>
    ...
    35d6:	eb650513          	addi	a0,a0,-330 # 7488 <malloc+0x194c>
    ...
    35f2:	eda50513          	addi	a0,a0,-294 # 74c8 <malloc+0x198c>
    ...
    360e:	eee50513          	addi	a0,a0,-274 # 74f8 <malloc+0x19bc>
    ...
    362a:	ef250513          	addi	a0,a0,-270 # 7518 <malloc+0x19dc>
    ...
    3646:	ef650513          	addi	a0,a0,-266 # 7538 <malloc+0x19fc>
    ...
    3662:	efa50513          	addi	a0,a0,-262 # 7558 <malloc+0x1a1c>
    ...
    367e:	f0e50513          	addi	a0,a0,-242 # 7588 <malloc+0x1a4c>
    ...
    369a:	f1a50513          	addi	a0,a0,-230 # 75b0 <malloc+0x1a74>
    ...
    36b6:	f2650513          	addi	a0,a0,-218 # 75d8 <malloc+0x1a9c>
    ...
    36d2:	f3250513          	addi	a0,a0,-206 # 7600 <malloc+0x1ac4>
    ...
    36ee:	f3650513          	addi	a0,a0,-202 # 7620 <malloc+0x1ae4>
    ...
    370a:	f3a50513          	addi	a0,a0,-198 # 7640 <malloc+0x1b04>
    ...
    3726:	f4650513          	addi	a0,a0,-186 # 7668 <malloc+0x1b2c>
    ...
    3742:	f4a50513          	addi	a0,a0,-182 # 7688 <malloc+0x1b4c>
    ...
    375e:	f4e50513          	addi	a0,a0,-178 # 76a8 <malloc+0x1b6c>
    ...
    377a:	f5a50513          	addi	a0,a0,-166 # 76d0 <malloc+0x1b94>
    ...
    3796:	bd650513          	addi	a0,a0,-1066 # 7368 <malloc+0x182c>
    ...
    37b2:	f4250513          	addi	a0,a0,-190 # 76f0 <malloc+0x1bb4>
    ...
    37ce:	f4650513          	addi	a0,a0,-186 # 7710 <malloc+0x1bd4>
    ...
    37ea:	f5a50513          	addi	a0,a0,-166 # 7740 <malloc+0x1c04>
    ...
    3806:	f5e50513          	addi	a0,a0,-162 # 7760 <malloc+0x1c24>
...
000000000000381c <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    382c:	f5050513          	addi	a0,a0,-176 # 7778 <malloc+0x1c3c>
  ...
  if(chdir("dots") != 0){
    ...
    383e:	f3e50513          	addi	a0,a0,-194 # 7778 <malloc+0x1c3c>
  ...
  if(unlink(".") == 0){
    ...
    3850:	ddc50513          	addi	a0,a0,-548 # 6628 <malloc+0xaec>
  ...
  if(unlink("..") == 0){
    ...
    3862:	97250513          	addi	a0,a0,-1678 # 71d0 <malloc+0x1694>
  ...
  if(chdir("/") != 0){
    ...
    3874:	90850513          	addi	a0,a0,-1784 # 7178 <malloc+0x163c>
  ...
  if(unlink("dots/.") == 0){
    ...
    3886:	f5e50513          	addi	a0,a0,-162 # 77e0 <malloc+0x1ca4>
  ...
  if(unlink("dots/..") == 0){
    ...
    3898:	f7450513          	addi	a0,a0,-140 # 7808 <malloc+0x1ccc>
  ...
  if(unlink("dots") != 0){
    ...
    38aa:	ed250513          	addi	a0,a0,-302 # 7778 <malloc+0x1c3c>
    ...
    38c8:	ebc50513          	addi	a0,a0,-324 # 7780 <malloc+0x1c44>
    ...
    38e4:	eb850513          	addi	a0,a0,-328 # 7798 <malloc+0x1c5c>
    ...
    3900:	eb450513          	addi	a0,a0,-332 # 77b0 <malloc+0x1c74>
    ...
    391c:	eb050513          	addi	a0,a0,-336 # 77c8 <malloc+0x1c8c>
    ...
    3938:	84c50513          	addi	a0,a0,-1972 # 7180 <malloc+0x1644>
    ...
    3954:	e9850513          	addi	a0,a0,-360 # 77e8 <malloc+0x1cac>
    ...
    3970:	ea450513          	addi	a0,a0,-348 # 7810 <malloc+0x1cd4>
    ...
    398c:	ea850513          	addi	a0,a0,-344 # 7830 <malloc+0x1cf4>
...
00000000000039a2 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    39b8:	57c50513          	addi	a0,a0,1404 # 5f30 <malloc+0x3f4>
  ...
  if(chdir("dirfile") == 0){
    ...
    39d4:	56050513          	addi	a0,a0,1376 # 5f30 <malloc+0x3f4>
  ...
  fd = open("dirfile/xx", 0);
    ...
    39e8:	eac50513          	addi	a0,a0,-340 # 7890 <malloc+0x1d54>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    3a00:	e9450513          	addi	a0,a0,-364 # 7890 <malloc+0x1d54>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    3a14:	e8050513          	addi	a0,a0,-384 # 7890 <malloc+0x1d54>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    3a28:	e6c50513          	addi	a0,a0,-404 # 7890 <malloc+0x1d54>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    3a3c:	e5858593          	addi	a1,a1,-424 # 7890 <malloc+0x1d54>
    3a40:	00002517          	auipc	a0,0x2
    3a44:	6e850513          	addi	a0,a0,1768 # 6128 <malloc+0x5ec>
  ...
  if(unlink("dirfile") != 0){
    ...
    3a58:	4dc50513          	addi	a0,a0,1244 # 5f30 <malloc+0x3f4>
  ...
  fd = open(".", O_RDWR);
    ...
    3a6e:	bbe50513          	addi	a0,a0,-1090 # 6628 <malloc+0xaec>
  ...
  fd = open(".", 0);
    ...
    3a84:	ba850513          	addi	a0,a0,-1112 # 6628 <malloc+0xaec>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    3a98:	56c58593          	addi	a1,a1,1388 # 6000 <malloc+0x4c4>
  ...
  close(fd);
    ...
    3ac4:	d9050513          	addi	a0,a0,-624 # 7850 <malloc+0x1d14>
    ...
    3ae0:	d9450513          	addi	a0,a0,-620 # 7870 <malloc+0x1d34>
    ...
    3afc:	da850513          	addi	a0,a0,-600 # 78a0 <malloc+0x1d64>
    ...
    3b18:	d8c50513          	addi	a0,a0,-628 # 78a0 <malloc+0x1d64>
    ...
    3b34:	d9850513          	addi	a0,a0,-616 # 78c8 <malloc+0x1d8c>
    ...
    3b50:	da450513          	addi	a0,a0,-604 # 78f0 <malloc+0x1db4>
    ...
    3b6c:	db050513          	addi	a0,a0,-592 # 7918 <malloc+0x1ddc>
    ...
    3b88:	dbc50513          	addi	a0,a0,-580 # 7940 <malloc+0x1e04>
    ...
    3ba4:	dc050513          	addi	a0,a0,-576 # 7960 <malloc+0x1e24>
    ...
    3bc0:	dcc50513          	addi	a0,a0,-564 # 7988 <malloc+0x1e4c>
...
0000000000003bd6 <iref>:
{
    ...
    3bf4:	db0a0a13          	addi	s4,s4,-592 # 79a0 <malloc+0x1e64>
    mkdir("");
    3bf8:	00004497          	auipc	s1,0x4
    3bfc:	8b848493          	addi	s1,s1,-1864 # 74b0 <malloc+0x1974>
    link("README", "");
    3c00:	00002a97          	auipc	s5,0x2
    3c04:	528a8a93          	addi	s5,s5,1320 # 6128 <malloc+0x5ec>
    fd = open("xx", O_CREATE);
    3c08:	00004997          	auipc	s3,0x4
    3c0c:	c9098993          	addi	s3,s3,-880 # 7898 <malloc+0x1d5c>
    3c10:	a891                	j	3c64 <iref+0x8e>
      printf("%s: mkdir irefd failed\n", s);
    3c12:	85da                	mv	a1,s6
    3c14:	00004517          	auipc	a0,0x4
    3c18:	d9450513          	addi	a0,a0,-620 # 79a8 <malloc+0x1e6c>
    ...
    3c34:	d9050513          	addi	a0,a0,-624 # 79c0 <malloc+0x1e84>
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    3cc8:	50c98993          	addi	s3,s3,1292 # 71d0 <malloc+0x1694>
    unlink("irefd");
    3ccc:	00004917          	auipc	s2,0x4
    3cd0:	cd490913          	addi	s2,s2,-812 # 79a0 <malloc+0x1e64>
    chdir("..");
    3cd4:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    3cf0:	48c50513          	addi	a0,a0,1164 # 7178 <malloc+0x163c>
...
0000000000003d10 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    3d20:	cbc50513          	addi	a0,a0,-836 # 79d8 <malloc+0x1e9c>
  ...
  if(pid == 0){
    ...
    3d44:	c9850513          	addi	a0,a0,-872 # 79d8 <malloc+0x1e9c>
    ...
    3d5a:	ca250513          	addi	a0,a0,-862 # 79f8 <malloc+0x1ebc>
    ...
    3d76:	c6e50513          	addi	a0,a0,-914 # 79e0 <malloc+0x1ea4>
    ...
    3d92:	a3a50513          	addi	a0,a0,-1478 # 67c8 <malloc+0xc8c>
  ...
  if(unlink("oidir") != 0){
    ...
    3dc0:	c1c50513          	addi	a0,a0,-996 # 79d8 <malloc+0x1e9c>
    ...
    3dd4:	be850513          	addi	a0,a0,-1048 # 69b8 <malloc+0xe7c>
...
0000000000003e02 <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    3e12:	c1250513          	addi	a0,a0,-1006 # 7a20 <malloc+0x1ee4>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    3e3e:	be650513          	addi	a0,a0,-1050 # 7a20 <malloc+0x1ee4>
  ...
  sleep(10); // one second
    ...
    3e76:	b1650513          	addi	a0,a0,-1258 # 6988 <malloc+0xe4c>
    ...
    3e90:	b9448493          	addi	s1,s1,-1132 # 7a20 <malloc+0x1ee4>
    3e94:	4581                	li	a1,0
    3e96:	8526                	mv	a0,s1
...
0000000000003ed2 <killstatus>:
{
  ...
  exit(0);
    ...
    3f3a:	89250513          	addi	a0,a0,-1902 # 67c8 <malloc+0xc8c>
    ...
    3f60:	ad450513          	addi	a0,a0,-1324 # 7a30 <malloc+0x1ef4>
...
0000000000003f76 <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    3fa0:	9ec50513          	addi	a0,a0,-1556 # 6988 <malloc+0xe4c>
  ...
  if(pid2 == 0)
    ...
    3fce:	7fe50513          	addi	a0,a0,2046 # 67c8 <malloc+0xc8c>
  ...
  if(pid3 == 0){
    ...
    4012:	ff258593          	addi	a1,a1,-14 # 6000 <malloc+0x4c4>
    ...
    403c:	79050513          	addi	a0,a0,1936 # 67c8 <malloc+0xc8c>
    ...
    4058:	9fc50513          	addi	a0,a0,-1540 # 7a50 <malloc+0x1f14>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    4078:	b6458593          	addi	a1,a1,-1180 # bbd8 <buf>
    ...
    4094:	9d850513          	addi	a0,a0,-1576 # 7a68 <malloc+0x1f2c>
  ...
  printf("kill... ");
    ...
    40c0:	9c450513          	addi	a0,a0,-1596 # 7a80 <malloc+0x1f44>
  ...
  printf("wait... ");
    ...
    40f4:	9a050513          	addi	a0,a0,-1632 # 7a90 <malloc+0x1f54>
...
0000000000004120 <reparent>:
{
  ...
  exit(0);
    ...
    4174:	65850513          	addi	a0,a0,1624 # 67c8 <malloc+0xc8c>
    ...
    4190:	7c450513          	addi	a0,a0,1988 # 6950 <malloc+0xe14>
...
00000000000041d2 <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    4208:	6cc50513          	addi	a0,a0,1740 # 68d0 <malloc+0xd94>
    ...
    423c:	dc858593          	addi	a1,a1,-568 # 6000 <malloc+0x4c4>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    4302:	7a250513          	addi	a0,a0,1954 # 7aa0 <malloc+0x1f64>
    ...
    431e:	4ae50513          	addi	a0,a0,1198 # 67c8 <malloc+0xc8c>
    ...
    4354:	6705                	lui	a4,0x1
      n += *(a+i);
    4356:	0007c683          	lbu	a3,0(a5) # 6400000 <__BSS_END__+0x63f1418>
    ...
    436a:	75a50513          	addi	a0,a0,1882 # 7ac0 <malloc+0x1f84>
...
000000000000438a <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    440e:	6e650513          	addi	a0,a0,1766 # 7af0 <malloc+0x1fb4>
...
000000000000442e <sharedfd>:
{
  ...
  if(pid == 0) {
    ...
    44c4:	65050513          	addi	a0,a0,1616 # 7b10 <malloc+0x1fd4>
    ...
    44e0:	65c50513          	addi	a0,a0,1628 # 7b38 <malloc+0x1ffc>
  ...
  fd = open("sharedfd", 0);
    ...
    4524:	8a050513          	addi	a0,a0,-1888 # 5dc0 <malloc+0x284>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    4564:	5f850513          	addi	a0,a0,1528 # 7b58 <malloc+0x201c>
  ...
  unlink("sharedfd");
    ...
    45a0:	82450513          	addi	a0,a0,-2012 # 5dc0 <malloc+0x284>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    45c6:	5be50513          	addi	a0,a0,1470 # 7b80 <malloc+0x2044>
...
00000000000045e6 <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    460c:	62078793          	addi	a5,a5,1568 # 5c28 <malloc+0xec>
    4610:	f6f43823          	sd	a5,-144(s0)
    4614:	00001797          	auipc	a5,0x1
    4618:	61c78793          	addi	a5,a5,1564 # 5c30 <malloc+0xf4>
    461c:	f6f43c23          	sd	a5,-136(s0)
    4620:	00001797          	auipc	a5,0x1
    4624:	61878793          	addi	a5,a5,1560 # 5c38 <malloc+0xfc>
    4628:	f8f43023          	sd	a5,-128(s0)
    462c:	00001797          	auipc	a5,0x1
    4630:	61478793          	addi	a5,a5,1556 # 5c40 <malloc+0x104>
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    4688:	554a0a13          	addi	s4,s4,1364 # bbd8 <buf>
    468c:	00007a97          	auipc	s5,0x7
    4690:	54da8a93          	addi	s5,s5,1357 # bbd9 <buf+0x1>
    if(total != N*SZ){
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    46a8:	52c50513          	addi	a0,a0,1324 # 6bd0 <malloc+0x1094>
    ...
    4724:	47850513          	addi	a0,a0,1144 # 7b98 <malloc+0x205c>
    ...
    473e:	46e50513          	addi	a0,a0,1134 # 7ba8 <malloc+0x206c>
    ...
    4766:	45e50513          	addi	a0,a0,1118 # 7bc0 <malloc+0x2084>
    ...
    4796:	44678793          	addi	a5,a5,1094 # bbd8 <buf>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    47f4:	3e050513          	addi	a0,a0,992 # 7bd0 <malloc+0x2094>
...
0000000000004828 <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4856:	396b8b93          	addi	s7,s7,918 # 7be8 <malloc+0x20ac>
  for(i = 0; i < N; i++){
    ...
    4898:	35c50513          	addi	a0,a0,860 # 7bf0 <malloc+0x20b4>
    ...
    48b6:	33650513          	addi	a0,a0,822 # 7be8 <malloc+0x20ac>
  ...
  fd = open(".", 0);
    ...
    48ee:	d3e50513          	addi	a0,a0,-706 # 6628 <malloc+0xaec>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4964:	2b050513          	addi	a0,a0,688 # 7c10 <malloc+0x20d4>
    ...
    4984:	2b050513          	addi	a0,a0,688 # 7c30 <malloc+0x20f4>
  ...
  for(i = 0; i < N; i++){
    ...
    49bc:	2a050513          	addi	a0,a0,672 # 7c58 <malloc+0x211c>
    ...
    49d8:	df450513          	addi	a0,a0,-524 # 67c8 <malloc+0xc8c>
...
0000000000004b82 <bigfile>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4bc2:	01a90913          	addi	s2,s2,26 # bbd8 <buf>
  for(i = 0; i < N; i++){
    4bc6:	4a51                	li	s4,20
  if(fd < 0){
  ...
  fd = open("bigfile.dat", 0);
    ...
    4c0a:	08a50513          	addi	a0,a0,138 # 7c90 <malloc+0x2154>
  ...
  for(i = 0; ; i++){
    ...
    4c20:	fbc90913          	addi	s2,s2,-68 # bbd8 <buf>
  if(fd < 0){
  ...
  for(i = 0; ; i++){
    ...
    4c6e:	03650513          	addi	a0,a0,54 # 7ca0 <malloc+0x2164>
    ...
    4c8a:	03a50513          	addi	a0,a0,58 # 7cc0 <malloc+0x2184>
    ...
    4ca6:	03e50513          	addi	a0,a0,62 # 7ce0 <malloc+0x21a4>
    ...
    4cc2:	04250513          	addi	a0,a0,66 # 7d00 <malloc+0x21c4>
    ...
    4cde:	04650513          	addi	a0,a0,70 # 7d20 <malloc+0x21e4>
    ...
    4cfa:	04250513          	addi	a0,a0,66 # 7d38 <malloc+0x21fc>
  ...
  unlink("bigfile.dat");
    ...
    4d28:	f6c50513          	addi	a0,a0,-148 # 7c90 <malloc+0x2154>
    ...
    4d4c:	01050513          	addi	a0,a0,16 # 7d58 <malloc+0x221c>
...
0000000000004d62 <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    4d84:	ff850513          	addi	a0,a0,-8 # 7d78 <malloc+0x223c>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    4da4:	fe8c8c93          	addi	s9,s9,-24 # 7d88 <malloc+0x224c>
    int total = 0;
    4da8:	4d81                	li	s11,0
      int cc = write(fd, buf, BSIZE);
    4daa:	00007a17          	auipc	s4,0x7
    4dae:	e2ea0a13          	addi	s4,s4,-466 # bbd8 <buf>
    name[0] = 'f';
    ...
    4e1e:	f7e50513          	addi	a0,a0,-130 # 7d98 <malloc+0x225c>
  ...
  printf("fsfull test finished\n");
    ...
    4e94:	f2850513          	addi	a0,a0,-216 # 7db8 <malloc+0x227c>
    ...
    4ee4:	ec850513          	addi	a0,a0,-312 # 7da8 <malloc+0x226c>
...
0000000000004f02 <rand>:
{
  ...
  randstate = randstate * 1664525 + 1013904223;
    ...
    4f0c:	4a870713          	addi	a4,a4,1192 # 83b0 <randstate>
    4f10:	6308                	ld	a0,0(a4)
    4f12:	001967b7          	lui	a5,0x196
    4f16:	60d78793          	addi	a5,a5,1549 # 19660d <__BSS_END__+0x187a25>
    4f1a:	02f50533          	mul	a0,a0,a5
    4f1e:	3c6ef7b7          	lui	a5,0x3c6ef
    4f22:	35f78793          	addi	a5,a5,863 # 3c6ef35f <__BSS_END__+0x3c6e0777>
...
0000000000004f32 <badwrite>:
{
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
    ...
    4fa6:	e2e50513          	addi	a0,a0,-466 # 7dd0 <malloc+0x2294>
  ...
  if(write(fd, "x", 1) != 1){
    ...
    4fbe:	04658593          	addi	a1,a1,70 # 6000 <malloc+0x4c4>
    ...
    4fd4:	e2050513          	addi	a0,a0,-480 # 7df0 <malloc+0x22b4>
    ...
    4fee:	dee50513          	addi	a0,a0,-530 # 7dd8 <malloc+0x229c>
    ...
    5008:	dd450513          	addi	a0,a0,-556 # 7dd8 <malloc+0x229c>
  ...
  unlink("junk");
    ...
    502c:	da850513          	addi	a0,a0,-600 # 7dd0 <malloc+0x2294>
...
countfree()
{
  ...
  if(pid == 0){
    ...
    5082:	f8298993          	addi	s3,s3,-126 # 6000 <malloc+0x4c4>
      uint64 a = (uint64) sbrk(4096);
    ...
    50b4:	d9050513          	addi	a0,a0,-624 # 7e40 <malloc+0x2304>
    ...
    50ce:	d3650513          	addi	a0,a0,-714 # 7e00 <malloc+0x22c4>
    ...
    50e8:	d3c50513          	addi	a0,a0,-708 # 7e20 <malloc+0x22e4>
  ...
  while(1){
    ...
    5136:	d2e50513          	addi	a0,a0,-722 # 7e60 <malloc+0x2324>
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    5186:	cfe50513          	addi	a0,a0,-770 # 7e80 <malloc+0x2344>
  ...
  if(pid == 0) {
    ...
    51b6:	cf650513          	addi	a0,a0,-778 # 7ea8 <malloc+0x236c>
    ...
    51da:	cba50513          	addi	a0,a0,-838 # 7e90 <malloc+0x2354>
    ...
    5202:	cb250513          	addi	a0,a0,-846 # 7eb0 <malloc+0x2374>
...
main(int argc, char *argv[])
{
  ...
  struct test {
    ...
    524c:	d8078793          	addi	a5,a5,-640 # 7fc8 <malloc+0x248c>
    5250:	c0040713          	addi	a4,s0,-1024
    5254:	00003817          	auipc	a6,0x3
    5258:	13480813          	addi	a6,a6,308 # 8388 <malloc+0x284c>
  ...
  printf("usertests starting\n");
    ...
    527c:	cf050513          	addi	a0,a0,-784 # 7f68 <malloc+0x242c>
  ...
  if(fail){
    ...
    52b4:	c7050513          	addi	a0,a0,-912 # 7f20 <malloc+0x23e4>
  ...
  if(argc == 2 && strcmp(argv[1], "-c") == 0){
    ...
    52d0:	bec58593          	addi	a1,a1,-1044 # 7eb8 <malloc+0x237c>
    ...
    52e6:	cbe58593          	addi	a1,a1,-834 # 7fa0 <malloc+0x2464>
    ...
    530a:	bba50513          	addi	a0,a0,-1094 # 7ec0 <malloc+0x2384>
  ...
  if(fail){
    ...
    5376:	b9650513          	addi	a0,a0,-1130 # 7f08 <malloc+0x23cc>
    ...
    5390:	bc450513          	addi	a0,a0,-1084 # 7f50 <malloc+0x2414>
    ...
    53ee:	bde78793          	addi	a5,a5,-1058 # 7fc8 <malloc+0x248c>
    53f2:	c0040713          	addi	a4,s0,-1024
    53f6:	00003817          	auipc	a6,0x3
    53fa:	f9280813          	addi	a6,a6,-110 # 8388 <malloc+0x284c>
    ...
    541e:	b6650513          	addi	a0,a0,-1178 # 7f80 <malloc+0x2444>
    5422:	00000097          	auipc	ra,0x0
    5426:	65c080e7          	jalr	1628(ra) # 5a7e <printf>
        printf("SOME TESTS FAILED\n");
    542a:	00003a97          	auipc	s5,0x3
    542e:	adea8a93          	addi	s5,s5,-1314 # 7f08 <malloc+0x23cc>
        if(continuous != 2)
    5432:	4a09                	li	s4,2
        printf("FAILED -- lost %d free pages\n", free0 - free1);
    5434:	00003b17          	auipc	s6,0x3
    5438:	ab4b0b13          	addi	s6,s6,-1356 # 7ee8 <malloc+0x23ac>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    57ee:	ba650513          	addi	a0,a0,-1114 # 8390 <digits>
    57f2:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  state = 0;
    ...
    58ba:	adab8b93          	addi	s7,s7,-1318 # 8390 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    59fa:	99290913          	addi	s2,s2,-1646 # 8388 <malloc+0x284c>
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    5ac2:	8fa7b783          	ld	a5,-1798(a5) # 83b8 <freep>
    ...
    5af0:	00e6ea63          	bltu	a3,a4,5b04 <free+0x50>
{
  ...
  freep = p;
    ...
    5b32:	88f73523          	sd	a5,-1910(a4) # 83b8 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    5b64:	85853503          	ld	a0,-1960(a0) # 83b8 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    5b8c:	83090913          	addi	s2,s2,-2000 # 83b8 <freep>
  if(p == (char*)-1)
    5b90:	5afd                	li	s5,-1
    5b92:	a895                	j	5c06 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
    5b94:	00009797          	auipc	a5,0x9
    5b98:	04478793          	addi	a5,a5,68 # ebd8 <base>
    5b9c:	00003717          	auipc	a4,0x3
    5ba0:	80f73e23          	sd	a5,-2020(a4) # 83b8 <freep>
    ...
    5bc0:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    5bc4:	00002717          	auipc	a4,0x2
    5bc8:	7ea73a23          	sd	a0,2036(a4) # 83b8 <freep>
      return (void*)(p + 1);
