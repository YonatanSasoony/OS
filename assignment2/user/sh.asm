...
getcmd(char *buf, int nbuf)
{
  ...
  fprintf(2, "$ ");
      ...
      14:	32858593          	addi	a1,a1,808 # 1338 <malloc+0xe6>
      18:	4509                	li	a0,2
...
panic(char *s)
{
  ...
  fprintf(2, "%s\n", s);
      ...
      62:	2e258593          	addi	a1,a1,738 # 1340 <malloc+0xee>
      66:	4509                	li	a0,2
...
fork1(void)
{
  ...
  return pid;
    ...
    panic("fork");
      ...
      9c:	2b050513          	addi	a0,a0,688 # 1348 <malloc+0xf6>
...
00000000000000a8 <runcmd>:
{
  ...
  switch(cmd->type){
      ...
      c8:	38470713          	addi	a4,a4,900 # 1448 <malloc+0x1f6>
    ...
    panic("runcmd");
      ...
      e2:	27250513          	addi	a0,a0,626 # 1350 <malloc+0xfe>
    ...
    fprintf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     104:	25858593          	addi	a1,a1,600 # 1358 <malloc+0x106>
     108:	4509                	li	a0,2
  ...
  exit(0);
    ...
    runcmd(rcmd->cmd);
     ...
     150:	21c58593          	addi	a1,a1,540 # 1368 <malloc+0x116>
     154:	4509                	li	a0,2
    ...
    break;
     ...
     1e6:	19650513          	addi	a0,a0,406 # 1378 <malloc+0x126>
...
gettoken(char **ps, char *es, char **q, char **eq)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     462:	04298993          	addi	s3,s3,66 # 14a0 <whitespace>
  ...
  *ps = s;
  ...
  switch(*s){
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     4cc:	fd898993          	addi	s3,s3,-40 # 14a0 <whitespace>
     4d0:	00001a97          	auipc	s5,0x1
     4d4:	fc8a8a93          	addi	s5,s5,-56 # 1498 <symbols>
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     536:	f6e98993          	addi	s3,s3,-146 # 14a0 <whitespace>
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     5a6:	dfeb8b93          	addi	s7,s7,-514 # 13a0 <malloc+0x14e>
  ...
  while(peek(ps, es, "<>")){
     ...
     5b8:	dcc50513          	addi	a0,a0,-564 # 1380 <malloc+0x12e>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     6a0:	d0c60613          	addi	a2,a2,-756 # 13a8 <malloc+0x156>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     6d0:	cfcb0b13          	addi	s6,s6,-772 # 13c8 <malloc+0x176>
  ...
  return ret;
     ...
     70a:	caa50513          	addi	a0,a0,-854 # 13b0 <malloc+0x15e>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     76c:	c5050513          	addi	a0,a0,-944 # 13b8 <malloc+0x166>
...
0000000000000786 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     7a6:	c2e60613          	addi	a2,a2,-978 # 13d0 <malloc+0x17e>
     7aa:	85ce                	mv	a1,s3
     7ac:	854a                	mv	a0,s2
...
00000000000007f4 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     816:	bc6a0a13          	addi	s4,s4,-1082 # 13d8 <malloc+0x186>
  ...
  if(peek(ps, es, ";")){
     ...
     84c:	b9860613          	addi	a2,a2,-1128 # 13e0 <malloc+0x18e>
     850:	85ce                	mv	a1,s3
     852:	854a                	mv	a0,s2
...
000000000000089c <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     ...
     8b2:	afa60613          	addi	a2,a2,-1286 # 13a8 <malloc+0x156>
  ...
  if(!peek(ps, es, ")"))
     ...
     8e2:	b1a60613          	addi	a2,a2,-1254 # 13f8 <malloc+0x1a6>
     8e6:	85ca                	mv	a1,s2
     8e8:	8526                	mv	a0,s1
  ...
  cmd = parseredirs(cmd, ps, es);
    ...
    panic("parseblock");
     ...
     924:	ac850513          	addi	a0,a0,-1336 # 13e8 <malloc+0x196>
     928:	fffff097          	auipc	ra,0xfffff
     92c:	72c080e7          	jalr	1836(ra) # 54 <panic>
    panic("syntax - missing )");
     930:	00001517          	auipc	a0,0x1
     934:	ad050513          	addi	a0,a0,-1328 # 1400 <malloc+0x1ae>
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     960:	b0470713          	addi	a4,a4,-1276 # 1460 <malloc+0x20e>
...
00000000000009d8 <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     a0c:	a1060613          	addi	a2,a2,-1520 # 1418 <malloc+0x1c6>
     a10:	85a6                	mv	a1,s1
  ...
  nulterminate(cmd);
    ...
    fprintf(2, "leftovers: %s\n", s);
     ...
     a42:	9e258593          	addi	a1,a1,-1566 # 1420 <malloc+0x1ce>
     a46:	4509                	li	a0,2
     a48:	00000097          	auipc	ra,0x0
     a4c:	71e080e7          	jalr	1822(ra) # 1166 <fprintf>
    panic("syntax");
     a50:	00001517          	auipc	a0,0x1
     a54:	96050513          	addi	a0,a0,-1696 # 13b0 <malloc+0x15e>
...
0000000000000a60 <main>:
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     a76:	9be48493          	addi	s1,s1,-1602 # 1430 <malloc+0x1de>
     a7a:	4589                	li	a1,2
     a7c:	8526                	mv	a0,s1
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
     ...
     a9c:	a1848493          	addi	s1,s1,-1512 # 14b0 <buf.0>
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     aa0:	06300913          	li	s2,99
     aa4:	02000993          	li	s3,32
      if(chdir(buf+3) < 0)
     aa8:	00001a17          	auipc	s4,0x1
     aac:	a0ba0a13          	addi	s4,s4,-1525 # 14b3 <buf.0+0x3>
        fprintf(2, "cannot cd %s\n", buf+3);
     ab0:	00001a97          	auipc	s5,0x1
     ab4:	988a8a93          	addi	s5,s5,-1656 # 1438 <malloc+0x1e6>
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     b36:	97e50513          	addi	a0,a0,-1666 # 14b0 <buf.0>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     f04:	58050513          	addi	a0,a0,1408 # 1480 <digits>
     f08:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  state = 0;
    ...
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     ...
     fd0:	4b4b8b93          	addi	s7,s7,1204 # 1480 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    1110:	36c90913          	addi	s2,s2,876 # 1478 <malloc+0x226>
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    11d8:	2d47b783          	ld	a5,724(a5) # 14a8 <freep>
    ...
    1206:	00e6ea63          	bltu	a3,a4,121a <free+0x50>
{
  ...
  freep = p;
    ...
    1248:	26f73223          	sd	a5,612(a4) # 14a8 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    127a:	23253503          	ld	a0,562(a0) # 14a8 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    12a2:	20a90913          	addi	s2,s2,522 # 14a8 <freep>
  if(p == (char*)-1)
    12a6:	5afd                	li	s5,-1
    12a8:	a895                	j	131c <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
    12aa:	00000797          	auipc	a5,0x0
    12ae:	26e78793          	addi	a5,a5,622 # 1518 <base>
    12b2:	00000717          	auipc	a4,0x0
    12b6:	1ef73b23          	sd	a5,502(a4) # 14a8 <freep>
    ...
    12de:	1ca73723          	sd	a0,462(a4) # 14a8 <freep>
      return (void*)(p + 1);
