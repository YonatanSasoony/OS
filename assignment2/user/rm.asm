...
free(void *ap)
{
 ...
 6fc:	1c07b783          	ld	a5,448(a5) # 8b8 <freep>
 ...
 72a:	00e6ea63          	bltu	a3,a4,73e <free+0x50>
{
 ...
 76c:	14f73823          	sd	a5,336(a4) # 8b8 <freep>
}
 770:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 79e:	11e53503          	ld	a0,286(a0) # 8b8 <freep>
 ...
 7c6:	0f690913          	addi	s2,s2,246 # 8b8 <freep>
  if(p == (char*)-1)
 7ca:	5afd                	li	s5,-1
 7cc:	a895                	j	840 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 7ce:	00000797          	auipc	a5,0x0
 7d2:	0f278793          	addi	a5,a5,242 # 8c0 <base>
 7d6:	00000717          	auipc	a4,0x0
 7da:	0ef73123          	sd	a5,226(a4) # 8b8 <freep>
 7de:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 802:	0aa73d23          	sd	a0,186(a4) # 8b8 <freep>
      return (void*)(p + 1);
