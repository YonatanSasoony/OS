...
wc(int fd, char *name)
{
  ...
  3c:	948a0a13          	addi	s4,s4,-1720 # 980 <malloc+0xec>
        inword = 0;
  40:	4b01                	li	s6,0
  while((n = read(fd, buf, sizeof(buf))) > 0){
  ...
  ba:	8e250513          	addi	a0,a0,-1822 # 998 <malloc+0x104>
  ...
  e8:	8a450513          	addi	a0,a0,-1884 # 988 <malloc+0xf4>
...
main(int argc, char *argv[])
{
 ...
 162:	84a58593          	addi	a1,a1,-1974 # 9a8 <malloc+0x114>
 166:	4501                	li	a0,0
 ...
 180:	83450513          	addi	a0,a0,-1996 # 9b0 <malloc+0x11c>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 546:	48e50513          	addi	a0,a0,1166 # 9d0 <digits>
 54a:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 612:	3c2b8b93          	addi	s7,s7,962 # 9d0 <digits>
 ...
 752:	27a90913          	addi	s2,s2,634 # 9c8 <malloc+0x134>
        while(*s != 0){
...
free(void *ap)
{
 ...
 81a:	1d27b783          	ld	a5,466(a5) # 9e8 <freep>
 ...
 848:	00e6ea63          	bltu	a3,a4,85c <free+0x50>
{
 ...
 88a:	16f73123          	sd	a5,354(a4) # 9e8 <freep>
}
 88e:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 8bc:	13053503          	ld	a0,304(a0) # 9e8 <freep>
 ...
 8e4:	10890913          	addi	s2,s2,264 # 9e8 <freep>
  if(p == (char*)-1)
 8e8:	5afd                	li	s5,-1
 8ea:	a895                	j	95e <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 8ec:	00000797          	auipc	a5,0x0
 8f0:	30478793          	addi	a5,a5,772 # bf0 <base>
 8f4:	00000717          	auipc	a4,0x0
 8f8:	0ef73a23          	sd	a5,244(a4) # 9e8 <freep>
 8fc:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 920:	0ca73623          	sd	a0,204(a4) # 9e8 <freep>
      return (void*)(p + 1);
