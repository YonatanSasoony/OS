...
printint(int fd, int xx, int base, int sgn)
{
 ...
 64e:	47e50513          	addi	a0,a0,1150 # ac8 <digits>
 652:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 71a:	3b2b8b93          	addi	s7,s7,946 # ac8 <digits>
 ...
 85a:	26a90913          	addi	s2,s2,618 # ac0 <malloc+0x124>
        while(*s != 0){
...
free(void *ap)
{
 ...
 922:	1c27b783          	ld	a5,450(a5) # ae0 <freep>
 ...
 950:	00e6ea63          	bltu	a3,a4,964 <free+0x50>
{
 ...
 992:	14f73923          	sd	a5,338(a4) # ae0 <freep>
}
 996:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 9c4:	12053503          	ld	a0,288(a0) # ae0 <freep>
 ...
 9ec:	0f890913          	addi	s2,s2,248 # ae0 <freep>
  if(p == (char*)-1)
 9f0:	5afd                	li	s5,-1
 9f2:	a895                	j	a66 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 9f4:	00000797          	auipc	a5,0x0
 9f8:	4f478793          	addi	a5,a5,1268 # ee8 <base>
 9fc:	00000717          	auipc	a4,0x0
 a00:	0ef73223          	sd	a5,228(a4) # ae0 <freep>
 a04:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 a28:	0aa73e23          	sd	a0,188(a4) # ae0 <freep>
      return (void*)(p + 1);
