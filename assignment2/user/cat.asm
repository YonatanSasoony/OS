...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4ce:	48e50513          	addi	a0,a0,1166 # 958 <digits>
 4d2:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 59a:	3c2b8b93          	addi	s7,s7,962 # 958 <digits>
 ...
 6da:	27a90913          	addi	s2,s2,634 # 950 <malloc+0x134>
        while(*s != 0){
...
free(void *ap)
{
 ...
 7a2:	1d27b783          	ld	a5,466(a5) # 970 <freep>
 ...
 7d0:	00e6ea63          	bltu	a3,a4,7e4 <free+0x50>
{
 ...
 812:	16f73123          	sd	a5,354(a4) # 970 <freep>
}
 816:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 844:	13053503          	ld	a0,304(a0) # 970 <freep>
 ...
 86c:	10890913          	addi	s2,s2,264 # 970 <freep>
  if(p == (char*)-1)
 870:	5afd                	li	s5,-1
 872:	a895                	j	8e6 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 874:	00000797          	auipc	a5,0x0
 878:	30478793          	addi	a5,a5,772 # b78 <base>
 87c:	00000717          	auipc	a4,0x0
 880:	0ef73a23          	sd	a5,244(a4) # 970 <freep>
 884:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
