...
main(int argc, char *argv[])
{
  ...
  14:	83858593          	addi	a1,a1,-1992 # 848 <malloc+0xea>
  18:	4509                	li	a0,2
  ...
  50:	81458593          	addi	a1,a1,-2028 # 860 <malloc+0x102>
  54:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 410:	47450513          	addi	a0,a0,1140 # 880 <digits>
 414:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4dc:	3a8b8b93          	addi	s7,s7,936 # 880 <digits>
 ...
 61c:	26090913          	addi	s2,s2,608 # 878 <malloc+0x11a>
        while(*s != 0){
...
free(void *ap)
{
 ...
 6e4:	1b87b783          	ld	a5,440(a5) # 898 <freep>
 ...
 712:	00e6ea63          	bltu	a3,a4,726 <free+0x50>
{
 ...
 754:	14f73423          	sd	a5,328(a4) # 898 <freep>
}
 758:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 786:	11653503          	ld	a0,278(a0) # 898 <freep>
 ...
 7ae:	0ee90913          	addi	s2,s2,238 # 898 <freep>
  if(p == (char*)-1)
 7b2:	5afd                	li	s5,-1
 7b4:	a895                	j	828 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 7b6:	00000797          	auipc	a5,0x0
 7ba:	0ea78793          	addi	a5,a5,234 # 8a0 <base>
 7be:	00000717          	auipc	a4,0x0
 7c2:	0cf73d23          	sd	a5,218(a4) # 898 <freep>
 7c6:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7ea:	0aa73923          	sd	a0,178(a4) # 898 <freep>
      return (void*)(p + 1);
