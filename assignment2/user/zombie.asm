...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3da:	44250513          	addi	a0,a0,1090 # 818 <digits>
 3de:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4a6:	376b8b93          	addi	s7,s7,886 # 818 <digits>
 ...
 5e6:	22e90913          	addi	s2,s2,558 # 810 <malloc+0xe8>
        while(*s != 0){
...
free(void *ap)
{
 ...
 6ae:	1867b783          	ld	a5,390(a5) # 830 <freep>
 ...
 6dc:	00e6ea63          	bltu	a3,a4,6f0 <free+0x50>
{
 ...
 71e:	10f73b23          	sd	a5,278(a4) # 830 <freep>
}
 722:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 750:	0e453503          	ld	a0,228(a0) # 830 <freep>
 ...
 778:	0bc90913          	addi	s2,s2,188 # 830 <freep>
  if(p == (char*)-1)
 77c:	5afd                	li	s5,-1
 77e:	a895                	j	7f2 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 780:	00000797          	auipc	a5,0x0
 784:	0b878793          	addi	a5,a5,184 # 838 <base>
 788:	00000717          	auipc	a4,0x0
 78c:	0af73423          	sd	a5,168(a4) # 830 <freep>
 790:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7b4:	08a73023          	sd	a0,128(a4) # 830 <freep>
      return (void*)(p + 1);
