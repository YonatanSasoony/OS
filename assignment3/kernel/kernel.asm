...
main()
{
  ...
  scheduler();        
    ...
    80000f5e:	718080e7          	jalr	1816(ra) # 80004672 <fileinit>
    virtio_disk_init(); // emulated hard disk
...
forkret(void)
{
  ...
  if (first) {
    ...
    800019d2:	e627a783          	lw	a5,-414(a5) # 80008830 <first.1>
  ...
  usertrapret();
    ...
    800019ec:	e407a423          	sw	zero,-440(a5) # 80008830 <first.1>
    fsinit(ROOTDEV);
...
allocpid() {
  ...
  pid = nextpid;
    ...
    80001a1e:	e1a78793          	addi	a5,a5,-486 # 80008834 <nextpid>
...
0000000080001b88 <allocproc>:
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80001ba0:	73490913          	addi	s2,s2,1844 # 800172d0 <tickslock>
    acquire(&p->lock);
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    80001bbc:	17048493          	addi	s1,s1,368
...
0000000080001d4c <fork>:
{
  ...
  *(np->trapframe) = *(p->trapframe);
  ...
  for(i = 0; i < NOFILE; i++)
    ...
    80001e00:	908080e7          	jalr	-1784(ra) # 80004704 <filedup>
...
0000000080001e8c <scheduler>:
{
  ...
  c->proc = 0;
    ...
    80001ed4:	40090913          	addi	s2,s2,1024 # 800172d0 <tickslock>
  asm volatile("csrr %0, sstatus" : "=r" (x) );
...
00000000800020a2 <wait>:
{
  ...
  acquire(&wait_lock);
    ...
    800020e0:	1f498993          	addi	s3,s3,500 # 800172d0 <tickslock>
    ...
    for(np = proc; np < &proc[NPROC]; np++){
    8000215c:	17048493          	addi	s1,s1,368
...
wakeup(void *chan)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    800021ee:	0e690913          	addi	s2,s2,230 # 800172d0 <tickslock>
...
0000000080002240 <reparent>:
{
  ...
  for(pp = proc; pp < &proc[NPROC]; pp++){
    ...
    80002266:	06e98993          	addi	s3,s3,110 # 800172d0 <tickslock>
...
000000008000229a <exit>:
{
  ...
  if(p == initproc)
    ...
    800022de:	47c080e7          	jalr	1148(ra) # 80004756 <fileclose>
      p->ofile[fd] = 0;
  ...
  begin_op();
    ...
    800022f6:	f98080e7          	jalr	-104(ra) # 8000428a <begin_op>
  iput(p->cwd);
  ...
  end_op();
    ...
    8000230a:	004080e7          	jalr	4(ra) # 8000430a <end_op>
  p->cwd = 0;
...
kill(int pid)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++){
    ...
    8000238c:	f4898993          	addi	s3,s3,-184 # 800172d0 <tickslock>
    acquire(&p->lock);
  ...
  for(p = proc; p < &proc[NPROC]; p++){
    800023aa:	17048493          	addi	s1,s1,368
...
procdump(void)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++){
    ...
    800024c0:	f6c90913          	addi	s2,s2,-148 # 80017428 <bcache+0x140>
    if(p->state == UNUSED)
      continue;
...
trapinit(void)
{
  ...
  initlock(&tickslock, "time");
    ...
    800025bc:	d1850513          	addi	a0,a0,-744 # 800172d0 <tickslock>
...
trapinithart(void)
{
  ...
  asm volatile("csrw stvec, %0" : : "r" (x));
    800025d6:	00004797          	auipc	a5,0x4
    800025da:	9ba78793          	addi	a5,a5,-1606 # 80005f90 <kernelvec>
...
clockintr()
{
  ...
  acquire(&tickslock);
    ...
    80002694:	c4048493          	addi	s1,s1,-960 # 800172d0 <tickslock>
...
devintr()
{
  ...
  if((scause & 0x8000000000000000L) &&
    ...
    80002702:	99a080e7          	jalr	-1638(ra) # 80006098 <plic_claim>
    ...
    80002730:	990080e7          	jalr	-1648(ra) # 800060bc <plic_complete>
    return 1;
    ...
    80002746:	e0c080e7          	jalr	-500(ra) # 8000654e <virtio_disk_intr>
...
000000008000276e <usertrap>:
{
  ...
  asm volatile("csrw stvec, %0" : : "r" (x));
    80002784:	00004797          	auipc	a5,0x4
    80002788:	80c78793          	addi	a5,a5,-2036 # 80005f90 <kernelvec>
...
sys_sleep(void)
{
  ...
  acquire(&tickslock);
    ...
    80002c16:	6be50513          	addi	a0,a0,1726 # 800172d0 <tickslock>
  ...
  while(ticks - ticks0 < n){
    ...
    80002c34:	6a098993          	addi	s3,s3,1696 # 800172d0 <tickslock>
  ...
  release(&tickslock);
    ...
    80002c6a:	66a50513          	addi	a0,a0,1642 # 800172d0 <tickslock>
  ...
  return 0;
    ...
    80002c8c:	64850513          	addi	a0,a0,1608 # 800172d0 <tickslock>
...
sys_uptime(void)
{
  ...
  acquire(&tickslock);
    ...
    80002cdc:	5f850513          	addi	a0,a0,1528 # 800172d0 <tickslock>
  ...
  release(&tickslock);
    ...
    80002cf4:	5e050513          	addi	a0,a0,1504 # 800172d0 <tickslock>
...
binit(void)
{
  ...
  initlock(&bcache.lock, "bcache");
    ...
    80002d2c:	5c050513          	addi	a0,a0,1472 # 800172e8 <bcache>
  ...
  bcache.head.prev = &bcache.head;
    ...
    80002d3c:	5b078793          	addi	a5,a5,1456 # 8001f2e8 <bcache+0x8000>
    80002d40:	0001d717          	auipc	a4,0x1d
    80002d44:	81070713          	addi	a4,a4,-2032 # 8001f550 <bcache+0x8268>
    80002d48:	2ae7b823          	sd	a4,688(a5)
  bcache.head.next = &bcache.head;
    80002d4c:	2ae7bc23          	sd	a4,696(a5)
  for(b = bcache.buf; b < bcache.buf+NBUF; b++){
    80002d50:	00014497          	auipc	s1,0x14
    80002d54:	5b048493          	addi	s1,s1,1456 # 80017300 <bcache+0x18>
    ...
    80002d78:	7d4080e7          	jalr	2004(ra) # 80004548 <initsleeplock>
...
bread(uint dev, uint blockno)
{
  ...
  acquire(&bcache.lock);
    ...
    80002db4:	53850513          	addi	a0,a0,1336 # 800172e8 <bcache>
    80002db8:	ffffe097          	auipc	ra,0xffffe
    80002dbc:	e0a080e7          	jalr	-502(ra) # 80000bc2 <acquire>
  for(b = bcache.head.next; b != &bcache.head; b = b->next){
    80002dc0:	0001c497          	auipc	s1,0x1c
    80002dc4:	7e04b483          	ld	s1,2016(s1) # 8001f5a0 <bcache+0x82b8>
    80002dc8:	0001c797          	auipc	a5,0x1c
    80002dcc:	78878793          	addi	a5,a5,1928 # 8001f550 <bcache+0x8268>
    ...
    80002df4:	4f850513          	addi	a0,a0,1272 # 800172e8 <bcache>
    ...
    80002e08:	77e080e7          	jalr	1918(ra) # 80004582 <acquiresleep>
      return b;
    80002e0c:	a8b9                	j	80002e6a <bread+0xcc>
  for(b = bcache.head.prev; b != &bcache.head; b = b->prev){
    80002e0e:	0001c497          	auipc	s1,0x1c
    80002e12:	78a4b483          	ld	s1,1930(s1) # 8001f598 <bcache+0x82b0>
    80002e16:	0001c797          	auipc	a5,0x1c
    80002e1a:	73a78793          	addi	a5,a5,1850 # 8001f550 <bcache+0x8268>
  ...
  panic("bget: no buffers");
    ...
    80002e52:	49a50513          	addi	a0,a0,1178 # 800172e8 <bcache>
    ...
    80002e66:	720080e7          	jalr	1824(ra) # 80004582 <acquiresleep>
  struct buf *b;
  ...
  return b;
    ...
    80002e86:	444080e7          	jalr	1092(ra) # 800062c6 <virtio_disk_rw>
    b->valid = 1;
...
bwrite(struct buf *b)
{
  ...
  if(!holdingsleep(&b->lock))
    ...
    80002ea2:	77e080e7          	jalr	1918(ra) # 8000461c <holdingsleep>
  ...
  virtio_disk_rw(b, 1);
    ...
    80002eb0:	41a080e7          	jalr	1050(ra) # 800062c6 <virtio_disk_rw>
}
...
brelse(struct buf *b)
{
  ...
  if(!holdingsleep(&b->lock))
    ...
    80002ee6:	73a080e7          	jalr	1850(ra) # 8000461c <holdingsleep>
  ...
  releasesleep(&b->lock);
    ...
    80002ef2:	6ea080e7          	jalr	1770(ra) # 800045d8 <releasesleep>
  ...
  if (b->refcnt == 0) {
    ...
    80002f22:	3ca78793          	addi	a5,a5,970 # 8001f2e8 <bcache+0x8000>
    80002f26:	2b87b703          	ld	a4,696(a5)
    80002f2a:	e8b8                	sd	a4,80(s1)
    b->prev = &bcache.head;
    80002f2c:	0001c717          	auipc	a4,0x1c
    80002f30:	62470713          	addi	a4,a4,1572 # 8001f550 <bcache+0x8268>
  ...
  release(&bcache.lock);
    ...
    80002f44:	3a850513          	addi	a0,a0,936 # 800172e8 <bcache>
...
bpin(struct buf *b) {
  ...
  acquire(&bcache.lock);
    ...
    80002f7c:	37050513          	addi	a0,a0,880 # 800172e8 <bcache>
...
bunpin(struct buf *b) {
  ...
  release(&bcache.lock);
    ...
    80002fce:	31e50513          	addi	a0,a0,798 # 800172e8 <bcache>
...
bfree(int dev, uint b)
{
  ...
  bp = bread(dev, BBLOCK(b, sb));
    ...
    80002ffa:	9ce7a783          	lw	a5,-1586(a5) # 8001f9c4 <sb+0x1c>
  ...
  log_write(bp);
    ...
    80003036:	430080e7          	jalr	1072(ra) # 80004462 <log_write>
  brelse(bp);
...
0000000080003060 <balloc>:
{
  ...
  for(b = 0; b < sb.size; b += BPB){
    ...
    8000307e:	9327a783          	lw	a5,-1742(a5) # 8001f9ac <sb+0x4>
    80003082:	cbd1                	beqz	a5,80003116 <balloc+0xb6>
    80003084:	8baa                	mv	s7,a0
    80003086:	4a81                	li	s5,0
    bp = bread(dev, BBLOCK(b, sb));
    80003088:	0001db17          	auipc	s6,0x1d
    8000308c:	920b0b13          	addi	s6,s6,-1760 # 8001f9a8 <sb>
  ...
  panic("balloc: out of blocks");
    ...
    80003134:	332080e7          	jalr	818(ra) # 80004462 <log_write>
        brelse(bp);
  ...
  log_write(bp);
    ...
    80003168:	2fe080e7          	jalr	766(ra) # 80004462 <log_write>
  brelse(bp);
...
bmap(struct inode *ip, uint bn)
{
  ...
  panic("bmap: out of range");
    ...
    80003258:	20e080e7          	jalr	526(ra) # 80004462 <log_write>
...
000000008000326e <iget>:
{
  ...
  acquire(&itable.lock);
    ...
    80003286:	74650513          	addi	a0,a0,1862 # 8001f9c8 <itable>
  ...
  for(ip = &itable.inode[0]; ip < &itable.inode[NINODE]; ip++){
    ...
    80003298:	74c48493          	addi	s1,s1,1868 # 8001f9e0 <itable+0x18>
    8000329c:	0001e697          	auipc	a3,0x1e
    800032a0:	1d468693          	addi	a3,a3,468 # 80021470 <log>
  ...
  for(ip = &itable.inode[0]; ip < &itable.inode[NINODE]; ip++){
    ...
    800032cc:	70050513          	addi	a0,a0,1792 # 8001f9c8 <itable>
  ...
  release(&itable.lock);
    ...
    800032fc:	6d050513          	addi	a0,a0,1744 # 8001f9c8 <itable>
...
fsinit(int dev) {
  ...
  memmove(sb, bp->data, sizeof(*sb));
    ...
    8000334a:	66298993          	addi	s3,s3,1634 # 8001f9a8 <sb>
  ...
  initlog(dev, &sb);
    ...
    8000337e:	62e58593          	addi	a1,a1,1582 # 8001f9a8 <sb>
    80003382:	854a                	mv	a0,s2
    80003384:	00001097          	auipc	ra,0x1
    80003388:	e60080e7          	jalr	-416(ra) # 800041e4 <initlog>
}
...
00000000800033aa <iinit>:
{
  ...
  initlock(&itable.lock, "itable");
    ...
    800033c4:	60850513          	addi	a0,a0,1544 # 8001f9c8 <itable>
    800033c8:	ffffd097          	auipc	ra,0xffffd
    800033cc:	76a080e7          	jalr	1898(ra) # 80000b32 <initlock>
  for(i = 0; i < NINODE; i++) {
    800033d0:	0001c497          	auipc	s1,0x1c
    800033d4:	62048493          	addi	s1,s1,1568 # 8001f9f0 <itable+0x28>
    800033d8:	0001e997          	auipc	s3,0x1e
    800033dc:	0a898993          	addi	s3,s3,168 # 80021480 <log+0x10>
    ...
    800033f0:	15c080e7          	jalr	348(ra) # 80004548 <initsleeplock>
  for(i = 0; i < NINODE; i++) {
...
000000008000340a <ialloc>:
{
  ...
  for(inum = 1; inum < sb.ninodes; inum++){
    ...
    80003424:	59472703          	lw	a4,1428(a4) # 8001f9b4 <sb+0xc>
    ...
    80003438:	574a0a13          	addi	s4,s4,1396 # 8001f9a8 <sb>
  ...
  panic("ialloc: no inodes");
    ...
    800034a8:	fbe080e7          	jalr	-66(ra) # 80004462 <log_write>
      brelse(bp);
...
00000000800034d8 <iupdate>:
{
  ...
  bp = bread(ip->dev, IBLOCK(ip->inum, sb));
    ...
    800034f0:	4d45a583          	lw	a1,1236(a1) # 8001f9c0 <sb+0x18>
  ...
  log_write(bp);
    ...
    8000354a:	f1c080e7          	jalr	-228(ra) # 80004462 <log_write>
  brelse(bp);
...
0000000080003564 <idup>:
{
  ...
  acquire(&itable.lock);
    ...
    80003574:	45850513          	addi	a0,a0,1112 # 8001f9c8 <itable>
  ...
  release(&itable.lock);
    ...
    8000358a:	44250513          	addi	a0,a0,1090 # 8001f9c8 <itable>
...
00000000800035a2 <ilock>:
{
  ...
  acquiresleep(&ip->lock);
    ...
    800035be:	fc8080e7          	jalr	-56(ra) # 80004582 <acquiresleep>
  if(ip->valid == 0){
    ...
    800035ec:	3d85a583          	lw	a1,984(a1) # 8001f9c0 <sb+0x18>
...
0000000080003664 <iunlock>:
{
  ...
  if(ip == 0 || !holdingsleep(&ip->lock) || ip->ref < 1)
    ...
    8000367e:	fa2080e7          	jalr	-94(ra) # 8000461c <holdingsleep>
  ...
  releasesleep(&ip->lock);
    ...
    80003690:	f4c080e7          	jalr	-180(ra) # 800045d8 <releasesleep>
}
...
000000008000375c <iput>:
{
  ...
  acquire(&itable.lock);
    ...
    8000376e:	25e50513          	addi	a0,a0,606 # 8001f9c8 <itable>
  ...
  release(&itable.lock);
    ...
    8000378c:	24050513          	addi	a0,a0,576 # 8001f9c8 <itable>
  ...
  if(ip->ref == 1 && ip->valid && ip->nlink == 0){
    ...
    800037b8:	dce080e7          	jalr	-562(ra) # 80004582 <acquiresleep>
    release(&itable.lock);
    800037bc:	0001c517          	auipc	a0,0x1c
    800037c0:	20c50513          	addi	a0,a0,524 # 8001f9c8 <itable>
    ...
    800037ee:	dee080e7          	jalr	-530(ra) # 800045d8 <releasesleep>
    acquire(&itable.lock);
    800037f2:	0001c517          	auipc	a0,0x1c
    800037f6:	1d650513          	addi	a0,a0,470 # 8001f9c8 <itable>
    ...
    80003950:	10d7e863          	bltu	a5,a3,80003a60 <writei+0x112>
{
  ...
  for(tot=0; tot<n; tot+=m, off+=m, src+=m){
    ...
    800039c0:	aa6080e7          	jalr	-1370(ra) # 80004462 <log_write>
    brelse(bp);
...
0000000080003c96 <dirlink>:
{
  ...
  if(writei(dp, 0, (uint64)&de, off, sizeof(de)) != sizeof(de))
    ...
    80003d4c:	a3850513          	addi	a0,a0,-1480 # 80008780 <syscalls+0x350>
...
char* itoa(int i, char b[]){
    ...
    80003d94:	ec22                	sd	s0,24(sp)
    80003d96:	1000                	addi	s0,sp,32
    80003d98:	872a                	mv	a4,a0
    80003d9a:	852e                	mv	a0,a1
    char const digit[] = "0123456789";
    80003d9c:	00005797          	auipc	a5,0x5
    80003da0:	86c78793          	addi	a5,a5,-1940 # 80008608 <syscalls+0x1d8>
    80003da4:	6394                	ld	a3,0(a5)
    80003da6:	fed43023          	sd	a3,-32(s0)
    80003daa:	0087d683          	lhu	a3,8(a5)
    80003dae:	fed41423          	sh	a3,-24(s0)
    80003db2:	00a7c783          	lbu	a5,10(a5)
    80003db6:	fef40523          	sb	a5,-22(s0)
    char* p = b;
    80003dba:	87ae                	mv	a5,a1
    if(i<0){
    80003dbc:	02074b63          	bltz	a4,80003df2 <itoa+0x60>
        *p++ = '-';
        i *= -1;
    }
    int shifter = i;
    80003dc0:	86ba                	mv	a3,a4
    do{ //Move to where representation ends
        ++p;
        shifter = shifter/10;
    80003dc2:	4629                	li	a2,10
        ++p;
    80003dc4:	0785                	addi	a5,a5,1
        shifter = shifter/10;
    80003dc6:	02c6c6bb          	divw	a3,a3,a2
    }while(shifter);
    80003dca:	feed                	bnez	a3,80003dc4 <itoa+0x32>
    *p = '\0';
    80003dcc:	00078023          	sb	zero,0(a5)
    do{ //Move back, inserting digits as u go
        *--p = digit[i%10];
    80003dd0:	4629                	li	a2,10
    80003dd2:	17fd                	addi	a5,a5,-1
    80003dd4:	02c766bb          	remw	a3,a4,a2
    80003dd8:	ff040593          	addi	a1,s0,-16
    80003ddc:	96ae                	add	a3,a3,a1
    80003dde:	ff06c683          	lbu	a3,-16(a3)
    80003de2:	00d78023          	sb	a3,0(a5)
        i = i/10;
    80003de6:	02c7473b          	divw	a4,a4,a2
    }while(i);
    80003dea:	f765                	bnez	a4,80003dd2 <itoa+0x40>
    return b;
}
    80003dec:	6462                	ld	s0,24(sp)
    80003dee:	6105                	addi	sp,sp,32
    80003df0:	8082                	ret
        *p++ = '-';
    80003df2:	00158793          	addi	a5,a1,1
    80003df6:	02d00693          	li	a3,45
    80003dfa:	00d58023          	sb	a3,0(a1)
        i *= -1;
    80003dfe:	40e0073b          	negw	a4,a4
    80003e02:	bf7d                	j	80003dc0 <itoa+0x2e>

0000000080003e04 <removeSwapFile>:
...
removeSwapFile(struct proc* p)
{
  ...
  char path[DIGITS];
  memmove(path,"/.swap", 6);
    80003e12:	4619                	li	a2,6
    80003e14:	00005597          	auipc	a1,0x5
    80003e18:	80458593          	addi	a1,a1,-2044 # 80008618 <syscalls+0x1e8>
    80003e1c:	fd040513          	addi	a0,s0,-48
    80003e20:	ffffd097          	auipc	ra,0xffffd
    80003e24:	efa080e7          	jalr	-262(ra) # 80000d1a <memmove>
  itoa(p->pid, path+ 6);
    80003e28:	fd640593          	addi	a1,s0,-42
    80003e2c:	5888                	lw	a0,48(s1)
    80003e2e:	00000097          	auipc	ra,0x0
    80003e32:	f64080e7          	jalr	-156(ra) # 80003d92 <itoa>
  struct inode *ip, *dp;
  struct dirent de;
  char name[DIRSIZ];
  uint off;
  ...
  if(0 == p->swapFile)
    80003e36:	1684b503          	ld	a0,360(s1)
    80003e3a:	16050763          	beqz	a0,80003fa8 <removeSwapFile+0x1a4>
  {
    return -1;
  }
  fileclose(p->swapFile);
    80003e3e:	00001097          	auipc	ra,0x1
    80003e42:	918080e7          	jalr	-1768(ra) # 80004756 <fileclose>

  begin_op();
    80003e46:	00000097          	auipc	ra,0x0
    80003e4a:	444080e7          	jalr	1092(ra) # 8000428a <begin_op>
  if((dp = nameiparent(path, name)) == 0)
    80003e4e:	fb040593          	addi	a1,s0,-80
    80003e52:	fd040513          	addi	a0,s0,-48
    80003e56:	00000097          	auipc	ra,0x0
    80003e5a:	f20080e7          	jalr	-224(ra) # 80003d76 <nameiparent>
    80003e5e:	892a                	mv	s2,a0
    80003e60:	cd69                	beqz	a0,80003f3a <removeSwapFile+0x136>
  {
    end_op();
    return -1;
  }
  ...
  ilock(dp);
    ...
    80003e66:	740080e7          	jalr	1856(ra) # 800035a2 <ilock>

    // Cannot unlink "." or "..".
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
    80003e6a:	00004597          	auipc	a1,0x4
    80003e6e:	7b658593          	addi	a1,a1,1974 # 80008620 <syscalls+0x1f0>
    80003e72:	fb040513          	addi	a0,s0,-80
    80003e76:	00000097          	auipc	ra,0x0
    80003e7a:	bf6080e7          	jalr	-1034(ra) # 80003a6c <namecmp>
    80003e7e:	c57d                	beqz	a0,80003f6c <removeSwapFile+0x168>
    80003e80:	00004597          	auipc	a1,0x4
    80003e84:	7a858593          	addi	a1,a1,1960 # 80008628 <syscalls+0x1f8>
    80003e88:	fb040513          	addi	a0,s0,-80
    80003e8c:	00000097          	auipc	ra,0x0
    80003e90:	be0080e7          	jalr	-1056(ra) # 80003a6c <namecmp>
    80003e94:	cd61                	beqz	a0,80003f6c <removeSwapFile+0x168>
     goto bad;

  if((ip = dirlookup(dp, name, &off)) == 0)
    80003e96:	fac40613          	addi	a2,s0,-84
    80003e9a:	fb040593          	addi	a1,s0,-80
    80003e9e:	854a                	mv	a0,s2
    80003ea0:	00000097          	auipc	ra,0x0
    80003ea4:	be6080e7          	jalr	-1050(ra) # 80003a86 <dirlookup>
    80003ea8:	84aa                	mv	s1,a0
    80003eaa:	c169                	beqz	a0,80003f6c <removeSwapFile+0x168>
    goto bad;
  ilock(ip);
    80003eac:	fffff097          	auipc	ra,0xfffff
    80003eb0:	6f6080e7          	jalr	1782(ra) # 800035a2 <ilock>

  if(ip->nlink < 1)
    80003eb4:	04a49783          	lh	a5,74(s1)
    80003eb8:	08f05763          	blez	a5,80003f46 <removeSwapFile+0x142>
    panic("unlink: nlink < 1");
  if(ip->type == T_DIR && !isdirempty(ip)){
    80003ebc:	04449703          	lh	a4,68(s1)
    80003ec0:	4785                	li	a5,1
    80003ec2:	08f70a63          	beq	a4,a5,80003f56 <removeSwapFile+0x152>
    iunlockput(ip);
    goto bad;
  }

  memset(&de, 0, sizeof(de));
    80003ec6:	4641                	li	a2,16
    80003ec8:	4581                	li	a1,0
    80003eca:	fc040513          	addi	a0,s0,-64
    80003ece:	ffffd097          	auipc	ra,0xffffd
    80003ed2:	df0080e7          	jalr	-528(ra) # 80000cbe <memset>
  if(writei(dp,0, (uint64)&de, off, sizeof(de)) != sizeof(de))
    80003ed6:	4741                	li	a4,16
    80003ed8:	fac42683          	lw	a3,-84(s0)
    80003edc:	fc040613          	addi	a2,s0,-64
    80003ee0:	4581                	li	a1,0
    80003ee2:	854a                	mv	a0,s2
    80003ee4:	00000097          	auipc	ra,0x0
    80003ee8:	a6a080e7          	jalr	-1430(ra) # 8000394e <writei>
    80003eec:	47c1                	li	a5,16
    80003eee:	08f51a63          	bne	a0,a5,80003f82 <removeSwapFile+0x17e>
    panic("unlink: writei");
  if(ip->type == T_DIR){
    80003ef2:	04449703          	lh	a4,68(s1)
    80003ef6:	4785                	li	a5,1
    80003ef8:	08f70d63          	beq	a4,a5,80003f92 <removeSwapFile+0x18e>
    dp->nlink--;
    iupdate(dp);
  }
  iunlockput(dp);
    ...
    80003f02:	906080e7          	jalr	-1786(ra) # 80003804 <iunlockput>

  ip->nlink--;
    80003f06:	04a4d783          	lhu	a5,74(s1)
    80003f0a:	37fd                	addiw	a5,a5,-1
    80003f0c:	04f49523          	sh	a5,74(s1)
  iupdate(ip);
    80003f10:	8526                	mv	a0,s1
    80003f12:	fffff097          	auipc	ra,0xfffff
    80003f16:	5c6080e7          	jalr	1478(ra) # 800034d8 <iupdate>
  iunlockput(ip);
    80003f1a:	8526                	mv	a0,s1
    80003f1c:	00000097          	auipc	ra,0x0
    80003f20:	8e8080e7          	jalr	-1816(ra) # 80003804 <iunlockput>

  end_op();
    80003f24:	00000097          	auipc	ra,0x0
    80003f28:	3e6080e7          	jalr	998(ra) # 8000430a <end_op>
  ...
  bad:
    ...
    80003f36:	6125                	addi	sp,sp,96
    80003f38:	8082                	ret
    end_op();
    80003f3a:	00000097          	auipc	ra,0x0
    80003f3e:	3d0080e7          	jalr	976(ra) # 8000430a <end_op>
    return -1;
    80003f42:	557d                	li	a0,-1
    80003f44:	b7ed                	j	80003f2e <removeSwapFile+0x12a>
    panic("unlink: nlink < 1");
    80003f46:	00004517          	auipc	a0,0x4
    80003f4a:	6ea50513          	addi	a0,a0,1770 # 80008630 <syscalls+0x200>
  ...
  if(ip->type == T_DIR && !isdirempty(ip)){
    ...
    80003f5c:	798080e7          	jalr	1944(ra) # 800056f0 <isdirempty>
    80003f60:	f13d                	bnez	a0,80003ec6 <removeSwapFile+0xc2>
    iunlockput(ip);
    80003f62:	8526                	mv	a0,s1
    80003f64:	00000097          	auipc	ra,0x0
    80003f68:	8a0080e7          	jalr	-1888(ra) # 80003804 <iunlockput>
    iunlockput(dp);
    80003f6c:	854a                	mv	a0,s2
    80003f6e:	00000097          	auipc	ra,0x0
    80003f72:	896080e7          	jalr	-1898(ra) # 80003804 <iunlockput>
    end_op();
    80003f76:	00000097          	auipc	ra,0x0
    80003f7a:	394080e7          	jalr	916(ra) # 8000430a <end_op>
    return -1;
    80003f7e:	557d                	li	a0,-1
    80003f80:	b77d                	j	80003f2e <removeSwapFile+0x12a>
    panic("unlink: writei");
    80003f82:	00004517          	auipc	a0,0x4
    80003f86:	6c650513          	addi	a0,a0,1734 # 80008648 <syscalls+0x218>
    80003f8a:	ffffc097          	auipc	ra,0xffffc
    80003f8e:	5a0080e7          	jalr	1440(ra) # 8000052a <panic>
    dp->nlink--;
    80003f92:	04a95783          	lhu	a5,74(s2)
    80003f96:	37fd                	addiw	a5,a5,-1
    80003f98:	04f91523          	sh	a5,74(s2)
    iupdate(dp);
    80003f9c:	854a                	mv	a0,s2
    80003f9e:	fffff097          	auipc	ra,0xfffff
    80003fa2:	53a080e7          	jalr	1338(ra) # 800034d8 <iupdate>
    80003fa6:	bf99                	j	80003efc <removeSwapFile+0xf8>
    return -1;
    80003fa8:	557d                	li	a0,-1
    80003faa:	b751                	j	80003f2e <removeSwapFile+0x12a>

0000000080003fac <createSwapFile>:
...
createSwapFile(struct proc* p)
{
  ...
  char path[DIGITS];
  memmove(path,"/.swap", 6);
    80003fba:	4619                	li	a2,6
    80003fbc:	00004597          	auipc	a1,0x4
    80003fc0:	65c58593          	addi	a1,a1,1628 # 80008618 <syscalls+0x1e8>
    80003fc4:	fd040513          	addi	a0,s0,-48
    80003fc8:	ffffd097          	auipc	ra,0xffffd
    80003fcc:	d52080e7          	jalr	-686(ra) # 80000d1a <memmove>
  itoa(p->pid, path+ 6);
    80003fd0:	fd640593          	addi	a1,s0,-42
    80003fd4:	5888                	lw	a0,48(s1)
    80003fd6:	00000097          	auipc	ra,0x0
    80003fda:	dbc080e7          	jalr	-580(ra) # 80003d92 <itoa>

  begin_op();
    80003fde:	00000097          	auipc	ra,0x0
    80003fe2:	2ac080e7          	jalr	684(ra) # 8000428a <begin_op>
  
  struct inode * in = create(path, T_FILE, 0, 0);
    80003fe6:	4681                	li	a3,0
    80003fe8:	4601                	li	a2,0
    80003fea:	4589                	li	a1,2
    80003fec:	fd040513          	addi	a0,s0,-48
    80003ff0:	00002097          	auipc	ra,0x2
    80003ff4:	8f4080e7          	jalr	-1804(ra) # 800058e4 <create>
    80003ff8:	892a                	mv	s2,a0
  iunlock(in);
    80003ffa:	fffff097          	auipc	ra,0xfffff
    80003ffe:	66a080e7          	jalr	1642(ra) # 80003664 <iunlock>
  p->swapFile = filealloc();
    80004002:	00000097          	auipc	ra,0x0
    80004006:	698080e7          	jalr	1688(ra) # 8000469a <filealloc>
    8000400a:	16a4b423          	sd	a0,360(s1)
  if (p->swapFile == 0)
    8000400e:	cd1d                	beqz	a0,8000404c <createSwapFile+0xa0>
    panic("no slot for files on /store");

  p->swapFile->ip = in;
    80004010:	01253c23          	sd	s2,24(a0)
  p->swapFile->type = FD_INODE;
    80004014:	1684b703          	ld	a4,360(s1)
    80004018:	4789                	li	a5,2
    8000401a:	c31c                	sw	a5,0(a4)
  p->swapFile->off = 0;
    8000401c:	1684b703          	ld	a4,360(s1)
    80004020:	02072023          	sw	zero,32(a4) # 43020 <_entry-0x7ffbcfe0>
  p->swapFile->readable = O_WRONLY;
    80004024:	1684b703          	ld	a4,360(s1)
    80004028:	4685                	li	a3,1
    8000402a:	00d70423          	sb	a3,8(a4)
  p->swapFile->writable = O_RDWR;
    8000402e:	1684b703          	ld	a4,360(s1)
    80004032:	00f704a3          	sb	a5,9(a4)
    end_op();
    80004036:	00000097          	auipc	ra,0x0
    8000403a:	2d4080e7          	jalr	724(ra) # 8000430a <end_op>
    ...
    80004050:	60c50513          	addi	a0,a0,1548 # 80008658 <syscalls+0x228>
    80004054:	ffffc097          	auipc	ra,0xffffc
    80004058:	4d6080e7          	jalr	1238(ra) # 8000052a <panic>

000000008000405c <writeToSwapFile>:
...
writeToSwapFile(struct proc * p, char* buffer, uint placeOnFile, uint size)
{
  ...
  p->swapFile->off = placeOnFile;
    80004064:	16853783          	ld	a5,360(a0)
    80004068:	d390                	sw	a2,32(a5)
  return kfilewrite(p->swapFile, (uint64)buffer, size);
    8000406a:	8636                	mv	a2,a3
    8000406c:	16853503          	ld	a0,360(a0)
    80004070:	00001097          	auipc	ra,0x1
    80004074:	ad8080e7          	jalr	-1320(ra) # 80004b48 <kfilewrite>
}
...
0000000080004080 <readFromSwapFile>:
...
readFromSwapFile(struct proc * p, char* buffer, uint placeOnFile, uint size)
{
  ...
  p->swapFile->off = placeOnFile;
    80004088:	16853783          	ld	a5,360(a0)
    8000408c:	d390                	sw	a2,32(a5)
  return kfileread(p->swapFile, (uint64)buffer,  size);
    8000408e:	8636                	mv	a2,a3
    80004090:	16853503          	ld	a0,360(a0)
    80004094:	00001097          	auipc	ra,0x1
    80004098:	9f2080e7          	jalr	-1550(ra) # 80004a86 <kfileread>
...
write_head(void)
{
  ...
  struct buf *buf = bread(log.dev, log.start);
    800040b0:	0001d917          	auipc	s2,0x1d
    800040b4:	3c090913          	addi	s2,s2,960 # 80021470 <log>
    800040b8:	01892583          	lw	a1,24(s2)
    800040bc:	02892503          	lw	a0,40(s2)
    800040c0:	fffff097          	auipc	ra,0xfffff
    800040c4:	cde080e7          	jalr	-802(ra) # 80002d9e <bread>
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    800040d8:	3cc78793          	addi	a5,a5,972 # 800214a0 <log+0x30>
    ...
    800040ea:	0001d617          	auipc	a2,0x1d
    800040ee:	3ba60613          	addi	a2,a2,954 # 800214a4 <log+0x34>
  ...
  bwrite(buf);
    ...
    80004106:	d8e080e7          	jalr	-626(ra) # 80002e90 <bwrite>
  brelse(buf);
    8000410a:	8526                	mv	a0,s1
    8000410c:	fffff097          	auipc	ra,0xfffff
    80004110:	dc2080e7          	jalr	-574(ra) # 80002ece <brelse>
}
...
0000000080004120 <install_trans>:
  for (tail = 0; tail < log.lh.n; tail++) {
    ...
    80004124:	37c7a783          	lw	a5,892(a5) # 8002149c <log+0x2c>
    80004128:	0af05d63          	blez	a5,800041e2 <install_trans+0xc2>
{
    ...
    80004146:	35ea8a93          	addi	s5,s5,862 # 800214a0 <log+0x30>
  for (tail = 0; tail < log.lh.n; tail++) {
    8000414a:	4a01                	li	s4,0
    struct buf *lbuf = bread(log.dev, log.start+tail+1); // read log block
    8000414c:	0001d997          	auipc	s3,0x1d
    80004150:	32498993          	addi	s3,s3,804 # 80021470 <log>
    80004154:	a00d                	j	80004176 <install_trans+0x56>
    brelse(lbuf);
    80004156:	854a                	mv	a0,s2
    80004158:	fffff097          	auipc	ra,0xfffff
    8000415c:	d76080e7          	jalr	-650(ra) # 80002ece <brelse>
    brelse(dbuf);
    80004160:	8526                	mv	a0,s1
    80004162:	fffff097          	auipc	ra,0xfffff
    80004166:	d6c080e7          	jalr	-660(ra) # 80002ece <brelse>
  for (tail = 0; tail < log.lh.n; tail++) {
    ...
    80004188:	c1a080e7          	jalr	-998(ra) # 80002d9e <bread>
    ...
    8000419a:	c08080e7          	jalr	-1016(ra) # 80002d9e <bread>
...
00000000800041e4 <initlog>:
{
  ...
  initlock(&log.lock, "log");
    ...
    800041fa:	27a48493          	addi	s1,s1,634 # 80021470 <log>
    800041fe:	00004597          	auipc	a1,0x4
    80004202:	47a58593          	addi	a1,a1,1146 # 80008678 <syscalls+0x248>
    80004206:	8526                	mv	a0,s1
    80004208:	ffffd097          	auipc	ra,0xffffd
    8000420c:	92a080e7          	jalr	-1750(ra) # 80000b32 <initlock>
  ...
  struct buf *buf = bread(log.dev, log.start);
    ...
    80004226:	b7c080e7          	jalr	-1156(ra) # 80002d9e <bread>
  log.lh.n = lh->n;
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    8000423a:	26a70713          	addi	a4,a4,618 # 800214a0 <log+0x30>
  ...
  brelse(buf);
    ...
    8000425e:	c74080e7          	jalr	-908(ra) # 80002ece <brelse>
...
recover_from_log(void)
{
  ...
  log.lh.n = 0;
    ...
    80004270:	2207a823          	sw	zero,560(a5) # 8002149c <log+0x2c>
...
begin_op(void)
{
  ...
  acquire(&log.lock);
    ...
    8000429a:	1da50513          	addi	a0,a0,474 # 80021470 <log>
    8000429e:	ffffd097          	auipc	ra,0xffffd
    800042a2:	924080e7          	jalr	-1756(ra) # 80000bc2 <acquire>
  while(1){
    if(log.committing){
    800042a6:	0001d497          	auipc	s1,0x1d
    800042aa:	1ca48493          	addi	s1,s1,458 # 80021470 <log>
      sleep(&log, &log.lock);
    ...
    800042ba:	d88080e7          	jalr	-632(ra) # 8000203e <sleep>
    if(log.committing){
    ...
    800042e6:	d5c080e7          	jalr	-676(ra) # 8000203e <sleep>
    800042ea:	bfd1                	j	800042be <begin_op+0x34>
    } else {
      log.outstanding += 1;
    800042ec:	0001d517          	auipc	a0,0x1d
    800042f0:	18450513          	addi	a0,a0,388 # 80021470 <log>
...
end_op(void)
{
  ...
  acquire(&log.lock);
    ...
    80004320:	15448493          	addi	s1,s1,340 # 80021470 <log>
    80004324:	8526                	mv	a0,s1
    80004326:	ffffd097          	auipc	ra,0xffffd
    8000432a:	89c080e7          	jalr	-1892(ra) # 80000bc2 <acquire>
  log.outstanding -= 1;
  ...
  if(log.committing)
    ...
    8000433a:	e7b9                	bnez	a5,80004388 <end_op+0x7e>
    panic("log.committing");
  if(log.outstanding == 0){
    8000433c:	04091e63          	bnez	s2,80004398 <end_op+0x8e>
    do_commit = 1;
    log.committing = 1;
    80004340:	0001d497          	auipc	s1,0x1d
    80004344:	13048493          	addi	s1,s1,304 # 80021470 <log>
  ...
  release(&log.lock);
    ...
    80004352:	928080e7          	jalr	-1752(ra) # 80000c76 <release>
}
...
commit()
{
  ...
  release(&log.lock);
    ...
    800043c0:	6aa2                	ld	s5,8(sp)
    800043c2:	6121                	addi	sp,sp,64
    800043c4:	8082                	ret
  for (tail = 0; tail < log.lh.n; tail++) {
    800043c6:	0001da97          	auipc	s5,0x1d
    800043ca:	0daa8a93          	addi	s5,s5,218 # 800214a0 <log+0x30>
    struct buf *to = bread(log.dev, log.start+tail+1); // log block
    800043ce:	0001da17          	auipc	s4,0x1d
    800043d2:	0a2a0a13          	addi	s4,s4,162 # 80021470 <log>
    ...
    800043e8:	9ba080e7          	jalr	-1606(ra) # 80002d9e <bread>
    ...
    800043fa:	9a8080e7          	jalr	-1624(ra) # 80002d9e <bread>
    ...
    80004410:	90e080e7          	jalr	-1778(ra) # 80000d1a <memmove>
    bwrite(to);  // write the log
    80004414:	8526                	mv	a0,s1
    80004416:	fffff097          	auipc	ra,0xfffff
    8000441a:	a7a080e7          	jalr	-1414(ra) # 80002e90 <bwrite>
    brelse(from);
    8000441e:	854e                	mv	a0,s3
    80004420:	fffff097          	auipc	ra,0xfffff
    80004424:	aae080e7          	jalr	-1362(ra) # 80002ece <brelse>
    brelse(to);
    80004428:	8526                	mv	a0,s1
    8000442a:	fffff097          	auipc	ra,0xfffff
    8000442e:	aa4080e7          	jalr	-1372(ra) # 80002ece <brelse>
  for (tail = 0; tail < log.lh.n; tail++) {
    ...
    80004442:	c66080e7          	jalr	-922(ra) # 800040a4 <write_head>
    install_trans(0); // Now install writes to home locations
    80004446:	4501                	li	a0,0
    80004448:	00000097          	auipc	ra,0x0
    8000444c:	cd8080e7          	jalr	-808(ra) # 80004120 <install_trans>
    log.lh.n = 0;
    80004450:	0001d797          	auipc	a5,0x1d
    80004454:	0407a623          	sw	zero,76(a5) # 8002149c <log+0x2c>
    write_head();    // Erase the transaction from the log
    80004458:	00000097          	auipc	ra,0x0
    8000445c:	c4c080e7          	jalr	-948(ra) # 800040a4 <write_head>
...
log_write(struct buf *b)
{
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    800044b2:	ff270713          	addi	a4,a4,-14 # 800214a0 <log+0x30>
  for (i = 0; i < log.lh.n; i++) {
  ...
  if (i == log.lh.n) {  // Add new block to log?
    ...
    800044de:	a92080e7          	jalr	-1390(ra) # 80002f6c <bpin>
    log.lh.n++;
    ...
    800044f6:	19e50513          	addi	a0,a0,414 # 80008690 <syscalls+0x260>
    800044fa:	ffffc097          	auipc	ra,0xffffc
    800044fe:	030080e7          	jalr	48(ra) # 8000052a <panic>
    panic("log_write outside of trans");
    80004502:	00004517          	auipc	a0,0x4
    80004506:	1a650513          	addi	a0,a0,422 # 800086a8 <syscalls+0x278>
    8000450a:	ffffc097          	auipc	ra,0xffffc
    8000450e:	020080e7          	jalr	32(ra) # 8000052a <panic>
  log.lh.block[i] = b->blockno;
...
initsleeplock(struct sleeplock *lk, char *name)
{
  ...
  initlock(&lk->lk, "sleep lock");
    ...
    8000455c:	17058593          	addi	a1,a1,368 # 800086c8 <syscalls+0x298>
...
acquiresleep(struct sleeplock *lk)
{
  ...
  acquire(&lk->lk);
    ...
    8000459a:	62c080e7          	jalr	1580(ra) # 80000bc2 <acquire>
  while (lk->locked) {
    ...
    800045aa:	a98080e7          	jalr	-1384(ra) # 8000203e <sleep>
  while (lk->locked) {
  ...
  lk->pid = myproc()->pid;
    ...
    800045ba:	3c8080e7          	jalr	968(ra) # 8000197e <myproc>
...
releasesleep(struct sleeplock *lk)
{
  ...
  wakeup(lk);
    ...
    80004602:	bcc080e7          	jalr	-1076(ra) # 800021ca <wakeup>
  release(&lk->lk);
...
holdingsleep(struct sleeplock *lk)
{
  ...
  acquire(&lk->lk);
    ...
    80004636:	590080e7          	jalr	1424(ra) # 80000bc2 <acquire>
  ...
  r = lk->locked && (lk->pid == myproc()->pid);
    ...
    80004662:	320080e7          	jalr	800(ra) # 8000197e <myproc>
...
filealloc(void)
{
  ...
  acquire(&ftable.lock);
    ...
    800046a8:	f1450513          	addi	a0,a0,-236 # 800215b8 <ftable>
    800046ac:	ffffc097          	auipc	ra,0xffffc
    800046b0:	516080e7          	jalr	1302(ra) # 80000bc2 <acquire>
  for(f = ftable.file; f < ftable.file + NFILE; f++){
    800046b4:	0001d497          	auipc	s1,0x1d
    800046b8:	f1c48493          	addi	s1,s1,-228 # 800215d0 <ftable+0x18>
    800046bc:	0001e717          	auipc	a4,0x1e
    800046c0:	eb470713          	addi	a4,a4,-332 # 80022570 <ftable+0xfb8>
    if(f->ref == 0){
  ...
  release(&ftable.lock);
    ...
    800046d4:	ee850513          	addi	a0,a0,-280 # 800215b8 <ftable>
    800046d8:	ffffc097          	auipc	ra,0xffffc
    800046dc:	59e080e7          	jalr	1438(ra) # 80000c76 <release>
  return 0;
    ...
    800046ec:	ed050513          	addi	a0,a0,-304 # 800215b8 <ftable>
    800046f0:	ffffc097          	auipc	ra,0xffffc
    800046f4:	586080e7          	jalr	1414(ra) # 80000c76 <release>
}
...
filedup(struct file *f)
{
  ...
  release(&ftable.lock);
    ...
    8000472e:	e8e50513          	addi	a0,a0,-370 # 800215b8 <ftable>
    80004732:	ffffc097          	auipc	ra,0xffffc
    80004736:	544080e7          	jalr	1348(ra) # 80000c76 <release>
  return f;
}
    ...
    8000474a:	f9a50513          	addi	a0,a0,-102 # 800086e0 <syscalls+0x2b0>
...
fileclose(struct file *f)
{
  ...
  acquire(&ftable.lock);
    ...
    8000476e:	e4e50513          	addi	a0,a0,-434 # 800215b8 <ftable>
    80004772:	ffffc097          	auipc	ra,0xffffc
    80004776:	450080e7          	jalr	1104(ra) # 80000bc2 <acquire>
  if(f->ref < 1)
  ...
  release(&ftable.lock);
    ...
    800047a8:	e1450513          	addi	a0,a0,-492 # 800215b8 <ftable>
  ...
  if(ff.type == FD_PIPE){
    ...
    800047d0:	f90080e7          	jalr	-112(ra) # 8000375c <iput>
    end_op();
    ...
    800047e2:	f0a50513          	addi	a0,a0,-246 # 800086e8 <syscalls+0x2b8>
    ...
    800047fa:	480080e7          	jalr	1152(ra) # 80000c76 <release>
  }
}
    ...
    80004818:	542080e7          	jalr	1346(ra) # 80004d56 <pipeclose>
...
filestat(struct file *f, uint64 addr)
{
  ...
  struct proc *p = myproc();
    ...
    80004834:	14e080e7          	jalr	334(ra) # 8000197e <myproc>
  struct stat st;
  ...
  if(f->type == FD_INODE || f->type == FD_DEVICE){
    ...
    80004876:	dcc080e7          	jalr	-564(ra) # 8000163e <copyout>
...
fileread(struct file *f, uint64 addr, int n)
{
  ...
  if(f->type == FD_PIPE){
    ...
    800048c4:	ce2080e7          	jalr	-798(ra) # 800035a2 <ilock>
    ...
    800048d6:	f84080e7          	jalr	-124(ra) # 80003856 <readi>
    ...
    800048ec:	d7c080e7          	jalr	-644(ra) # 80003664 <iunlock>
  } else {
    panic("fileread");
  }
  ...
  return r;
    ...
    80004906:	5b6080e7          	jalr	1462(ra) # 80004eb8 <piperead>
    ...
    80004924:	bf870713          	addi	a4,a4,-1032 # 80021518 <devsw>
    ...
    8000493a:	dc250513          	addi	a0,a0,-574 # 800086f8 <syscalls+0x2c8>
...
filewrite(struct file *f, uint64 addr, int n)
{
  ...
  if(f->type == FD_PIPE){
    ...
    800049a6:	424080e7          	jalr	1060(ra) # 80004dc6 <pipewrite>
    ...
    800049c4:	b5870713          	addi	a4,a4,-1192 # 80021518 <devsw>
    ...
    800049ea:	bbc080e7          	jalr	-1092(ra) # 800035a2 <ilock>
    ...
    80004a02:	f50080e7          	jalr	-176(ra) # 8000394e <writei>
    ...
    80004a1e:	c4a080e7          	jalr	-950(ra) # 80003664 <iunlock>
      end_op();
  ...
  return ret;
    ...
    80004a6e:	c9e50513          	addi	a0,a0,-866 # 80008708 <syscalls+0x2d8>
...
kfileread(struct file *f, uint64 addr, int n)
{
  ...
  if(f->readable == 0)
    ...
    80004a98:	c3d5                	beqz	a5,80004b3c <kfileread+0xb6>
    80004a9a:	84aa                	mv	s1,a0
    80004a9c:	89ae                	mv	s3,a1
    80004a9e:	8932                	mv	s2,a2
    return -1;

  if(f->type == FD_PIPE){
    80004aa0:	411c                	lw	a5,0(a0)
    80004aa2:	4705                	li	a4,1
    80004aa4:	04e78963          	beq	a5,a4,80004af6 <kfileread+0x70>
    r = piperead(f->pipe, addr, n);
  } else if(f->type == FD_DEVICE){
    80004aa8:	470d                	li	a4,3
    80004aaa:	04e78d63          	beq	a5,a4,80004b04 <kfileread+0x7e>
    if(f->major < 0 || f->major >= NDEV || !devsw[f->major].read)
      return -1;
    r = devsw[f->major].read(1, addr, n);
  } else if(f->type == FD_INODE){
    80004aae:	4709                	li	a4,2
    80004ab0:	06e79e63          	bne	a5,a4,80004b2c <kfileread+0xa6>
    ilock(f->ip);
    80004ab4:	6d08                	ld	a0,24(a0)
    80004ab6:	fffff097          	auipc	ra,0xfffff
    80004aba:	aec080e7          	jalr	-1300(ra) # 800035a2 <ilock>
    if((r = readi(f->ip, 0, addr, f->off, n)) > 0)
    80004abe:	874a                	mv	a4,s2
    80004ac0:	5094                	lw	a3,32(s1)
    80004ac2:	864e                	mv	a2,s3
    80004ac4:	4581                	li	a1,0
    80004ac6:	6c88                	ld	a0,24(s1)
    80004ac8:	fffff097          	auipc	ra,0xfffff
    80004acc:	d8e080e7          	jalr	-626(ra) # 80003856 <readi>
    80004ad0:	892a                	mv	s2,a0
    80004ad2:	00a05563          	blez	a0,80004adc <kfileread+0x56>
      f->off += r;
    80004ad6:	509c                	lw	a5,32(s1)
    80004ad8:	9fa9                	addw	a5,a5,a0
    80004ada:	d09c                	sw	a5,32(s1)
    iunlock(f->ip);
    80004adc:	6c88                	ld	a0,24(s1)
    80004ade:	fffff097          	auipc	ra,0xfffff
    80004ae2:	b86080e7          	jalr	-1146(ra) # 80003664 <iunlock>
  } else {
    panic("fileread");
  }
  ...
  return r;
    ...
    80004af2:	6145                	addi	sp,sp,48
    80004af4:	8082                	ret
    r = piperead(f->pipe, addr, n);
    80004af6:	6908                	ld	a0,16(a0)
    80004af8:	00000097          	auipc	ra,0x0
    80004afc:	3c0080e7          	jalr	960(ra) # 80004eb8 <piperead>
    80004b00:	892a                	mv	s2,a0
    80004b02:	b7d5                	j	80004ae6 <kfileread+0x60>
    if(f->major < 0 || f->major >= NDEV || !devsw[f->major].read)
    80004b04:	02451783          	lh	a5,36(a0)
    80004b08:	03079693          	slli	a3,a5,0x30
    80004b0c:	92c1                	srli	a3,a3,0x30
    80004b0e:	4725                	li	a4,9
    80004b10:	02d76863          	bltu	a4,a3,80004b40 <kfileread+0xba>
    80004b14:	0792                	slli	a5,a5,0x4
    80004b16:	0001d717          	auipc	a4,0x1d
    80004b1a:	a0270713          	addi	a4,a4,-1534 # 80021518 <devsw>
    80004b1e:	97ba                	add	a5,a5,a4
    80004b20:	639c                	ld	a5,0(a5)
    80004b22:	c38d                	beqz	a5,80004b44 <kfileread+0xbe>
    r = devsw[f->major].read(1, addr, n);
    80004b24:	4505                	li	a0,1
    80004b26:	9782                	jalr	a5
    80004b28:	892a                	mv	s2,a0
    80004b2a:	bf75                	j	80004ae6 <kfileread+0x60>
    panic("fileread");
    80004b2c:	00004517          	auipc	a0,0x4
    80004b30:	bcc50513          	addi	a0,a0,-1076 # 800086f8 <syscalls+0x2c8>
    80004b34:	ffffc097          	auipc	ra,0xffffc
    80004b38:	9f6080e7          	jalr	-1546(ra) # 8000052a <panic>
    return -1;
    80004b3c:	597d                	li	s2,-1
    80004b3e:	b765                	j	80004ae6 <kfileread+0x60>
      return -1;
    80004b40:	597d                	li	s2,-1
    80004b42:	b755                	j	80004ae6 <kfileread+0x60>
    80004b44:	597d                	li	s2,-1
    80004b46:	b745                	j	80004ae6 <kfileread+0x60>

0000000080004b48 <kfilewrite>:
...
kfilewrite(struct file *f, uint64 addr, int n)
{
    ...
    80004b5a:	e45e                	sd	s7,8(sp)
    80004b5c:	e062                	sd	s8,0(sp)
    80004b5e:	0880                	addi	s0,sp,80
  int r, ret = 0;

  if(f->writable == 0)
    80004b60:	00954783          	lbu	a5,9(a0)
    80004b64:	10078663          	beqz	a5,80004c70 <kfilewrite+0x128>
  ...
  if(f->type == FD_PIPE){
    ...
    80004b72:	02e78263          	beq	a5,a4,80004b96 <kfilewrite+0x4e>
    ret = pipewrite(f->pipe, addr, n);
  } else if(f->type == FD_DEVICE){
    80004b76:	470d                	li	a4,3
    80004b78:	02e78663          	beq	a5,a4,80004ba4 <kfilewrite+0x5c>
    if(f->major < 0 || f->major >= NDEV || !devsw[f->major].write)
      return -1;
    ret = devsw[f->major].write(1, addr, n);
  } else if(f->type == FD_INODE){
    80004b7c:	4709                	li	a4,2
    80004b7e:	0ee79163          	bne	a5,a4,80004c60 <kfilewrite+0x118>
    // and 2 blocks of slop for non-aligned writes.
    // this really belongs lower down, since writei()
    // might be writing a device like the console.
    int max = ((MAXOPBLOCKS-1-1-2) / 2) * BSIZE;
    int i = 0;
    while(i < n){
    80004b82:	0ac05d63          	blez	a2,80004c3c <kfilewrite+0xf4>
    int i = 0;
    80004b86:	4981                	li	s3,0
    80004b88:	6b05                	lui	s6,0x1
    80004b8a:	c00b0b13          	addi	s6,s6,-1024 # c00 <_entry-0x7ffff400>
    80004b8e:	6b85                	lui	s7,0x1
    80004b90:	c00b8b9b          	addiw	s7,s7,-1024
    80004b94:	a861                	j	80004c2c <kfilewrite+0xe4>
    ret = pipewrite(f->pipe, addr, n);
    80004b96:	6908                	ld	a0,16(a0)
    80004b98:	00000097          	auipc	ra,0x0
    80004b9c:	22e080e7          	jalr	558(ra) # 80004dc6 <pipewrite>
    80004ba0:	8a2a                	mv	s4,a0
    80004ba2:	a045                	j	80004c42 <kfilewrite+0xfa>
    if(f->major < 0 || f->major >= NDEV || !devsw[f->major].write)
    80004ba4:	02451783          	lh	a5,36(a0)
    80004ba8:	03079693          	slli	a3,a5,0x30
    80004bac:	92c1                	srli	a3,a3,0x30
    80004bae:	4725                	li	a4,9
    80004bb0:	0cd76263          	bltu	a4,a3,80004c74 <kfilewrite+0x12c>
    80004bb4:	0792                	slli	a5,a5,0x4
    80004bb6:	0001d717          	auipc	a4,0x1d
    80004bba:	96270713          	addi	a4,a4,-1694 # 80021518 <devsw>
    80004bbe:	97ba                	add	a5,a5,a4
    80004bc0:	679c                	ld	a5,8(a5)
    80004bc2:	cbdd                	beqz	a5,80004c78 <kfilewrite+0x130>
    ret = devsw[f->major].write(1, addr, n);
    80004bc4:	4505                	li	a0,1
    80004bc6:	9782                	jalr	a5
    80004bc8:	8a2a                	mv	s4,a0
    80004bca:	a8a5                	j	80004c42 <kfilewrite+0xfa>
    80004bcc:	00048c1b          	sext.w	s8,s1
      int n1 = n - i;
      if(n1 > max)
        n1 = max;
    ...
    80004bd4:	6ba080e7          	jalr	1722(ra) # 8000428a <begin_op>
      ilock(f->ip);
    80004bd8:	01893503          	ld	a0,24(s2)
    80004bdc:	fffff097          	auipc	ra,0xfffff
    80004be0:	9c6080e7          	jalr	-1594(ra) # 800035a2 <ilock>
      if ((r = writei(f->ip, 0, addr + i, f->off, n1)) > 0)
    80004be4:	8762                	mv	a4,s8
    80004be6:	02092683          	lw	a3,32(s2)
    80004bea:	01598633          	add	a2,s3,s5
    80004bee:	4581                	li	a1,0
    80004bf0:	01893503          	ld	a0,24(s2)
    80004bf4:	fffff097          	auipc	ra,0xfffff
    80004bf8:	d5a080e7          	jalr	-678(ra) # 8000394e <writei>
    80004bfc:	84aa                	mv	s1,a0
    80004bfe:	00a05763          	blez	a0,80004c0c <kfilewrite+0xc4>
        f->off += r;
    80004c02:	02092783          	lw	a5,32(s2)
    80004c06:	9fa9                	addw	a5,a5,a0
    80004c08:	02f92023          	sw	a5,32(s2)
      iunlock(f->ip);
    80004c0c:	01893503          	ld	a0,24(s2)
    80004c10:	fffff097          	auipc	ra,0xfffff
    80004c14:	a54080e7          	jalr	-1452(ra) # 80003664 <iunlock>
      end_op();
    80004c18:	fffff097          	auipc	ra,0xfffff
    80004c1c:	6f2080e7          	jalr	1778(ra) # 8000430a <end_op>

      if(r != n1){
    80004c20:	009c1f63          	bne	s8,s1,80004c3e <kfilewrite+0xf6>
        // error from writei
        break;
      }
      i += r;
    80004c24:	013489bb          	addw	s3,s1,s3
    while(i < n){
    80004c28:	0149db63          	bge	s3,s4,80004c3e <kfilewrite+0xf6>
      int n1 = n - i;
    80004c2c:	413a07bb          	subw	a5,s4,s3
      if(n1 > max)
    80004c30:	84be                	mv	s1,a5
    80004c32:	2781                	sext.w	a5,a5
    80004c34:	f8fb5ce3          	bge	s6,a5,80004bcc <kfilewrite+0x84>
    80004c38:	84de                	mv	s1,s7
    80004c3a:	bf49                	j	80004bcc <kfilewrite+0x84>
    int i = 0;
    80004c3c:	4981                	li	s3,0
    }
    ret = (i == n ? n : -1);
    80004c3e:	013a1f63          	bne	s4,s3,80004c5c <kfilewrite+0x114>
  } else {
    panic("filewrite");
  }
  ...
  return ret;
    ...
    80004c54:	6ba2                	ld	s7,8(sp)
    80004c56:	6c02                	ld	s8,0(sp)
    80004c58:	6161                	addi	sp,sp,80
    80004c5a:	8082                	ret
    ret = (i == n ? n : -1);
    80004c5c:	5a7d                	li	s4,-1
    80004c5e:	b7d5                	j	80004c42 <kfilewrite+0xfa>
    panic("filewrite");
    80004c60:	00004517          	auipc	a0,0x4
    80004c64:	aa850513          	addi	a0,a0,-1368 # 80008708 <syscalls+0x2d8>
    80004c68:	ffffc097          	auipc	ra,0xffffc
    80004c6c:	8c2080e7          	jalr	-1854(ra) # 8000052a <panic>
    return -1;
    80004c70:	5a7d                	li	s4,-1
    80004c72:	bfc1                	j	80004c42 <kfilewrite+0xfa>
      return -1;
    80004c74:	5a7d                	li	s4,-1
    80004c76:	b7f1                	j	80004c42 <kfilewrite+0xfa>
    80004c78:	5a7d                	li	s4,-1
    80004c7a:	b7e1                	j	80004c42 <kfilewrite+0xfa>

0000000080004c7c <pipealloc>:
...
pipealloc(struct file **f0, struct file **f1)
{
    ...
    80004c88:	e052                	sd	s4,0(sp)
    80004c8a:	1800                	addi	s0,sp,48
    80004c8c:	84aa                	mv	s1,a0
    80004c8e:	8a2e                	mv	s4,a1
  struct pipe *pi;

  pi = 0;
  *f0 = *f1 = 0;
    80004c90:	0005b023          	sd	zero,0(a1)
    80004c94:	00053023          	sd	zero,0(a0)
  if((*f0 = filealloc()) == 0 || (*f1 = filealloc()) == 0)
    80004c98:	00000097          	auipc	ra,0x0
    80004c9c:	a02080e7          	jalr	-1534(ra) # 8000469a <filealloc>
    80004ca0:	e088                	sd	a0,0(s1)
    80004ca2:	c551                	beqz	a0,80004d2e <pipealloc+0xb2>
    80004ca4:	00000097          	auipc	ra,0x0
    80004ca8:	9f6080e7          	jalr	-1546(ra) # 8000469a <filealloc>
    80004cac:	00aa3023          	sd	a0,0(s4)
    80004cb0:	c92d                	beqz	a0,80004d22 <pipealloc+0xa6>
    goto bad;
  if((pi = (struct pipe*)kalloc()) == 0)
    80004cb2:	ffffc097          	auipc	ra,0xffffc
    80004cb6:	e20080e7          	jalr	-480(ra) # 80000ad2 <kalloc>
    80004cba:	892a                	mv	s2,a0
    80004cbc:	c125                	beqz	a0,80004d1c <pipealloc+0xa0>
    goto bad;
  pi->readopen = 1;
    80004cbe:	4985                	li	s3,1
    80004cc0:	23352023          	sw	s3,544(a0)
  pi->writeopen = 1;
    80004cc4:	23352223          	sw	s3,548(a0)
  pi->nwrite = 0;
    80004cc8:	20052e23          	sw	zero,540(a0)
  pi->nread = 0;
    80004ccc:	20052c23          	sw	zero,536(a0)
  initlock(&pi->lock, "pipe");
    80004cd0:	00004597          	auipc	a1,0x4
    80004cd4:	a4858593          	addi	a1,a1,-1464 # 80008718 <syscalls+0x2e8>
    80004cd8:	ffffc097          	auipc	ra,0xffffc
    80004cdc:	e5a080e7          	jalr	-422(ra) # 80000b32 <initlock>
  (*f0)->type = FD_PIPE;
    80004ce0:	609c                	ld	a5,0(s1)
    80004ce2:	0137a023          	sw	s3,0(a5)
  (*f0)->readable = 1;
    80004ce6:	609c                	ld	a5,0(s1)
    80004ce8:	01378423          	sb	s3,8(a5)
  (*f0)->writable = 0;
    80004cec:	609c                	ld	a5,0(s1)
    80004cee:	000784a3          	sb	zero,9(a5)
  (*f0)->pipe = pi;
    80004cf2:	609c                	ld	a5,0(s1)
    80004cf4:	0127b823          	sd	s2,16(a5)
  (*f1)->type = FD_PIPE;
    80004cf8:	000a3783          	ld	a5,0(s4)
    80004cfc:	0137a023          	sw	s3,0(a5)
  (*f1)->readable = 0;
    80004d00:	000a3783          	ld	a5,0(s4)
    80004d04:	00078423          	sb	zero,8(a5)
  (*f1)->writable = 1;
    80004d08:	000a3783          	ld	a5,0(s4)
    80004d0c:	013784a3          	sb	s3,9(a5)
  (*f1)->pipe = pi;
    80004d10:	000a3783          	ld	a5,0(s4)
    80004d14:	0127b823          	sd	s2,16(a5)
  return 0;
    80004d18:	4501                	li	a0,0
    80004d1a:	a025                	j	80004d42 <pipealloc+0xc6>

 bad:
  if(pi)
    kfree((char*)pi);
  if(*f0)
    80004d1c:	6088                	ld	a0,0(s1)
    80004d1e:	e501                	bnez	a0,80004d26 <pipealloc+0xaa>
    80004d20:	a039                	j	80004d2e <pipealloc+0xb2>
    80004d22:	6088                	ld	a0,0(s1)
    80004d24:	c51d                	beqz	a0,80004d52 <pipealloc+0xd6>
    fileclose(*f0);
    80004d26:	00000097          	auipc	ra,0x0
    80004d2a:	a30080e7          	jalr	-1488(ra) # 80004756 <fileclose>
  if(*f1)
  ...
  if(*f1)
    80004d34:	c799                	beqz	a5,80004d42 <pipealloc+0xc6>
    fileclose(*f1);
    80004d36:	853e                	mv	a0,a5
    80004d38:	00000097          	auipc	ra,0x0
    80004d3c:	a1e080e7          	jalr	-1506(ra) # 80004756 <fileclose>
  return -1;
    ...
    80004d4c:	6a02                	ld	s4,0(sp)
    80004d4e:	6145                	addi	sp,sp,48
    80004d50:	8082                	ret
  return -1;
    80004d52:	557d                	li	a0,-1
    80004d54:	b7fd                	j	80004d42 <pipealloc+0xc6>

0000000080004d56 <pipeclose>:
...
pipeclose(struct pipe *pi, int writable)
{
  ...
  acquire(&pi->lock);
    ...
    80004d6a:	e5c080e7          	jalr	-420(ra) # 80000bc2 <acquire>
  if(writable){
    80004d6e:	02090d63          	beqz	s2,80004da8 <pipeclose+0x52>
    pi->writeopen = 0;
    80004d72:	2204a223          	sw	zero,548(s1)
    wakeup(&pi->nread);
    80004d76:	21848513          	addi	a0,s1,536
    80004d7a:	ffffd097          	auipc	ra,0xffffd
    80004d7e:	450080e7          	jalr	1104(ra) # 800021ca <wakeup>
  } else {
    pi->readopen = 0;
    wakeup(&pi->nwrite);
  }
  if(pi->readopen == 0 && pi->writeopen == 0){
    80004d82:	2204b783          	ld	a5,544(s1)
    80004d86:	eb95                	bnez	a5,80004dba <pipeclose+0x64>
    release(&pi->lock);
    80004d88:	8526                	mv	a0,s1
    80004d8a:	ffffc097          	auipc	ra,0xffffc
    80004d8e:	eec080e7          	jalr	-276(ra) # 80000c76 <release>
    kfree((char*)pi);
    80004d92:	8526                	mv	a0,s1
    80004d94:	ffffc097          	auipc	ra,0xffffc
    80004d98:	c42080e7          	jalr	-958(ra) # 800009d6 <kfree>
  } else
    release(&pi->lock);
}
    ...
    80004da6:	8082                	ret
    pi->readopen = 0;
    80004da8:	2204a023          	sw	zero,544(s1)
    wakeup(&pi->nwrite);
    80004dac:	21c48513          	addi	a0,s1,540
    80004db0:	ffffd097          	auipc	ra,0xffffd
    80004db4:	41a080e7          	jalr	1050(ra) # 800021ca <wakeup>
    80004db8:	b7e9                	j	80004d82 <pipeclose+0x2c>
    release(&pi->lock);
    80004dba:	8526                	mv	a0,s1
    80004dbc:	ffffc097          	auipc	ra,0xffffc
    80004dc0:	eba080e7          	jalr	-326(ra) # 80000c76 <release>
}
    80004dc4:	bfe1                	j	80004d9c <pipeclose+0x46>

0000000080004dc6 <pipewrite>:
...
pipewrite(struct pipe *pi, uint64 addr, int n)
{
    ...
    80004dcc:	e4a6                	sd	s1,72(sp)
    80004dce:	e0ca                	sd	s2,64(sp)
    80004dd0:	fc4e                	sd	s3,56(sp)
    80004dd2:	f852                	sd	s4,48(sp)
    80004dd4:	f456                	sd	s5,40(sp)
    80004dd6:	f05a                	sd	s6,32(sp)
    80004dd8:	ec5e                	sd	s7,24(sp)
    80004dda:	e862                	sd	s8,16(sp)
    80004ddc:	1080                	addi	s0,sp,96
  ...
  struct proc *pr = myproc();
    ...
    80004de8:	b9a080e7          	jalr	-1126(ra) # 8000197e <myproc>
    80004dec:	89aa                	mv	s3,a0

  acquire(&pi->lock);
    80004dee:	8526                	mv	a0,s1
    80004df0:	ffffc097          	auipc	ra,0xffffc
    80004df4:	dd2080e7          	jalr	-558(ra) # 80000bc2 <acquire>
  while(i < n){
    80004df8:	0b405363          	blez	s4,80004e9e <pipewrite+0xd8>
  int i = 0;
    ...
    80004dfe:	5b7d                	li	s6,-1
      wakeup(&pi->nread);
    80004e00:	21848c13          	addi	s8,s1,536
      sleep(&pi->nwrite, &pi->lock);
    80004e04:	21c48b93          	addi	s7,s1,540
    80004e08:	a089                	j	80004e4a <pipewrite+0x84>
      release(&pi->lock);
    80004e0a:	8526                	mv	a0,s1
    80004e0c:	ffffc097          	auipc	ra,0xffffc
    80004e10:	e6a080e7          	jalr	-406(ra) # 80000c76 <release>
      return -1;
  ...
  return i;
    ...
    80004e18:	60e6                	ld	ra,88(sp)
    80004e1a:	6446                	ld	s0,80(sp)
    80004e1c:	64a6                	ld	s1,72(sp)
    80004e1e:	6906                	ld	s2,64(sp)
    80004e20:	79e2                	ld	s3,56(sp)
    80004e22:	7a42                	ld	s4,48(sp)
    80004e24:	7aa2                	ld	s5,40(sp)
    80004e26:	7b02                	ld	s6,32(sp)
    80004e28:	6be2                	ld	s7,24(sp)
    80004e2a:	6c42                	ld	s8,16(sp)
    80004e2c:	6125                	addi	sp,sp,96
    80004e2e:	8082                	ret
      wakeup(&pi->nread);
    80004e30:	8562                	mv	a0,s8
    80004e32:	ffffd097          	auipc	ra,0xffffd
    80004e36:	398080e7          	jalr	920(ra) # 800021ca <wakeup>
      sleep(&pi->nwrite, &pi->lock);
    80004e3a:	85a6                	mv	a1,s1
    80004e3c:	855e                	mv	a0,s7
    80004e3e:	ffffd097          	auipc	ra,0xffffd
    80004e42:	200080e7          	jalr	512(ra) # 8000203e <sleep>
  while(i < n){
    80004e46:	05495d63          	bge	s2,s4,80004ea0 <pipewrite+0xda>
    if(pi->readopen == 0 || pr->killed){
    80004e4a:	2204a783          	lw	a5,544(s1)
    80004e4e:	dfd5                	beqz	a5,80004e0a <pipewrite+0x44>
    80004e50:	0289a783          	lw	a5,40(s3)
    80004e54:	fbdd                	bnez	a5,80004e0a <pipewrite+0x44>
    if(pi->nwrite == pi->nread + PIPESIZE){ //DOC: pipewrite-full
    80004e56:	2184a783          	lw	a5,536(s1)
    80004e5a:	21c4a703          	lw	a4,540(s1)
    80004e5e:	2007879b          	addiw	a5,a5,512
    80004e62:	fcf707e3          	beq	a4,a5,80004e30 <pipewrite+0x6a>
      if(copyin(pr->pagetable, &ch, addr + i, 1) == -1)
    80004e66:	4685                	li	a3,1
    80004e68:	01590633          	add	a2,s2,s5
    80004e6c:	faf40593          	addi	a1,s0,-81
    80004e70:	0509b503          	ld	a0,80(s3)
    80004e74:	ffffd097          	auipc	ra,0xffffd
    80004e78:	856080e7          	jalr	-1962(ra) # 800016ca <copyin>
    80004e7c:	03650263          	beq	a0,s6,80004ea0 <pipewrite+0xda>
      pi->data[pi->nwrite++ % PIPESIZE] = ch;
    80004e80:	21c4a783          	lw	a5,540(s1)
    80004e84:	0017871b          	addiw	a4,a5,1
    80004e88:	20e4ae23          	sw	a4,540(s1)
    80004e8c:	1ff7f793          	andi	a5,a5,511
    80004e90:	97a6                	add	a5,a5,s1
    80004e92:	faf44703          	lbu	a4,-81(s0)
    80004e96:	00e78c23          	sb	a4,24(a5)
      i++;
    80004e9a:	2905                	addiw	s2,s2,1
    80004e9c:	b76d                	j	80004e46 <pipewrite+0x80>
  int i = 0;
    80004e9e:	4901                	li	s2,0
  wakeup(&pi->nread);
    80004ea0:	21848513          	addi	a0,s1,536
    80004ea4:	ffffd097          	auipc	ra,0xffffd
    80004ea8:	326080e7          	jalr	806(ra) # 800021ca <wakeup>
  release(&pi->lock);
    80004eac:	8526                	mv	a0,s1
    80004eae:	ffffc097          	auipc	ra,0xffffc
    80004eb2:	dc8080e7          	jalr	-568(ra) # 80000c76 <release>
  return i;
    80004eb6:	b785                	j	80004e16 <pipewrite+0x50>

0000000080004eb8 <piperead>:
...
piperead(struct pipe *pi, uint64 addr, int n)
{
    ...
    80004ec8:	e85a                	sd	s6,16(sp)
    80004eca:	0880                	addi	s0,sp,80
    80004ecc:	84aa                	mv	s1,a0
    80004ece:	892e                	mv	s2,a1
    80004ed0:	8ab2                	mv	s5,a2
  int i;
  struct proc *pr = myproc();
    80004ed2:	ffffd097          	auipc	ra,0xffffd
    80004ed6:	aac080e7          	jalr	-1364(ra) # 8000197e <myproc>
  ...
  while(pi->nread == pi->nwrite && pi->writeopen){  //DOC: pipe-empty
    80004ee6:	2184a703          	lw	a4,536(s1)
    80004eea:	21c4a783          	lw	a5,540(s1)
    if(pr->killed){
      release(&pi->lock);
      return -1;
    }
    sleep(&pi->nread, &pi->lock); //DOC: piperead-sleep
    80004eee:	21848993          	addi	s3,s1,536
  while(pi->nread == pi->nwrite && pi->writeopen){  //DOC: pipe-empty
    80004ef2:	02f71463          	bne	a4,a5,80004f1a <piperead+0x62>
    80004ef6:	2244a783          	lw	a5,548(s1)
    80004efa:	c385                	beqz	a5,80004f1a <piperead+0x62>
    if(pr->killed){
    80004efc:	028a2783          	lw	a5,40(s4)
    80004f00:	ebc1                	bnez	a5,80004f90 <piperead+0xd8>
    sleep(&pi->nread, &pi->lock); //DOC: piperead-sleep
    80004f02:	85a6                	mv	a1,s1
    80004f04:	854e                	mv	a0,s3
    80004f06:	ffffd097          	auipc	ra,0xffffd
    80004f0a:	138080e7          	jalr	312(ra) # 8000203e <sleep>
  while(pi->nread == pi->nwrite && pi->writeopen){  //DOC: pipe-empty
    80004f0e:	2184a703          	lw	a4,536(s1)
    80004f12:	21c4a783          	lw	a5,540(s1)
    80004f16:	fef700e3          	beq	a4,a5,80004ef6 <piperead+0x3e>
  }
  ...
  for(i = 0; i < n; i++){  //DOC: piperead-copy
    80004f1e:	05505363          	blez	s5,80004f64 <piperead+0xac>
    if(pi->nread == pi->nwrite)
    80004f22:	2184a783          	lw	a5,536(s1)
    80004f26:	21c4a703          	lw	a4,540(s1)
    80004f2a:	02f70d63          	beq	a4,a5,80004f64 <piperead+0xac>
    ch = pi->data[pi->nread++ % PIPESIZE];
    ...
    80004f54:	6ee080e7          	jalr	1774(ra) # 8000163e <copyout>
    80004f58:	01650663          	beq	a0,s6,80004f64 <piperead+0xac>
  for(i = 0; i < n; i++){  //DOC: piperead-copy
    80004f5c:	2985                	addiw	s3,s3,1
    80004f5e:	0905                	addi	s2,s2,1
    80004f60:	fd3a91e3          	bne	s5,s3,80004f22 <piperead+0x6a>
      break;
  }
  wakeup(&pi->nwrite);  //DOC: piperead-wakeup
    80004f64:	21c48513          	addi	a0,s1,540
    80004f68:	ffffd097          	auipc	ra,0xffffd
    80004f6c:	262080e7          	jalr	610(ra) # 800021ca <wakeup>
  release(&pi->lock);
  ...
  return i;
    ...
    80004f96:	ce4080e7          	jalr	-796(ra) # 80000c76 <release>
      return -1;
    80004f9a:	59fd                	li	s3,-1
    80004f9c:	bff9                	j	80004f7a <piperead+0xc2>

0000000080004f9e <exec>:
...
{
    80004f9e:	de010113          	addi	sp,sp,-544
    80004fa2:	20113c23          	sd	ra,536(sp)
    80004fa6:	20813823          	sd	s0,528(sp)
    80004faa:	20913423          	sd	s1,520(sp)
    80004fae:	21213023          	sd	s2,512(sp)
    80004fb2:	ffce                	sd	s3,504(sp)
    80004fb4:	fbd2                	sd	s4,496(sp)
    80004fb6:	f7d6                	sd	s5,488(sp)
    80004fb8:	f3da                	sd	s6,480(sp)
    80004fba:	efde                	sd	s7,472(sp)
    80004fbc:	ebe2                	sd	s8,464(sp)
    80004fbe:	e7e6                	sd	s9,456(sp)
    80004fc0:	e3ea                	sd	s10,448(sp)
    80004fc2:	ff6e                	sd	s11,440(sp)
    80004fc4:	1400                	addi	s0,sp,544
    80004fc6:	892a                	mv	s2,a0
    80004fc8:	dea43423          	sd	a0,-536(s0)
    80004fcc:	deb43823          	sd	a1,-528(s0)
  ...
  struct proc *p = myproc();
    ...
    80004fd4:	9ae080e7          	jalr	-1618(ra) # 8000197e <myproc>
    80004fd8:	84aa                	mv	s1,a0

  begin_op();
    80004fda:	fffff097          	auipc	ra,0xfffff
    80004fde:	2b0080e7          	jalr	688(ra) # 8000428a <begin_op>

  if((ip = namei(path)) == 0){
    80004fe2:	854a                	mv	a0,s2
    80004fe4:	fffff097          	auipc	ra,0xfffff
    80004fe8:	d74080e7          	jalr	-652(ra) # 80003d58 <namei>
    80004fec:	c93d                	beqz	a0,80005062 <exec+0xc4>
  ...
  ilock(ip);
    ...
    80004ff4:	5b2080e7          	jalr	1458(ra) # 800035a2 <ilock>

  // Check ELF header
  if(readi(ip, 0, (uint64)&elf, 0, sizeof(elf)) != sizeof(elf))
    80004ff8:	04000713          	li	a4,64
    80004ffc:	4681                	li	a3,0
    80004ffe:	e4840613          	addi	a2,s0,-440
    80005002:	4581                	li	a1,0
    80005004:	8556                	mv	a0,s5
    80005006:	fffff097          	auipc	ra,0xfffff
    8000500a:	850080e7          	jalr	-1968(ra) # 80003856 <readi>
    8000500e:	04000793          	li	a5,64
    80005012:	00f51a63          	bne	a0,a5,80005026 <exec+0x88>
    goto bad;
  if(elf.magic != ELF_MAGIC)
    80005016:	e4842703          	lw	a4,-440(s0)
    8000501a:	464c47b7          	lui	a5,0x464c4
    8000501e:	57f78793          	addi	a5,a5,1407 # 464c457f <_entry-0x39b3ba81>
    80005022:	04f70663          	beq	a4,a5,8000506e <exec+0xd0>
 ...
 bad:
  ...
  if(ip){
    ...
    8000502c:	7dc080e7          	jalr	2012(ra) # 80003804 <iunlockput>
    end_op();
    80005030:	fffff097          	auipc	ra,0xfffff
    80005034:	2da080e7          	jalr	730(ra) # 8000430a <end_op>
  }
  return -1;
    80005038:	557d                	li	a0,-1
}
    8000503a:	21813083          	ld	ra,536(sp)
    8000503e:	21013403          	ld	s0,528(sp)
    80005042:	20813483          	ld	s1,520(sp)
    80005046:	20013903          	ld	s2,512(sp)
    8000504a:	79fe                	ld	s3,504(sp)
    8000504c:	7a5e                	ld	s4,496(sp)
    8000504e:	7abe                	ld	s5,488(sp)
    80005050:	7b1e                	ld	s6,480(sp)
    80005052:	6bfe                	ld	s7,472(sp)
    80005054:	6c5e                	ld	s8,464(sp)
    80005056:	6cbe                	ld	s9,456(sp)
    80005058:	6d1e                	ld	s10,448(sp)
    8000505a:	7dfa                	ld	s11,440(sp)
    8000505c:	22010113          	addi	sp,sp,544
    80005060:	8082                	ret
    end_op();
    80005062:	fffff097          	auipc	ra,0xfffff
    80005066:	2a8080e7          	jalr	680(ra) # 8000430a <end_op>
    return -1;
    8000506a:	557d                	li	a0,-1
    8000506c:	b7f9                	j	8000503a <exec+0x9c>
  if((pagetable = proc_pagetable(p)) == 0)
    8000506e:	8526                	mv	a0,s1
    80005070:	ffffd097          	auipc	ra,0xffffd
    80005074:	9d2080e7          	jalr	-1582(ra) # 80001a42 <proc_pagetable>
    80005078:	8b2a                	mv	s6,a0
    8000507a:	d555                	beqz	a0,80005026 <exec+0x88>
  for(i=0, off=elf.phoff; i<elf.phnum; i++, off+=sizeof(ph)){
    8000507c:	e6842783          	lw	a5,-408(s0)
    80005080:	e8045703          	lhu	a4,-384(s0)
    80005084:	c735                	beqz	a4,800050f0 <exec+0x152>
  uint64 argc, sz = 0, sp, ustack[MAXARG+1], stackbase;
    80005086:	4481                	li	s1,0
  for(i=0, off=elf.phoff; i<elf.phnum; i++, off+=sizeof(ph)){
    80005088:	e0043423          	sd	zero,-504(s0)
    if(ph.vaddr % PGSIZE != 0)
    8000508c:	6a05                	lui	s4,0x1
    8000508e:	fffa0713          	addi	a4,s4,-1 # fff <_entry-0x7ffff001>
    80005092:	dee43023          	sd	a4,-544(s0)
  uint64 pa;
  ...
  for(i = 0; i < sz; i += PGSIZE){
    80005096:	6d85                	lui	s11,0x1
    80005098:	7d7d                	lui	s10,0xfffff
    8000509a:	ac1d                	j	800052d0 <exec+0x332>
    pa = walkaddr(pagetable, va + i);
    if(pa == 0)
      panic("loadseg: address should exist");
    8000509c:	00003517          	auipc	a0,0x3
    800050a0:	68450513          	addi	a0,a0,1668 # 80008720 <syscalls+0x2f0>
    800050a4:	ffffb097          	auipc	ra,0xffffb
    800050a8:	486080e7          	jalr	1158(ra) # 8000052a <panic>
    if(sz - i < PGSIZE)
      n = sz - i;
    else
      n = PGSIZE;
    if(readi(ip, 0, (uint64)pa, offset+i, n) != n)
    800050ac:	874a                	mv	a4,s2
    800050ae:	009c86bb          	addw	a3,s9,s1
    800050b2:	4581                	li	a1,0
    800050b4:	8556                	mv	a0,s5
    800050b6:	ffffe097          	auipc	ra,0xffffe
    800050ba:	7a0080e7          	jalr	1952(ra) # 80003856 <readi>
    800050be:	2501                	sext.w	a0,a0
    800050c0:	1aa91863          	bne	s2,a0,80005270 <exec+0x2d2>
  for(i = 0; i < sz; i += PGSIZE){
    800050c4:	009d84bb          	addw	s1,s11,s1
    800050c8:	013d09bb          	addw	s3,s10,s3
    800050cc:	1f74f263          	bgeu	s1,s7,800052b0 <exec+0x312>
    pa = walkaddr(pagetable, va + i);
    800050d0:	02049593          	slli	a1,s1,0x20
    800050d4:	9181                	srli	a1,a1,0x20
    800050d6:	95e2                	add	a1,a1,s8
    800050d8:	855a                	mv	a0,s6
    800050da:	ffffc097          	auipc	ra,0xffffc
    800050de:	f72080e7          	jalr	-142(ra) # 8000104c <walkaddr>
    800050e2:	862a                	mv	a2,a0
    if(pa == 0)
    800050e4:	dd45                	beqz	a0,8000509c <exec+0xfe>
      n = PGSIZE;
    800050e6:	8952                	mv	s2,s4
    if(sz - i < PGSIZE)
    800050e8:	fd49f2e3          	bgeu	s3,s4,800050ac <exec+0x10e>
      n = sz - i;
    800050ec:	894e                	mv	s2,s3
    800050ee:	bf7d                	j	800050ac <exec+0x10e>
  uint64 argc, sz = 0, sp, ustack[MAXARG+1], stackbase;
    800050f0:	4481                	li	s1,0
  iunlockput(ip);
    800050f2:	8556                	mv	a0,s5
    800050f4:	ffffe097          	auipc	ra,0xffffe
    800050f8:	710080e7          	jalr	1808(ra) # 80003804 <iunlockput>
  end_op();
    800050fc:	fffff097          	auipc	ra,0xfffff
    80005100:	20e080e7          	jalr	526(ra) # 8000430a <end_op>
  p = myproc();
    80005104:	ffffd097          	auipc	ra,0xffffd
    80005108:	87a080e7          	jalr	-1926(ra) # 8000197e <myproc>
    8000510c:	8baa                	mv	s7,a0
  uint64 oldsz = p->sz;
    8000510e:	04853d03          	ld	s10,72(a0)
  sz = PGROUNDUP(sz);
    80005112:	6785                	lui	a5,0x1
    80005114:	17fd                	addi	a5,a5,-1
    80005116:	94be                	add	s1,s1,a5
    80005118:	77fd                	lui	a5,0xfffff
    8000511a:	8fe5                	and	a5,a5,s1
    8000511c:	def43c23          	sd	a5,-520(s0)
  if((sz1 = uvmalloc(pagetable, sz, sz + 2*PGSIZE)) == 0)
    80005120:	6609                	lui	a2,0x2
    80005122:	963e                	add	a2,a2,a5
    80005124:	85be                	mv	a1,a5
    80005126:	855a                	mv	a0,s6
    80005128:	ffffc097          	auipc	ra,0xffffc
    8000512c:	2c6080e7          	jalr	710(ra) # 800013ee <uvmalloc>
    80005130:	8c2a                	mv	s8,a0
  ip = 0;
    80005132:	4a81                	li	s5,0
  if((sz1 = uvmalloc(pagetable, sz, sz + 2*PGSIZE)) == 0)
    80005134:	12050e63          	beqz	a0,80005270 <exec+0x2d2>
  uvmclear(pagetable, sz-2*PGSIZE);
    80005138:	75f9                	lui	a1,0xffffe
    8000513a:	95aa                	add	a1,a1,a0
    8000513c:	855a                	mv	a0,s6
    8000513e:	ffffc097          	auipc	ra,0xffffc
    80005142:	4ce080e7          	jalr	1230(ra) # 8000160c <uvmclear>
  stackbase = sp - PGSIZE;
    80005146:	7afd                	lui	s5,0xfffff
    80005148:	9ae2                	add	s5,s5,s8
  for(argc = 0; argv[argc]; argc++) {
    8000514a:	df043783          	ld	a5,-528(s0)
    8000514e:	6388                	ld	a0,0(a5)
    80005150:	c925                	beqz	a0,800051c0 <exec+0x222>
    80005152:	e8840993          	addi	s3,s0,-376
    80005156:	f8840c93          	addi	s9,s0,-120
  sp = sz;
    8000515a:	8962                	mv	s2,s8
  for(argc = 0; argv[argc]; argc++) {
    8000515c:	4481                	li	s1,0
    sp -= strlen(argv[argc]) + 1;
    8000515e:	ffffc097          	auipc	ra,0xffffc
    80005162:	ce4080e7          	jalr	-796(ra) # 80000e42 <strlen>
    80005166:	0015079b          	addiw	a5,a0,1
    8000516a:	40f90933          	sub	s2,s2,a5
    sp -= sp % 16; // riscv sp must be 16-byte aligned
    8000516e:	ff097913          	andi	s2,s2,-16
    if(sp < stackbase)
    80005172:	13596363          	bltu	s2,s5,80005298 <exec+0x2fa>
    if(copyout(pagetable, sp, argv[argc], strlen(argv[argc]) + 1) < 0)
    80005176:	df043d83          	ld	s11,-528(s0)
    8000517a:	000dba03          	ld	s4,0(s11) # 1000 <_entry-0x7ffff000>
    8000517e:	8552                	mv	a0,s4
    80005180:	ffffc097          	auipc	ra,0xffffc
    80005184:	cc2080e7          	jalr	-830(ra) # 80000e42 <strlen>
    80005188:	0015069b          	addiw	a3,a0,1
    8000518c:	8652                	mv	a2,s4
    8000518e:	85ca                	mv	a1,s2
    80005190:	855a                	mv	a0,s6
    80005192:	ffffc097          	auipc	ra,0xffffc
    80005196:	4ac080e7          	jalr	1196(ra) # 8000163e <copyout>
    8000519a:	10054363          	bltz	a0,800052a0 <exec+0x302>
    ustack[argc] = sp;
    8000519e:	0129b023          	sd	s2,0(s3)
  for(argc = 0; argv[argc]; argc++) {
    800051a2:	0485                	addi	s1,s1,1
    800051a4:	008d8793          	addi	a5,s11,8
    800051a8:	def43823          	sd	a5,-528(s0)
    800051ac:	008db503          	ld	a0,8(s11)
    800051b0:	c911                	beqz	a0,800051c4 <exec+0x226>
    if(argc >= MAXARG)
    800051b2:	09a1                	addi	s3,s3,8
    800051b4:	fb3c95e3          	bne	s9,s3,8000515e <exec+0x1c0>
  sz = sz1;
    800051b8:	df843c23          	sd	s8,-520(s0)
  ip = 0;
    800051bc:	4a81                	li	s5,0
    800051be:	a84d                	j	80005270 <exec+0x2d2>
  sp = sz;
    800051c0:	8962                	mv	s2,s8
  for(argc = 0; argv[argc]; argc++) {
    800051c2:	4481                	li	s1,0
  ustack[argc] = 0;
    800051c4:	00349793          	slli	a5,s1,0x3
    800051c8:	f9040713          	addi	a4,s0,-112
    800051cc:	97ba                	add	a5,a5,a4
    800051ce:	ee07bc23          	sd	zero,-264(a5) # ffffffffffffeef8 <end+0xffffffff7ffd8ef8>
  sp -= (argc+1) * sizeof(uint64);
    800051d2:	00148693          	addi	a3,s1,1
    800051d6:	068e                	slli	a3,a3,0x3
    800051d8:	40d90933          	sub	s2,s2,a3
  sp -= sp % 16;
    800051dc:	ff097913          	andi	s2,s2,-16
  if(sp < stackbase)
    800051e0:	01597663          	bgeu	s2,s5,800051ec <exec+0x24e>
  sz = sz1;
    800051e4:	df843c23          	sd	s8,-520(s0)
  ip = 0;
    800051e8:	4a81                	li	s5,0
    800051ea:	a059                	j	80005270 <exec+0x2d2>
  if(copyout(pagetable, sp, (char *)ustack, (argc+1)*sizeof(uint64)) < 0)
    800051ec:	e8840613          	addi	a2,s0,-376
    800051f0:	85ca                	mv	a1,s2
    800051f2:	855a                	mv	a0,s6
    800051f4:	ffffc097          	auipc	ra,0xffffc
    800051f8:	44a080e7          	jalr	1098(ra) # 8000163e <copyout>
    800051fc:	0a054663          	bltz	a0,800052a8 <exec+0x30a>
  p->trapframe->a1 = sp;
    80005200:	058bb783          	ld	a5,88(s7) # 1058 <_entry-0x7fffefa8>
    80005204:	0727bc23          	sd	s2,120(a5)
  for(last=s=path; *s; s++)
    80005208:	de843783          	ld	a5,-536(s0)
    8000520c:	0007c703          	lbu	a4,0(a5)
    80005210:	cf11                	beqz	a4,8000522c <exec+0x28e>
    80005212:	0785                	addi	a5,a5,1
    if(*s == '/')
    80005214:	02f00693          	li	a3,47
    80005218:	a039                	j	80005226 <exec+0x288>
      last = s+1;
    8000521a:	def43423          	sd	a5,-536(s0)
  for(last=s=path; *s; s++)
    8000521e:	0785                	addi	a5,a5,1
    80005220:	fff7c703          	lbu	a4,-1(a5)
    80005224:	c701                	beqz	a4,8000522c <exec+0x28e>
    if(*s == '/')
    80005226:	fed71ce3          	bne	a4,a3,8000521e <exec+0x280>
    8000522a:	bfc5                	j	8000521a <exec+0x27c>
  safestrcpy(p->name, last, sizeof(p->name));
    8000522c:	4641                	li	a2,16
    8000522e:	de843583          	ld	a1,-536(s0)
    80005232:	158b8513          	addi	a0,s7,344
    80005236:	ffffc097          	auipc	ra,0xffffc
    8000523a:	bda080e7          	jalr	-1062(ra) # 80000e10 <safestrcpy>
  oldpagetable = p->pagetable;
    8000523e:	050bb503          	ld	a0,80(s7)
  p->pagetable = pagetable;
    80005242:	056bb823          	sd	s6,80(s7)
  p->sz = sz;
    80005246:	058bb423          	sd	s8,72(s7)
  p->trapframe->epc = elf.entry;  // initial program counter = main
    8000524a:	058bb783          	ld	a5,88(s7)
    8000524e:	e6043703          	ld	a4,-416(s0)
    80005252:	ef98                	sd	a4,24(a5)
  p->trapframe->sp = sp; // initial stack pointer
    80005254:	058bb783          	ld	a5,88(s7)
    80005258:	0327b823          	sd	s2,48(a5)
  proc_freepagetable(oldpagetable, oldsz);
    8000525c:	85ea                	mv	a1,s10
    8000525e:	ffffd097          	auipc	ra,0xffffd
    80005262:	880080e7          	jalr	-1920(ra) # 80001ade <proc_freepagetable>
  return argc; // this ends up in a0, the first argument to main(argc, argv)
    80005266:	0004851b          	sext.w	a0,s1
    8000526a:	bbc1                	j	8000503a <exec+0x9c>
    8000526c:	de943c23          	sd	s1,-520(s0)
    proc_freepagetable(pagetable, sz);
    80005270:	df843583          	ld	a1,-520(s0)
    80005274:	855a                	mv	a0,s6
    80005276:	ffffd097          	auipc	ra,0xffffd
    8000527a:	868080e7          	jalr	-1944(ra) # 80001ade <proc_freepagetable>
  if(ip){
    8000527e:	da0a94e3          	bnez	s5,80005026 <exec+0x88>
  return -1;
    80005282:	557d                	li	a0,-1
    80005284:	bb5d                	j	8000503a <exec+0x9c>
    80005286:	de943c23          	sd	s1,-520(s0)
    8000528a:	b7dd                	j	80005270 <exec+0x2d2>
    8000528c:	de943c23          	sd	s1,-520(s0)
    80005290:	b7c5                	j	80005270 <exec+0x2d2>
    80005292:	de943c23          	sd	s1,-520(s0)
    80005296:	bfe9                	j	80005270 <exec+0x2d2>
  sz = sz1;
    80005298:	df843c23          	sd	s8,-520(s0)
  ip = 0;
    8000529c:	4a81                	li	s5,0
    8000529e:	bfc9                	j	80005270 <exec+0x2d2>
  sz = sz1;
    800052a0:	df843c23          	sd	s8,-520(s0)
  ip = 0;
    800052a4:	4a81                	li	s5,0
    800052a6:	b7e9                	j	80005270 <exec+0x2d2>
  sz = sz1;
    800052a8:	df843c23          	sd	s8,-520(s0)
  ip = 0;
    800052ac:	4a81                	li	s5,0
    800052ae:	b7c9                	j	80005270 <exec+0x2d2>
    if((sz1 = uvmalloc(pagetable, sz, ph.vaddr + ph.memsz)) == 0)
    800052b0:	df843483          	ld	s1,-520(s0)
  for(i=0, off=elf.phoff; i<elf.phnum; i++, off+=sizeof(ph)){
    800052b4:	e0843783          	ld	a5,-504(s0)
    800052b8:	0017869b          	addiw	a3,a5,1
    800052bc:	e0d43423          	sd	a3,-504(s0)
    800052c0:	e0043783          	ld	a5,-512(s0)
    800052c4:	0387879b          	addiw	a5,a5,56
    800052c8:	e8045703          	lhu	a4,-384(s0)
    800052cc:	e2e6d3e3          	bge	a3,a4,800050f2 <exec+0x154>
    if(readi(ip, 0, (uint64)&ph, off, sizeof(ph)) != sizeof(ph))
    800052d0:	2781                	sext.w	a5,a5
    800052d2:	e0f43023          	sd	a5,-512(s0)
    ...
    800052e8:	572080e7          	jalr	1394(ra) # 80003856 <readi>
    800052ec:	03800793          	li	a5,56
    800052f0:	f6f51ee3          	bne	a0,a5,8000526c <exec+0x2ce>
    if(ph.type != ELF_PROG_LOAD)
    800052f4:	e1042783          	lw	a5,-496(s0)
    800052f8:	4705                	li	a4,1
    800052fa:	fae79de3          	bne	a5,a4,800052b4 <exec+0x316>
    if(ph.memsz < ph.filesz)
    800052fe:	e3843603          	ld	a2,-456(s0)
    80005302:	e3043783          	ld	a5,-464(s0)
    80005306:	f8f660e3          	bltu	a2,a5,80005286 <exec+0x2e8>
    if(ph.vaddr + ph.memsz < ph.vaddr)
    8000530a:	e2043783          	ld	a5,-480(s0)
    8000530e:	963e                	add	a2,a2,a5
    80005310:	f6f66ee3          	bltu	a2,a5,8000528c <exec+0x2ee>
    if((sz1 = uvmalloc(pagetable, sz, ph.vaddr + ph.memsz)) == 0)
    80005314:	85a6                	mv	a1,s1
    80005316:	855a                	mv	a0,s6
    80005318:	ffffc097          	auipc	ra,0xffffc
    8000531c:	0d6080e7          	jalr	214(ra) # 800013ee <uvmalloc>
    80005320:	dea43c23          	sd	a0,-520(s0)
    80005324:	d53d                	beqz	a0,80005292 <exec+0x2f4>
    if(ph.vaddr % PGSIZE != 0)
    80005326:	e2043c03          	ld	s8,-480(s0)
    8000532a:	de043783          	ld	a5,-544(s0)
    8000532e:	00fc77b3          	and	a5,s8,a5
    80005332:	ff9d                	bnez	a5,80005270 <exec+0x2d2>
    if(loadseg(pagetable, ph.vaddr, ip, ph.off, ph.filesz) < 0)
    80005334:	e1842c83          	lw	s9,-488(s0)
    80005338:	e3042b83          	lw	s7,-464(s0)
  for(i = 0; i < sz; i += PGSIZE){
    8000533c:	f60b8ae3          	beqz	s7,800052b0 <exec+0x312>
    80005340:	89de                	mv	s3,s7
    80005342:	4481                	li	s1,0
    80005344:	b371                	j	800050d0 <exec+0x132>
...
argfd(int n, int *pfd, struct file **pf)
{
  ...
  if(argint(n, &fd) < 0)
    ...
    8000535e:	6d6080e7          	jalr	1750(ra) # 80002a30 <argint>
...
fdalloc(struct file *f)
{
  ...
  struct proc *p = myproc();
    ...
    800053be:	5c4080e7          	jalr	1476(ra) # 8000197e <myproc>
    800053c2:	862a                	mv	a2,a0

  for(fd = 0; fd < NOFILE; fd++){
    800053c4:	0d050793          	addi	a5,a0,208
  ...
  return -1;
    ...
    800053ec:	e204                	sd	s1,0(a2)
      return fd;
    800053ee:	b7f5                	j	800053da <fdalloc+0x2c>

00000000800053f0 <sys_dup>:
...
sys_dup(void)
{
  ...
  if(argfd(0, 0, &f) < 0)
    800053fa:	fd840613          	addi	a2,s0,-40
    800053fe:	4581                	li	a1,0
    80005400:	4501                	li	a0,0
    80005402:	00000097          	auipc	ra,0x0
    80005406:	f44080e7          	jalr	-188(ra) # 80005346 <argfd>
    return -1;
    8000540a:	57fd                	li	a5,-1
  if(argfd(0, 0, &f) < 0)
    8000540c:	02054363          	bltz	a0,80005432 <sys_dup+0x42>
  if((fd=fdalloc(f)) < 0)
    80005410:	fd843503          	ld	a0,-40(s0)
    80005414:	00000097          	auipc	ra,0x0
    80005418:	f9a080e7          	jalr	-102(ra) # 800053ae <fdalloc>
    8000541c:	84aa                	mv	s1,a0
    return -1;
    8000541e:	57fd                	li	a5,-1
  if((fd=fdalloc(f)) < 0)
    80005420:	00054963          	bltz	a0,80005432 <sys_dup+0x42>
  filedup(f);
    80005424:	fd843503          	ld	a0,-40(s0)
    80005428:	fffff097          	auipc	ra,0xfffff
    8000542c:	2dc080e7          	jalr	732(ra) # 80004704 <filedup>
  return fd;
...
sys_read(void)
{
  ...
  if(argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argaddr(1, &p) < 0)
    ...
    80005452:	ef8080e7          	jalr	-264(ra) # 80005346 <argfd>
    return -1;
    80005456:	57fd                	li	a5,-1
  if(argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argaddr(1, &p) < 0)
    80005458:	04054163          	bltz	a0,8000549a <sys_read+0x5c>
    8000545c:	fe440593          	addi	a1,s0,-28
    80005460:	4509                	li	a0,2
    80005462:	ffffd097          	auipc	ra,0xffffd
    80005466:	5ce080e7          	jalr	1486(ra) # 80002a30 <argint>
    return -1;
    8000546a:	57fd                	li	a5,-1
  if(argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argaddr(1, &p) < 0)
    8000546c:	02054763          	bltz	a0,8000549a <sys_read+0x5c>
    80005470:	fd840593          	addi	a1,s0,-40
    80005474:	4505                	li	a0,1
    80005476:	ffffd097          	auipc	ra,0xffffd
    8000547a:	5dc080e7          	jalr	1500(ra) # 80002a52 <argaddr>
    return -1;
    8000547e:	57fd                	li	a5,-1
  if(argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argaddr(1, &p) < 0)
    80005480:	00054d63          	bltz	a0,8000549a <sys_read+0x5c>
  return fileread(f, p, n);
    ...
    80005494:	400080e7          	jalr	1024(ra) # 80004890 <fileread>
...
sys_write(void)
{
  ...
  if(argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argaddr(1, &p) < 0)
    ...
    800054b8:	e92080e7          	jalr	-366(ra) # 80005346 <argfd>
    return -1;
    800054bc:	57fd                	li	a5,-1
  if(argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argaddr(1, &p) < 0)
    800054be:	04054163          	bltz	a0,80005500 <sys_write+0x5c>
    800054c2:	fe440593          	addi	a1,s0,-28
    800054c6:	4509                	li	a0,2
    800054c8:	ffffd097          	auipc	ra,0xffffd
    800054cc:	568080e7          	jalr	1384(ra) # 80002a30 <argint>
    return -1;
    800054d0:	57fd                	li	a5,-1
  if(argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argaddr(1, &p) < 0)
    800054d2:	02054763          	bltz	a0,80005500 <sys_write+0x5c>
    800054d6:	fd840593          	addi	a1,s0,-40
    800054da:	4505                	li	a0,1
    800054dc:	ffffd097          	auipc	ra,0xffffd
    800054e0:	576080e7          	jalr	1398(ra) # 80002a52 <argaddr>
    return -1;
    800054e4:	57fd                	li	a5,-1
  if(argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argaddr(1, &p) < 0)
    800054e6:	00054d63          	bltz	a0,80005500 <sys_write+0x5c>
  ...
  return filewrite(f, p, n);
    ...
    800054fa:	45c080e7          	jalr	1116(ra) # 80004952 <filewrite>
...
sys_close(void)
{
  ...
  if(argfd(0, &fd, &f) < 0)
    80005512:	fe040613          	addi	a2,s0,-32
    80005516:	fec40593          	addi	a1,s0,-20
    8000551a:	4501                	li	a0,0
    8000551c:	00000097          	auipc	ra,0x0
    80005520:	e2a080e7          	jalr	-470(ra) # 80005346 <argfd>
    return -1;
    80005524:	57fd                	li	a5,-1
  if(argfd(0, &fd, &f) < 0)
    80005526:	02054463          	bltz	a0,8000554e <sys_close+0x44>
  myproc()->ofile[fd] = 0;
    8000552a:	ffffc097          	auipc	ra,0xffffc
    8000552e:	454080e7          	jalr	1108(ra) # 8000197e <myproc>
    80005532:	fec42783          	lw	a5,-20(s0)
    80005536:	07e9                	addi	a5,a5,26
    80005538:	078e                	slli	a5,a5,0x3
    8000553a:	97aa                	add	a5,a5,a0
    8000553c:	0007b023          	sd	zero,0(a5)
  fileclose(f);
    80005540:	fe043503          	ld	a0,-32(s0)
    80005544:	fffff097          	auipc	ra,0xfffff
    80005548:	212080e7          	jalr	530(ra) # 80004756 <fileclose>
  return 0;
...
sys_fstat(void)
{
  ...
  if(argfd(0, 0, &f) < 0 || argaddr(1, &st) < 0)
    ...
    8000556c:	dde080e7          	jalr	-546(ra) # 80005346 <argfd>
    return -1;
    80005570:	57fd                	li	a5,-1
  if(argfd(0, 0, &f) < 0 || argaddr(1, &st) < 0)
    80005572:	02054563          	bltz	a0,8000559c <sys_fstat+0x44>
    80005576:	fe040593          	addi	a1,s0,-32
    8000557a:	4505                	li	a0,1
    8000557c:	ffffd097          	auipc	ra,0xffffd
    80005580:	4d6080e7          	jalr	1238(ra) # 80002a52 <argaddr>
    return -1;
    80005584:	57fd                	li	a5,-1
  if(argfd(0, 0, &f) < 0 || argaddr(1, &st) < 0)
    80005586:	00054b63          	bltz	a0,8000559c <sys_fstat+0x44>
  return filestat(f, st);
    8000558a:	fe043583          	ld	a1,-32(s0)
    8000558e:	fe843503          	ld	a0,-24(s0)
    80005592:	fffff097          	auipc	ra,0xfffff
    80005596:	28c080e7          	jalr	652(ra) # 8000481e <filestat>
...
00000000800055a6 <sys_link>:

// Create the path new as a link to the same inode as old.
uint64
sys_link(void)
{
    800055a6:	7169                	addi	sp,sp,-304
    800055a8:	f606                	sd	ra,296(sp)
    800055aa:	f222                	sd	s0,288(sp)
    800055ac:	ee26                	sd	s1,280(sp)
    800055ae:	ea4a                	sd	s2,272(sp)
    800055b0:	1a00                	addi	s0,sp,304
  char name[DIRSIZ], new[MAXPATH], old[MAXPATH];
  struct inode *dp, *ip;

  if(argstr(0, old, MAXPATH) < 0 || argstr(1, new, MAXPATH) < 0)
    800055b2:	08000613          	li	a2,128
    800055b6:	ed040593          	addi	a1,s0,-304
    800055ba:	4501                	li	a0,0
    800055bc:	ffffd097          	auipc	ra,0xffffd
    800055c0:	4b8080e7          	jalr	1208(ra) # 80002a74 <argstr>
    return -1;
    800055c4:	57fd                	li	a5,-1
  if(argstr(0, old, MAXPATH) < 0 || argstr(1, new, MAXPATH) < 0)
    800055c6:	10054e63          	bltz	a0,800056e2 <sys_link+0x13c>
    800055ca:	08000613          	li	a2,128
    800055ce:	f5040593          	addi	a1,s0,-176
    800055d2:	4505                	li	a0,1
    800055d4:	ffffd097          	auipc	ra,0xffffd
    800055d8:	4a0080e7          	jalr	1184(ra) # 80002a74 <argstr>
    return -1;
    800055dc:	57fd                	li	a5,-1
  if(argstr(0, old, MAXPATH) < 0 || argstr(1, new, MAXPATH) < 0)
    800055de:	10054263          	bltz	a0,800056e2 <sys_link+0x13c>

  begin_op();
    800055e2:	fffff097          	auipc	ra,0xfffff
    800055e6:	ca8080e7          	jalr	-856(ra) # 8000428a <begin_op>
  if((ip = namei(old)) == 0){
    800055ea:	ed040513          	addi	a0,s0,-304
    800055ee:	ffffe097          	auipc	ra,0xffffe
    800055f2:	76a080e7          	jalr	1898(ra) # 80003d58 <namei>
    800055f6:	84aa                	mv	s1,a0
    800055f8:	c551                	beqz	a0,80005684 <sys_link+0xde>
    end_op();
    return -1;
  }
  ...
  ilock(ip);
    ...
    800055fe:	fa8080e7          	jalr	-88(ra) # 800035a2 <ilock>
  if(ip->type == T_DIR){
    80005602:	04449703          	lh	a4,68(s1)
    80005606:	4785                	li	a5,1
    80005608:	08f70463          	beq	a4,a5,80005690 <sys_link+0xea>
    iunlockput(ip);
    end_op();
    return -1;
  }
  ...
  iupdate(ip);
    ...
    8000561c:	ec0080e7          	jalr	-320(ra) # 800034d8 <iupdate>
  iunlock(ip);
    80005620:	8526                	mv	a0,s1
    80005622:	ffffe097          	auipc	ra,0xffffe
    80005626:	042080e7          	jalr	66(ra) # 80003664 <iunlock>

  if((dp = nameiparent(new, name)) == 0)
    8000562a:	fd040593          	addi	a1,s0,-48
    8000562e:	f5040513          	addi	a0,s0,-176
    80005632:	ffffe097          	auipc	ra,0xffffe
    80005636:	744080e7          	jalr	1860(ra) # 80003d76 <nameiparent>
    8000563a:	892a                	mv	s2,a0
    8000563c:	c935                	beqz	a0,800056b0 <sys_link+0x10a>
    goto bad;
  ilock(dp);
    8000563e:	ffffe097          	auipc	ra,0xffffe
    80005642:	f64080e7          	jalr	-156(ra) # 800035a2 <ilock>
  if(dp->dev != ip->dev || dirlink(dp, name, ip->inum) < 0){
    80005646:	00092703          	lw	a4,0(s2)
    8000564a:	409c                	lw	a5,0(s1)
    8000564c:	04f71d63          	bne	a4,a5,800056a6 <sys_link+0x100>
    80005650:	40d0                	lw	a2,4(s1)
    80005652:	fd040593          	addi	a1,s0,-48
    80005656:	854a                	mv	a0,s2
    80005658:	ffffe097          	auipc	ra,0xffffe
    8000565c:	63e080e7          	jalr	1598(ra) # 80003c96 <dirlink>
    80005660:	04054363          	bltz	a0,800056a6 <sys_link+0x100>
    iunlockput(dp);
    goto bad;
  }
  iunlockput(dp);
    ...
    8000566a:	19e080e7          	jalr	414(ra) # 80003804 <iunlockput>
  iput(ip);
    8000566e:	8526                	mv	a0,s1
    80005670:	ffffe097          	auipc	ra,0xffffe
    80005674:	0ec080e7          	jalr	236(ra) # 8000375c <iput>

  end_op();
    80005678:	fffff097          	auipc	ra,0xfffff
    8000567c:	c92080e7          	jalr	-878(ra) # 8000430a <end_op>

  return 0;
    80005680:	4781                	li	a5,0
    80005682:	a085                	j	800056e2 <sys_link+0x13c>
    end_op();
    80005684:	fffff097          	auipc	ra,0xfffff
    80005688:	c86080e7          	jalr	-890(ra) # 8000430a <end_op>
    return -1;
    8000568c:	57fd                	li	a5,-1
    8000568e:	a891                	j	800056e2 <sys_link+0x13c>
    iunlockput(ip);
    80005690:	8526                	mv	a0,s1
    80005692:	ffffe097          	auipc	ra,0xffffe
    80005696:	172080e7          	jalr	370(ra) # 80003804 <iunlockput>
    end_op();
    8000569a:	fffff097          	auipc	ra,0xfffff
    8000569e:	c70080e7          	jalr	-912(ra) # 8000430a <end_op>
    return -1;
    800056a2:	57fd                	li	a5,-1
    800056a4:	a83d                	j	800056e2 <sys_link+0x13c>
    iunlockput(dp);
    800056a6:	854a                	mv	a0,s2
    800056a8:	ffffe097          	auipc	ra,0xffffe
    800056ac:	15c080e7          	jalr	348(ra) # 80003804 <iunlockput>

bad:
  ilock(ip);
    800056b0:	8526                	mv	a0,s1
    800056b2:	ffffe097          	auipc	ra,0xffffe
    800056b6:	ef0080e7          	jalr	-272(ra) # 800035a2 <ilock>
  ip->nlink--;
  ...
  iupdate(ip);
    ...
    800056ca:	e12080e7          	jalr	-494(ra) # 800034d8 <iupdate>
  iunlockput(ip);
    800056ce:	8526                	mv	a0,s1
    800056d0:	ffffe097          	auipc	ra,0xffffe
    800056d4:	134080e7          	jalr	308(ra) # 80003804 <iunlockput>
  end_op();
    800056d8:	fffff097          	auipc	ra,0xfffff
    800056dc:	c32080e7          	jalr	-974(ra) # 8000430a <end_op>
  return -1;
    800056e0:	57fd                	li	a5,-1
}
    800056e2:	853e                	mv	a0,a5
    800056e4:	70b2                	ld	ra,296(sp)
    800056e6:	7412                	ld	s0,288(sp)
    800056e8:	64f2                	ld	s1,280(sp)
    800056ea:	6952                	ld	s2,272(sp)
    800056ec:	6155                	addi	sp,sp,304
    800056ee:	8082                	ret

00000000800056f0 <isdirempty>:
isdirempty(struct inode *dp)
{
  ...
  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
    800056f0:	4578                	lw	a4,76(a0)
    800056f2:	02000793          	li	a5,32
    800056f6:	04e7fa63          	bgeu	a5,a4,8000574a <isdirempty+0x5a>
{
    800056fa:	7179                	addi	sp,sp,-48
    800056fc:	f406                	sd	ra,40(sp)
    800056fe:	f022                	sd	s0,32(sp)
    80005700:	ec26                	sd	s1,24(sp)
    80005702:	e84a                	sd	s2,16(sp)
    80005704:	1800                	addi	s0,sp,48
    80005706:	892a                	mv	s2,a0
  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
    80005708:	02000493          	li	s1,32
    if(readi(dp, 0, (uint64)&de, off, sizeof(de)) != sizeof(de))
    8000570c:	4741                	li	a4,16
    8000570e:	86a6                	mv	a3,s1
    80005710:	fd040613          	addi	a2,s0,-48
    80005714:	4581                	li	a1,0
    80005716:	854a                	mv	a0,s2
    80005718:	ffffe097          	auipc	ra,0xffffe
    8000571c:	13e080e7          	jalr	318(ra) # 80003856 <readi>
    80005720:	47c1                	li	a5,16
    80005722:	00f51c63          	bne	a0,a5,8000573a <isdirempty+0x4a>
      panic("isdirempty: readi");
    if(de.inum != 0)
    80005726:	fd045783          	lhu	a5,-48(s0)
    8000572a:	e395                	bnez	a5,8000574e <isdirempty+0x5e>
  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
    8000572c:	24c1                	addiw	s1,s1,16
    8000572e:	04c92783          	lw	a5,76(s2)
    80005732:	fcf4ede3          	bltu	s1,a5,8000570c <isdirempty+0x1c>
      return 0;
  }
  return 1;
    80005736:	4505                	li	a0,1
    80005738:	a821                	j	80005750 <isdirempty+0x60>
      panic("isdirempty: readi");
    8000573a:	00003517          	auipc	a0,0x3
    8000573e:	00650513          	addi	a0,a0,6 # 80008740 <syscalls+0x310>
...
sys_unlink(void)
{
    8000575c:	7155                	addi	sp,sp,-208
    8000575e:	e586                	sd	ra,200(sp)
    80005760:	e1a2                	sd	s0,192(sp)
    80005762:	fd26                	sd	s1,184(sp)
    80005764:	f94a                	sd	s2,176(sp)
    80005766:	0980                	addi	s0,sp,208
  struct inode *ip, *dp;
  struct dirent de;
  ...
  if(argstr(0, path, MAXPATH) < 0)
    ...
    8000576c:	f4040593          	addi	a1,s0,-192
    80005770:	4501                	li	a0,0
    80005772:	ffffd097          	auipc	ra,0xffffd
    80005776:	302080e7          	jalr	770(ra) # 80002a74 <argstr>
    8000577a:	16054363          	bltz	a0,800058e0 <sys_unlink+0x184>
    return -1;

  begin_op();
    8000577e:	fffff097          	auipc	ra,0xfffff
    80005782:	b0c080e7          	jalr	-1268(ra) # 8000428a <begin_op>
  if((dp = nameiparent(path, name)) == 0){
    80005786:	fc040593          	addi	a1,s0,-64
    8000578a:	f4040513          	addi	a0,s0,-192
    8000578e:	ffffe097          	auipc	ra,0xffffe
    80005792:	5e8080e7          	jalr	1512(ra) # 80003d76 <nameiparent>
    80005796:	84aa                	mv	s1,a0
    80005798:	c961                	beqz	a0,80005868 <sys_unlink+0x10c>
    end_op();
    return -1;
  }
  ...
  ilock(dp);
    ...
    8000579e:	e08080e7          	jalr	-504(ra) # 800035a2 <ilock>

  // Cannot unlink "." or "..".
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
    800057a2:	00003597          	auipc	a1,0x3
    800057a6:	e7e58593          	addi	a1,a1,-386 # 80008620 <syscalls+0x1f0>
    800057aa:	fc040513          	addi	a0,s0,-64
    800057ae:	ffffe097          	auipc	ra,0xffffe
    800057b2:	2be080e7          	jalr	702(ra) # 80003a6c <namecmp>
    800057b6:	c175                	beqz	a0,8000589a <sys_unlink+0x13e>
    800057b8:	00003597          	auipc	a1,0x3
    800057bc:	e7058593          	addi	a1,a1,-400 # 80008628 <syscalls+0x1f8>
    800057c0:	fc040513          	addi	a0,s0,-64
    800057c4:	ffffe097          	auipc	ra,0xffffe
    800057c8:	2a8080e7          	jalr	680(ra) # 80003a6c <namecmp>
    800057cc:	c579                	beqz	a0,8000589a <sys_unlink+0x13e>
    goto bad;

  if((ip = dirlookup(dp, name, &off)) == 0)
    800057ce:	f3c40613          	addi	a2,s0,-196
    800057d2:	fc040593          	addi	a1,s0,-64
    800057d6:	8526                	mv	a0,s1
    800057d8:	ffffe097          	auipc	ra,0xffffe
    800057dc:	2ae080e7          	jalr	686(ra) # 80003a86 <dirlookup>
    800057e0:	892a                	mv	s2,a0
    800057e2:	cd45                	beqz	a0,8000589a <sys_unlink+0x13e>
    goto bad;
  ilock(ip);
  ...
  if(ip->nlink < 1)
    ...
    800057f0:	08f05263          	blez	a5,80005874 <sys_unlink+0x118>
    panic("unlink: nlink < 1");
  if(ip->type == T_DIR && !isdirempty(ip)){
    800057f4:	04491703          	lh	a4,68(s2)
    800057f8:	4785                	li	a5,1
    800057fa:	08f70563          	beq	a4,a5,80005884 <sys_unlink+0x128>
    iunlockput(ip);
    goto bad;
  }
  ...
  memset(&de, 0, sizeof(de));
    ...
    80005802:	fd040513          	addi	a0,s0,-48
    80005806:	ffffb097          	auipc	ra,0xffffb
    8000580a:	4b8080e7          	jalr	1208(ra) # 80000cbe <memset>
  if(writei(dp, 0, (uint64)&de, off, sizeof(de)) != sizeof(de))
    8000580e:	4741                	li	a4,16
    80005810:	f3c42683          	lw	a3,-196(s0)
    80005814:	fd040613          	addi	a2,s0,-48
    80005818:	4581                	li	a1,0
    8000581a:	8526                	mv	a0,s1
    8000581c:	ffffe097          	auipc	ra,0xffffe
    80005820:	132080e7          	jalr	306(ra) # 8000394e <writei>
    80005824:	47c1                	li	a5,16
    80005826:	08f51a63          	bne	a0,a5,800058ba <sys_unlink+0x15e>
    panic("unlink: writei");
  if(ip->type == T_DIR){
    8000582a:	04491703          	lh	a4,68(s2)
    8000582e:	4785                	li	a5,1
    80005830:	08f70d63          	beq	a4,a5,800058ca <sys_unlink+0x16e>
    dp->nlink--;
    iupdate(dp);
  }
  iunlockput(dp);
    ...
    8000583a:	fce080e7          	jalr	-50(ra) # 80003804 <iunlockput>
  ...
  iupdate(ip);
    ...
    8000584e:	c8e080e7          	jalr	-882(ra) # 800034d8 <iupdate>
  iunlockput(ip);
    80005852:	854a                	mv	a0,s2
    80005854:	ffffe097          	auipc	ra,0xffffe
    80005858:	fb0080e7          	jalr	-80(ra) # 80003804 <iunlockput>

  end_op();
    8000585c:	fffff097          	auipc	ra,0xfffff
    80005860:	aae080e7          	jalr	-1362(ra) # 8000430a <end_op>

  return 0;
    80005864:	4501                	li	a0,0
    80005866:	a0a1                	j	800058ae <sys_unlink+0x152>
    end_op();
    80005868:	fffff097          	auipc	ra,0xfffff
    8000586c:	aa2080e7          	jalr	-1374(ra) # 8000430a <end_op>
    return -1;
    80005870:	557d                	li	a0,-1
    80005872:	a835                	j	800058ae <sys_unlink+0x152>
    panic("unlink: nlink < 1");
    80005874:	00003517          	auipc	a0,0x3
    80005878:	dbc50513          	addi	a0,a0,-580 # 80008630 <syscalls+0x200>
    8000587c:	ffffb097          	auipc	ra,0xffffb
    80005880:	cae080e7          	jalr	-850(ra) # 8000052a <panic>
  if(ip->type == T_DIR && !isdirempty(ip)){
    80005884:	854a                	mv	a0,s2
    80005886:	00000097          	auipc	ra,0x0
    8000588a:	e6a080e7          	jalr	-406(ra) # 800056f0 <isdirempty>
    8000588e:	f925                	bnez	a0,800057fe <sys_unlink+0xa2>
    iunlockput(ip);
    80005890:	854a                	mv	a0,s2
    80005892:	ffffe097          	auipc	ra,0xffffe
    80005896:	f72080e7          	jalr	-142(ra) # 80003804 <iunlockput>

bad:
  iunlockput(dp);
    8000589a:	8526                	mv	a0,s1
    8000589c:	ffffe097          	auipc	ra,0xffffe
    800058a0:	f68080e7          	jalr	-152(ra) # 80003804 <iunlockput>
  end_op();
    800058a4:	fffff097          	auipc	ra,0xfffff
    800058a8:	a66080e7          	jalr	-1434(ra) # 8000430a <end_op>
  return -1;
    800058ac:	557d                	li	a0,-1
}
    800058ae:	60ae                	ld	ra,200(sp)
    800058b0:	640e                	ld	s0,192(sp)
    800058b2:	74ea                	ld	s1,184(sp)
    800058b4:	794a                	ld	s2,176(sp)
    800058b6:	6169                	addi	sp,sp,208
    800058b8:	8082                	ret
    panic("unlink: writei");
    800058ba:	00003517          	auipc	a0,0x3
    800058be:	d8e50513          	addi	a0,a0,-626 # 80008648 <syscalls+0x218>
    800058c2:	ffffb097          	auipc	ra,0xffffb
    800058c6:	c68080e7          	jalr	-920(ra) # 8000052a <panic>
    dp->nlink--;
    ...
    800058da:	c02080e7          	jalr	-1022(ra) # 800034d8 <iupdate>
    800058de:	bf99                	j	80005834 <sys_unlink+0xd8>
    return -1;
    800058e0:	557d                	li	a0,-1
    800058e2:	b7f1                	j	800058ae <sys_unlink+0x152>
...
create(char *path, short type, short major, short minor)
{
    ...
    800058f8:	8ab2                	mv	s5,a2
    800058fa:	8a36                	mv	s4,a3
  struct inode *ip, *dp;
  char name[DIRSIZ];
  ...
  if((dp = nameiparent(path, name)) == 0)
    ...
    80005904:	476080e7          	jalr	1142(ra) # 80003d76 <nameiparent>
    80005908:	892a                	mv	s2,a0
    8000590a:	12050e63          	beqz	a0,80005a46 <create+0x162>
    return 0;

  ilock(dp);
    8000590e:	ffffe097          	auipc	ra,0xffffe
    80005912:	c94080e7          	jalr	-876(ra) # 800035a2 <ilock>
  ...
  if((ip = dirlookup(dp, name, 0)) != 0){
    ...
    80005922:	168080e7          	jalr	360(ra) # 80003a86 <dirlookup>
    80005926:	84aa                	mv	s1,a0
    80005928:	c921                	beqz	a0,80005978 <create+0x94>
    iunlockput(dp);
    8000592a:	854a                	mv	a0,s2
    8000592c:	ffffe097          	auipc	ra,0xffffe
    80005930:	ed8080e7          	jalr	-296(ra) # 80003804 <iunlockput>
    ilock(ip);
    80005934:	8526                	mv	a0,s1
    80005936:	ffffe097          	auipc	ra,0xffffe
    8000593a:	c6c080e7          	jalr	-916(ra) # 800035a2 <ilock>
    if(type == T_FILE && (ip->type == T_FILE || ip->type == T_DEVICE))
    8000593e:	2981                	sext.w	s3,s3
    80005940:	4789                	li	a5,2
    80005942:	02f99463          	bne	s3,a5,8000596a <create+0x86>
    80005946:	0444d783          	lhu	a5,68(s1)
    8000594a:	37f9                	addiw	a5,a5,-2
    8000594c:	17c2                	slli	a5,a5,0x30
    8000594e:	93c1                	srli	a5,a5,0x30
    80005950:	4705                	li	a4,1
    80005952:	00f76c63          	bltu	a4,a5,8000596a <create+0x86>
  ...
  return ip;
    ...
    80005970:	e98080e7          	jalr	-360(ra) # 80003804 <iunlockput>
    return 0;
    80005974:	4481                	li	s1,0
    80005976:	b7c5                	j	80005956 <create+0x72>
  if((ip = ialloc(dp->dev, type)) == 0)
    80005978:	85ce                	mv	a1,s3
    8000597a:	00092503          	lw	a0,0(s2)
    8000597e:	ffffe097          	auipc	ra,0xffffe
    80005982:	a8c080e7          	jalr	-1396(ra) # 8000340a <ialloc>
    80005986:	84aa                	mv	s1,a0
    80005988:	c521                	beqz	a0,800059d0 <create+0xec>
  ilock(ip);
    8000598a:	ffffe097          	auipc	ra,0xffffe
    8000598e:	c18080e7          	jalr	-1000(ra) # 800035a2 <ilock>
  ip->major = major;
    80005992:	05549323          	sh	s5,70(s1)
  ip->minor = minor;
    80005996:	05449423          	sh	s4,72(s1)
  ip->nlink = 1;
    8000599a:	4a05                	li	s4,1
    8000599c:	05449523          	sh	s4,74(s1)
  iupdate(ip);
    800059a0:	8526                	mv	a0,s1
    800059a2:	ffffe097          	auipc	ra,0xffffe
    800059a6:	b36080e7          	jalr	-1226(ra) # 800034d8 <iupdate>
  if(type == T_DIR){  // Create . and .. entries.
    800059aa:	2981                	sext.w	s3,s3
    800059ac:	03498a63          	beq	s3,s4,800059e0 <create+0xfc>
  if(dirlink(dp, name, ip->inum) < 0)
    800059b0:	40d0                	lw	a2,4(s1)
    800059b2:	fb040593          	addi	a1,s0,-80
    800059b6:	854a                	mv	a0,s2
    800059b8:	ffffe097          	auipc	ra,0xffffe
    800059bc:	2de080e7          	jalr	734(ra) # 80003c96 <dirlink>
    800059c0:	06054b63          	bltz	a0,80005a36 <create+0x152>
  iunlockput(dp);
    800059c4:	854a                	mv	a0,s2
    800059c6:	ffffe097          	auipc	ra,0xffffe
    800059ca:	e3e080e7          	jalr	-450(ra) # 80003804 <iunlockput>
  return ip;
    800059ce:	b761                	j	80005956 <create+0x72>
    panic("create: ialloc");
    800059d0:	00003517          	auipc	a0,0x3
    800059d4:	d8850513          	addi	a0,a0,-632 # 80008758 <syscalls+0x328>
    800059d8:	ffffb097          	auipc	ra,0xffffb
    800059dc:	b52080e7          	jalr	-1198(ra) # 8000052a <panic>
    dp->nlink++;  // for ".."
    800059e0:	04a95783          	lhu	a5,74(s2)
    800059e4:	2785                	addiw	a5,a5,1
    800059e6:	04f91523          	sh	a5,74(s2)
    iupdate(dp);
    800059ea:	854a                	mv	a0,s2
    800059ec:	ffffe097          	auipc	ra,0xffffe
    800059f0:	aec080e7          	jalr	-1300(ra) # 800034d8 <iupdate>
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
    800059f4:	40d0                	lw	a2,4(s1)
    800059f6:	00003597          	auipc	a1,0x3
    800059fa:	c2a58593          	addi	a1,a1,-982 # 80008620 <syscalls+0x1f0>
    800059fe:	8526                	mv	a0,s1
    80005a00:	ffffe097          	auipc	ra,0xffffe
    80005a04:	296080e7          	jalr	662(ra) # 80003c96 <dirlink>
    80005a08:	00054f63          	bltz	a0,80005a26 <create+0x142>
    80005a0c:	00492603          	lw	a2,4(s2)
    80005a10:	00003597          	auipc	a1,0x3
    80005a14:	c1858593          	addi	a1,a1,-1000 # 80008628 <syscalls+0x1f8>
    80005a18:	8526                	mv	a0,s1
    80005a1a:	ffffe097          	auipc	ra,0xffffe
    80005a1e:	27c080e7          	jalr	636(ra) # 80003c96 <dirlink>
    80005a22:	f80557e3          	bgez	a0,800059b0 <create+0xcc>
      panic("create dots");
    80005a26:	00003517          	auipc	a0,0x3
    80005a2a:	d4250513          	addi	a0,a0,-702 # 80008768 <syscalls+0x338>
    80005a2e:	ffffb097          	auipc	ra,0xffffb
    80005a32:	afc080e7          	jalr	-1284(ra) # 8000052a <panic>
    panic("create: dirlink");
    80005a36:	00003517          	auipc	a0,0x3
    80005a3a:	d4250513          	addi	a0,a0,-702 # 80008778 <syscalls+0x348>
    80005a3e:	ffffb097          	auipc	ra,0xffffb
    80005a42:	aec080e7          	jalr	-1300(ra) # 8000052a <panic>
    return 0;
    80005a46:	84aa                	mv	s1,a0
    80005a48:	b739                	j	80005956 <create+0x72>
...
sys_open(void)
{
  ...
  if((n = argstr(0, path, MAXPATH)) < 0 || argint(1, &omode) < 0)
    ...
    80005a66:	012080e7          	jalr	18(ra) # 80002a74 <argstr>
    return -1;
  ...
  if((n = argstr(0, path, MAXPATH)) < 0 || argint(1, &omode) < 0)
    ...
    80005a7a:	fba080e7          	jalr	-70(ra) # 80002a30 <argint>
    80005a7e:	0a054863          	bltz	a0,80005b2e <sys_open+0xe4>

  begin_op();
    80005a82:	fffff097          	auipc	ra,0xfffff
    80005a86:	808080e7          	jalr	-2040(ra) # 8000428a <begin_op>
  ...
  if(omode & O_CREATE){
    ...
    80005aa2:	e46080e7          	jalr	-442(ra) # 800058e4 <create>
  ...
  iunlock(ip);
    ...
    80005b22:	b46080e7          	jalr	-1210(ra) # 80003664 <iunlock>
  end_op();
    80005b26:	ffffe097          	auipc	ra,0xffffe
    80005b2a:	7e4080e7          	jalr	2020(ra) # 8000430a <end_op>
  ...
  return fd;
    ...
    80005b76:	c92080e7          	jalr	-878(ra) # 80003804 <iunlockput>
      end_op();
    80005b7a:	ffffe097          	auipc	ra,0xffffe
    80005b7e:	790080e7          	jalr	1936(ra) # 8000430a <end_op>
      return -1;
    80005b82:	54fd                	li	s1,-1
    80005b84:	b76d                	j	80005b2e <sys_open+0xe4>
      end_op();
    80005b86:	ffffe097          	auipc	ra,0xffffe
    80005b8a:	784080e7          	jalr	1924(ra) # 8000430a <end_op>
      return -1;
    ...
    80005b98:	c70080e7          	jalr	-912(ra) # 80003804 <iunlockput>
    end_op();
    80005b9c:	ffffe097          	auipc	ra,0xffffe
    80005ba0:	76e080e7          	jalr	1902(ra) # 8000430a <end_op>
    return -1;
    ...
    80005bbc:	af8080e7          	jalr	-1288(ra) # 800036b0 <itrunc>
    80005bc0:	bfb1                	j	80005b1c <sys_open+0xd2>
      fileclose(f);
    80005bc2:	854e                	mv	a0,s3
    80005bc4:	fffff097          	auipc	ra,0xfffff
    80005bc8:	b92080e7          	jalr	-1134(ra) # 80004756 <fileclose>
    iunlockput(ip);
    80005bcc:	854a                	mv	a0,s2
    80005bce:	ffffe097          	auipc	ra,0xffffe
    80005bd2:	c36080e7          	jalr	-970(ra) # 80003804 <iunlockput>
    end_op();
    80005bd6:	ffffe097          	auipc	ra,0xffffe
    80005bda:	734080e7          	jalr	1844(ra) # 8000430a <end_op>
    return -1;
...
sys_mkdir(void)
{
  ...
  begin_op();
    ...
    80005bee:	6a0080e7          	jalr	1696(ra) # 8000428a <begin_op>
  if(argstr(0, path, MAXPATH) < 0 || (ip = create(path, T_DIR, 0, 0)) == 0){
    ...
    80005c00:	e78080e7          	jalr	-392(ra) # 80002a74 <argstr>
    ...
    80005c16:	cd2080e7          	jalr	-814(ra) # 800058e4 <create>
  ...
  iunlockput(ip);
    ...
    80005c20:	be8080e7          	jalr	-1048(ra) # 80003804 <iunlockput>
  end_op();
    80005c24:	ffffe097          	auipc	ra,0xffffe
    80005c28:	6e6080e7          	jalr	1766(ra) # 8000430a <end_op>
  return 0;
    ...
    80005c3a:	6d4080e7          	jalr	1748(ra) # 8000430a <end_op>
    return -1;
...
sys_mknod(void)
{
  ...
  if((argstr(0, path, MAXPATH)) < 0 ||
    ...
    80005c72:	dc2080e7          	jalr	-574(ra) # 80002a30 <argint>
  if((argstr(0, path, MAXPATH)) < 0 ||
    ...
    80005c84:	db0080e7          	jalr	-592(ra) # 80002a30 <argint>
     argint(1, &major) < 0 ||
    ...
    80005c9e:	c4a080e7          	jalr	-950(ra) # 800058e4 <create>
     argint(2, &minor) < 0 ||
  ...
  iunlockput(ip);
    ...
    80005ca8:	b60080e7          	jalr	-1184(ra) # 80003804 <iunlockput>
  end_op();
    80005cac:	ffffe097          	auipc	ra,0xffffe
    80005cb0:	65e080e7          	jalr	1630(ra) # 8000430a <end_op>
  return 0;
    80005cb4:	4501                	li	a0,0
    80005cb6:	a031                	j	80005cc2 <sys_mknod+0x80>
    end_op();
    80005cb8:	ffffe097          	auipc	ra,0xffffe
    80005cbc:	652080e7          	jalr	1618(ra) # 8000430a <end_op>
    return -1;
...
sys_chdir(void)
{
  ...
  struct proc *p = myproc();
    ...
    80005cda:	ca8080e7          	jalr	-856(ra) # 8000197e <myproc>
    80005cde:	892a                	mv	s2,a0
  
  begin_op();
    80005ce0:	ffffe097          	auipc	ra,0xffffe
    80005ce4:	5aa080e7          	jalr	1450(ra) # 8000428a <begin_op>
  ...
  ilock(ip);
    ...
    80005d12:	894080e7          	jalr	-1900(ra) # 800035a2 <ilock>
  if(ip->type != T_DIR){
  ...
  iunlock(ip);
    ...
    80005d26:	942080e7          	jalr	-1726(ra) # 80003664 <iunlock>
  iput(p->cwd);
    80005d2a:	15093503          	ld	a0,336(s2)
    80005d2e:	ffffe097          	auipc	ra,0xffffe
    80005d32:	a2e080e7          	jalr	-1490(ra) # 8000375c <iput>
  end_op();
    80005d36:	ffffe097          	auipc	ra,0xffffe
    80005d3a:	5d4080e7          	jalr	1492(ra) # 8000430a <end_op>
  p->cwd = ip;
  ...
  return 0;
    ...
    80005d54:	5ba080e7          	jalr	1466(ra) # 8000430a <end_op>
    return -1;
    ...
    80005d62:	aa6080e7          	jalr	-1370(ra) # 80003804 <iunlockput>
    end_op();
    80005d66:	ffffe097          	auipc	ra,0xffffe
    80005d6a:	5a4080e7          	jalr	1444(ra) # 8000430a <end_op>
    return -1;
...
sys_exec(void)
{
  ...
  if(argstr(0, path, MAXPATH) < 0 || argaddr(1, &uargv) < 0){
    ...
    80005d92:	ce6080e7          	jalr	-794(ra) # 80002a74 <argstr>
    return -1;
    80005d96:	597d                	li	s2,-1
  if(argstr(0, path, MAXPATH) < 0 || argaddr(1, &uargv) < 0){
    80005d98:	0c054a63          	bltz	a0,80005e6c <sys_exec+0xfa>
    80005d9c:	e3840593          	addi	a1,s0,-456
    80005da0:	4505                	li	a0,1
    80005da2:	ffffd097          	auipc	ra,0xffffd
    80005da6:	cb0080e7          	jalr	-848(ra) # 80002a52 <argaddr>
    80005daa:	0c054163          	bltz	a0,80005e6c <sys_exec+0xfa>
  }
  memset(argv, 0, sizeof(argv));
    ...
    80005dbc:	f06080e7          	jalr	-250(ra) # 80000cbe <memset>
  for(i=0;; i++){
    if(i >= NELEM(argv)){
  ...
  memset(argv, 0, sizeof(argv));
    ...
    80005dd0:	00391793          	slli	a5,s2,0x3
    80005dd4:	e3040593          	addi	a1,s0,-464
    80005dd8:	e3843503          	ld	a0,-456(s0)
    80005ddc:	953e                	add	a0,a0,a5
    80005dde:	ffffd097          	auipc	ra,0xffffd
    80005de2:	bb8080e7          	jalr	-1096(ra) # 80002996 <fetchaddr>
    ...
    80005df4:	ce2080e7          	jalr	-798(ra) # 80000ad2 <kalloc>
    ...
    80005e0a:	be2080e7          	jalr	-1054(ra) # 800029e8 <fetchstr>
 ...
 bad:
  for(i = 0; i < NELEM(argv) && argv[i] != 0; i++)
    80005e1a:	10048913          	addi	s2,s1,256
    80005e1e:	6088                	ld	a0,0(s1)
    80005e20:	c529                	beqz	a0,80005e6a <sys_exec+0xf8>
    kfree(argv[i]);
    80005e22:	ffffb097          	auipc	ra,0xffffb
    80005e26:	bb4080e7          	jalr	-1100(ra) # 800009d6 <kfree>
  for(i = 0; i < NELEM(argv) && argv[i] != 0; i++)
    80005e2a:	04a1                	addi	s1,s1,8
    80005e2c:	ff2499e3          	bne	s1,s2,80005e1e <sys_exec+0xac>
  return -1;
    80005e30:	597d                	li	s2,-1
    80005e32:	a82d                	j	80005e6c <sys_exec+0xfa>
      argv[i] = 0;
    80005e34:	0a8e                	slli	s5,s5,0x3
    80005e36:	fc040793          	addi	a5,s0,-64
    80005e3a:	9abe                	add	s5,s5,a5
    80005e3c:	e80ab023          	sd	zero,-384(s5) # ffffffffffffee80 <end+0xffffffff7ffd8e80>
  int ret = exec(path, argv);
    80005e40:	e4040593          	addi	a1,s0,-448
    80005e44:	f4040513          	addi	a0,s0,-192
    80005e48:	fffff097          	auipc	ra,0xfffff
    80005e4c:	156080e7          	jalr	342(ra) # 80004f9e <exec>
    80005e50:	892a                	mv	s2,a0
  for(i = 0; i < NELEM(argv) && argv[i] != 0; i++)
    80005e52:	10048993          	addi	s3,s1,256
    80005e56:	6088                	ld	a0,0(s1)
    80005e58:	c911                	beqz	a0,80005e6c <sys_exec+0xfa>
    kfree(argv[i]);
    80005e5a:	ffffb097          	auipc	ra,0xffffb
    80005e5e:	b7c080e7          	jalr	-1156(ra) # 800009d6 <kfree>
  for(i = 0; i < NELEM(argv) && argv[i] != 0; i++)
    80005e62:	04a1                	addi	s1,s1,8
    80005e64:	ff3499e3          	bne	s1,s3,80005e56 <sys_exec+0xe4>
    80005e68:	a011                	j	80005e6c <sys_exec+0xfa>
  return -1;
    80005e6a:	597d                	li	s2,-1
}
    80005e6c:	854a                	mv	a0,s2
    80005e6e:	60be                	ld	ra,456(sp)
    80005e70:	641e                	ld	s0,448(sp)
    80005e72:	74fa                	ld	s1,440(sp)
    80005e74:	795a                	ld	s2,432(sp)
    80005e76:	79ba                	ld	s3,424(sp)
    80005e78:	7a1a                	ld	s4,416(sp)
    80005e7a:	6afa                	ld	s5,408(sp)
    80005e7c:	6179                	addi	sp,sp,464
    80005e7e:	8082                	ret

0000000080005e80 <sys_pipe>:
...
sys_pipe(void)
{
    ...
    80005e88:	0080                	addi	s0,sp,64
  uint64 fdarray; // user pointer to array of two integers
  struct file *rf, *wf;
  int fd0, fd1;
  struct proc *p = myproc();
    80005e8a:	ffffc097          	auipc	ra,0xffffc
    80005e8e:	af4080e7          	jalr	-1292(ra) # 8000197e <myproc>
    80005e92:	84aa                	mv	s1,a0

  if(argaddr(0, &fdarray) < 0)
    80005e94:	fd840593          	addi	a1,s0,-40
    80005e98:	4501                	li	a0,0
    80005e9a:	ffffd097          	auipc	ra,0xffffd
    80005e9e:	bb8080e7          	jalr	-1096(ra) # 80002a52 <argaddr>
    return -1;
    80005ea2:	57fd                	li	a5,-1
  if(argaddr(0, &fdarray) < 0)
    80005ea4:	0e054063          	bltz	a0,80005f84 <sys_pipe+0x104>
  if(pipealloc(&rf, &wf) < 0)
    80005ea8:	fc840593          	addi	a1,s0,-56
    80005eac:	fd040513          	addi	a0,s0,-48
    80005eb0:	fffff097          	auipc	ra,0xfffff
    80005eb4:	dcc080e7          	jalr	-564(ra) # 80004c7c <pipealloc>
    return -1;
    80005eb8:	57fd                	li	a5,-1
  if(pipealloc(&rf, &wf) < 0)
    80005eba:	0c054563          	bltz	a0,80005f84 <sys_pipe+0x104>
  fd0 = -1;
    80005ebe:	fcf42223          	sw	a5,-60(s0)
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
    80005ec2:	fd043503          	ld	a0,-48(s0)
    80005ec6:	fffff097          	auipc	ra,0xfffff
    80005eca:	4e8080e7          	jalr	1256(ra) # 800053ae <fdalloc>
    80005ece:	fca42223          	sw	a0,-60(s0)
    80005ed2:	08054c63          	bltz	a0,80005f6a <sys_pipe+0xea>
    80005ed6:	fc843503          	ld	a0,-56(s0)
    80005eda:	fffff097          	auipc	ra,0xfffff
    80005ede:	4d4080e7          	jalr	1236(ra) # 800053ae <fdalloc>
    80005ee2:	fca42023          	sw	a0,-64(s0)
    80005ee6:	06054863          	bltz	a0,80005f56 <sys_pipe+0xd6>
      p->ofile[fd0] = 0;
    fileclose(rf);
    fileclose(wf);
    return -1;
  ...
  if(copyout(p->pagetable, fdarray, (char*)&fd0, sizeof(fd0)) < 0 ||
    ...
    80005eec:	fc440613          	addi	a2,s0,-60
    80005ef0:	fd843583          	ld	a1,-40(s0)
    80005ef4:	68a8                	ld	a0,80(s1)
    80005ef6:	ffffb097          	auipc	ra,0xffffb
    80005efa:	748080e7          	jalr	1864(ra) # 8000163e <copyout>
    80005efe:	02054063          	bltz	a0,80005f1e <sys_pipe+0x9e>
     copyout(p->pagetable, fdarray+sizeof(fd0), (char *)&fd1, sizeof(fd1)) < 0){
    80005f02:	4691                	li	a3,4
    80005f04:	fc040613          	addi	a2,s0,-64
    80005f08:	fd843583          	ld	a1,-40(s0)
    80005f0c:	0591                	addi	a1,a1,4
    80005f0e:	68a8                	ld	a0,80(s1)
    80005f10:	ffffb097          	auipc	ra,0xffffb
    80005f14:	72e080e7          	jalr	1838(ra) # 8000163e <copyout>
    p->ofile[fd1] = 0;
    fileclose(rf);
    fileclose(wf);
    return -1;
  ...
  if(copyout(p->pagetable, fdarray, (char*)&fd0, sizeof(fd0)) < 0 ||
    80005f1a:	06055563          	bgez	a0,80005f84 <sys_pipe+0x104>
    p->ofile[fd0] = 0;
    ...
    p->ofile[fd1] = 0;
    80005f2c:	fc042503          	lw	a0,-64(s0)
    80005f30:	0569                	addi	a0,a0,26
    80005f32:	050e                	slli	a0,a0,0x3
    80005f34:	9526                	add	a0,a0,s1
    80005f36:	00053023          	sd	zero,0(a0)
    fileclose(rf);
    80005f3a:	fd043503          	ld	a0,-48(s0)
    80005f3e:	fffff097          	auipc	ra,0xfffff
    80005f42:	818080e7          	jalr	-2024(ra) # 80004756 <fileclose>
    fileclose(wf);
    80005f46:	fc843503          	ld	a0,-56(s0)
    80005f4a:	fffff097          	auipc	ra,0xfffff
    80005f4e:	80c080e7          	jalr	-2036(ra) # 80004756 <fileclose>
    return -1;
    80005f52:	57fd                	li	a5,-1
    80005f54:	a805                	j	80005f84 <sys_pipe+0x104>
    if(fd0 >= 0)
    80005f56:	fc442783          	lw	a5,-60(s0)
    80005f5a:	0007c863          	bltz	a5,80005f6a <sys_pipe+0xea>
      p->ofile[fd0] = 0;
    80005f5e:	01a78513          	addi	a0,a5,26
    80005f62:	050e                	slli	a0,a0,0x3
    80005f64:	9526                	add	a0,a0,s1
    80005f66:	00053023          	sd	zero,0(a0)
    fileclose(rf);
    80005f6a:	fd043503          	ld	a0,-48(s0)
    80005f6e:	ffffe097          	auipc	ra,0xffffe
    80005f72:	7e8080e7          	jalr	2024(ra) # 80004756 <fileclose>
    fileclose(wf);
    80005f76:	fc843503          	ld	a0,-56(s0)
    80005f7a:	ffffe097          	auipc	ra,0xffffe
    80005f7e:	7dc080e7          	jalr	2012(ra) # 80004756 <fileclose>
    return -1;
...
0000000080005f90 <kernelvec>:
    ...
    80005fd0:	893fc0ef          	jal	ra,80002862 <kerneltrap>
...
free_desc(int i)
{
  ...
  wakeup(&disk.free[0]);
    ...
    80006156:	078080e7          	jalr	120(ra) # 800021ca <wakeup>
}
    ...
    80006166:	62650513          	addi	a0,a0,1574 # 80008788 <syscalls+0x358>
    8000616a:	ffffa097          	auipc	ra,0xffffa
    8000616e:	3c0080e7          	jalr	960(ra) # 8000052a <panic>
    panic("free_desc 2");
    80006172:	00002517          	auipc	a0,0x2
    80006176:	62650513          	addi	a0,a0,1574 # 80008798 <syscalls+0x368>
...
0000000080006182 <virtio_disk_init>:
{
  ...
  initlock(&disk.vdisk_lock, "virtio_disk");
    ...
    80006190:	61c58593          	addi	a1,a1,1564 # 800087a8 <syscalls+0x378>
...
virtio_disk_rw(struct buf *b, int write)
{
  ...
  acquire(&disk.vdisk_lock);
    800062f6:	0001f517          	auipc	a0,0x1f
    800062fa:	e3250513          	addi	a0,a0,-462 # 80025128 <disk+0x2128>
  ...
  for(int i = 0; i < NUM; i++){
    80006308:	44a1                	li	s1,8
      disk.free[i] = 0;
    8000630a:	0001dc17          	auipc	s8,0x1d
    8000630e:	cf6c0c13          	addi	s8,s8,-778 # 80023000 <disk>
  ...
  for(int i = 0; i < NUM; i++){
    80006332:	0001f717          	auipc	a4,0x1f
    80006336:	ce670713          	addi	a4,a4,-794 # 80025018 <disk+0x2018>
  ...
  while(1){
    ...
    80006368:	0001f597          	auipc	a1,0x1f
    8000636c:	dc058593          	addi	a1,a1,-576 # 80025128 <disk+0x2128>
    80006370:	0001f517          	auipc	a0,0x1f
    80006374:	ca850513          	addi	a0,a0,-856 # 80025018 <disk+0x2018>
    80006378:	ffffc097          	auipc	ra,0xffffc
    8000637c:	cc6080e7          	jalr	-826(ra) # 8000203e <sleep>
  for(int i = 0; i < 3; i++){
    80006380:	f8040a13          	addi	s4,s0,-128
{
  ...
  disk.desc[idx[1]].flags |= VRING_DESC_F_NEXT;
    80006398:	0001d817          	auipc	a6,0x1d
    8000639c:	c6880813          	addi	a6,a6,-920 # 80023000 <disk>
    800063a0:	0001f697          	auipc	a3,0x1f
    800063a4:	c6068693          	addi	a3,a3,-928 # 80025000 <disk+0x2000>
  ...
  *R(VIRTIO_MMIO_QUEUE_NOTIFY) = 0; // value is queue number
  ...
  while(b->disk == 1) {
    ...
    80006438:	0001f917          	auipc	s2,0x1f
    8000643c:	cf090913          	addi	s2,s2,-784 # 80025128 <disk+0x2128>
  while(b->disk == 1) {
    ...
    8000644a:	bf8080e7          	jalr	-1032(ra) # 8000203e <sleep>
  while(b->disk == 1) {
  ...
  disk.info[idx[0]].b = 0;
    ...
    80006462:	0001d797          	auipc	a5,0x1d
    80006466:	b9e78793          	addi	a5,a5,-1122 # 80023000 <disk>
    8000646a:	97ba                	add	a5,a5,a4
    8000646c:	0207b423          	sd	zero,40(a5)
    int flag = disk.desc[i].flags;
    80006470:	0001f997          	auipc	s3,0x1f
    80006474:	b9098993          	addi	s3,s3,-1136 # 80025000 <disk+0x2000>
  ...
  if(write)
    800064d0:	0001d817          	auipc	a6,0x1d
    800064d4:	b3080813          	addi	a6,a6,-1232 # 80023000 <disk>
  ...
  disk.desc[idx[0]].addr = (uint64) buf0;
    ...
    800064f0:	0001f697          	auipc	a3,0x1f
    800064f4:	b1068693          	addi	a3,a3,-1264 # 80025000 <disk+0x2000>
  ...
  disk.desc[idx[0]].next = idx[1];
    ...
    8000651e:	00e61723          	sh	a4,14(a2) # ffffffffffffe00e <end+0xffffffff7ffd800e>
  disk.desc[idx[1]].addr = (uint64) b->data;
  ...
  if(write)
    ...
    80006540:	ac46b683          	ld	a3,-1340(a3) # 80025000 <disk+0x2000>
...
virtio_disk_intr()
{
  ...
  acquire(&disk.vdisk_lock);
    ...
    8000655e:	bce50513          	addi	a0,a0,-1074 # 80025128 <disk+0x2128>
  ...
  *R(VIRTIO_MMIO_INTERRUPT_ACK) = *R(VIRTIO_MMIO_INTERRUPT_STATUS) & 0x3;
  ...
  while(disk.used_idx != disk.used->idx){
    80006578:	0001f797          	auipc	a5,0x1f
    8000657c:	a8878793          	addi	a5,a5,-1400 # 80025000 <disk+0x2000>
    ...
    8000658e:	0001d917          	auipc	s2,0x1d
    80006592:	a7290913          	addi	s2,s2,-1422 # 80023000 <disk>
    80006596:	0001f497          	auipc	s1,0x1f
    8000659a:	a6a48493          	addi	s1,s1,-1430 # 80025000 <disk+0x2000>
    __sync_synchronize();
    ...
    800065d0:	bfe080e7          	jalr	-1026(ra) # 800021ca <wakeup>
  ...
  release(&disk.vdisk_lock);
    800065ec:	0001f517          	auipc	a0,0x1f
    800065f0:	b3c50513          	addi	a0,a0,-1220 # 80025128 <disk+0x2128>
    ...
    8000660c:	21050513          	addi	a0,a0,528 # 80008818 <syscalls+0x3e8>
